...
public abstract class BaseFsmSync<TStateKey, TEventKey, TState> : 
    BaseFsm<TStateKey, TEventKey, TState>, 
    IFsmSync<TStateKey, TEventKey, TState> 
    ...
    protected BaseFsmSync(TStateKey initialState, string? name = null) : base(initialState, name) {
    }
