...
public static class TileSetLayouts {
    public static readonly ITileSetLayout Blob47Godot = new TileSetLayout(new[,] {
    ...
    public static readonly ITileSetLayout Blob47TileSetter = new TileSetLayout(new[,] {
    ...
    public static readonly ITileSetLayout WangSubset13 = new TileSetLayout(new[,] {
        { 28, 124, 112, 247, 223 },
        { 31, 255, 241, 253, 127 },
        { 7, 199, 193, -1, -1 }
    });
