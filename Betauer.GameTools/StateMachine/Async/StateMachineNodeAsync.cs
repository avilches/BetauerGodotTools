...
namespace Betauer.StateMachine.Async {
    public class StateMachineNodeAsync<TStateKey, TTransitionKey> : BaseStateMachineNode, IStateMachineAsync<TStateKey, TTransitionKey, StateNodeAsync<TStateKey, TTransitionKey>> 
