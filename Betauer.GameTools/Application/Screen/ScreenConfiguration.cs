...
namespace Betauer.Application.Screen {
    public class ScreenConfiguration {
        ...
        public Window.ContentScaleModeEnum StretchMode;
        public Window.ContentScaleAspectEnum StretchAspect;
        public float Zoom { get; }

        public ScreenConfiguration(Resolution downScaledMinimumResolution, Resolution baseResolution, Window.ContentScaleModeEnum stretchMode,
            Window.ContentScaleAspectEnum stretchAspect, List<Resolution>? resolutions = null, bool isResizeable = false, float zoom = 1f) {
