...
namespace Betauer.GodotAction {
    public class AnimationNodeBlendSpace1DAction : AnimationNodeBlendSpace1D {


        private List<Action>? _onChangedAction; 
        public AnimationNodeBlendSpace1DAction OnChanged(Action action) {
        ...
        public AnimationNodeBlendSpace1DAction OnRemovedFromGraph(Action action) {
        ...
        public AnimationNodeBlendSpace1DAction OnScriptChanged(Action action) {
        ...
        public AnimationNodeBlendSpace1DAction OnTreeChanged(Action action) {
