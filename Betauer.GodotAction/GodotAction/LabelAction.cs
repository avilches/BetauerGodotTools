...
namespace Betauer.GodotAction {
    public class LabelAction : Node {
        ...
        public LabelAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public LabelAction OnPhysicsProcess(Action<float> action) {
        ...
        public LabelAction OnInput(Action<InputEvent> action) {
        ...
        public LabelAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public LabelAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public LabelAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public LabelAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public LabelAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public LabelAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public LabelAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
