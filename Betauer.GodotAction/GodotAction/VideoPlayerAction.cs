...
namespace Betauer.GodotAction {
    public class VideoPlayerAction : VideoPlayer {
        ...
        public VideoPlayerAction OnProcessAction(Action<float> action) {
            _onProcessAction ??= new List<Action<float>>(1);
            _onProcessAction.Add(action);
            SetProcess(true);
            return this;
        }
        public VideoPlayerAction OnPhysicsProcess(Action<float> action) {
        ...
        public VideoPlayerAction OnInput(Action<InputEvent> action) {
        ...
        public VideoPlayerAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public VideoPlayerAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public VideoPlayerAction RemoveOnProcessAction(Action<float> action) {
            _onProcessAction?.Remove(action);
            return this;
        }

        public VideoPlayerAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcess?.Remove(action);
            return this;
        }

        public VideoPlayerAction RemoveOnInput(Action<InputEvent> action) {
            _onInput?.Remove(action);
            return this;
        }

        public VideoPlayerAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInput?.Remove(action);
            return this;
        }

        public VideoPlayerAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public VideoPlayerAction OnDraw(Action action) {
            if (_onDrawAction == null) 
                Connect("draw", this, nameof(ExecuteDraw));
            _onDrawAction = action;
            return this;
        }
        public VideoPlayerAction RemoveOnDraw() {
        ...
        public VideoPlayerAction OnGuiInput(Action<InputEvent> action) {
            if (_onGuiInputAction == null) 
                Connect("gui_input", this, nameof(ExecuteGuiInput));
            _onGuiInputAction = action;
            return this;
        }
        public VideoPlayerAction RemoveOnGuiInput() {
        ...
        public VideoPlayerAction OnHide(Action action) {
            if (_onHideAction == null) 
                Connect("hide", this, nameof(ExecuteHide));
            _onHideAction = action;
            return this;
        }
        public VideoPlayerAction RemoveOnHide() {
        ...
        public VideoPlayerAction OnItemRectChanged(Action action) {
        ...
        public VideoPlayerAction RemoveOnItemRectChanged() {
        ...
        public VideoPlayerAction OnMinimumSizeChanged(Action action) {
        ...
        public VideoPlayerAction RemoveOnMinimumSizeChanged() {
        ...
        public VideoPlayerAction OnReady(Action action) {
            if (_onReadyAction == null) 
                Connect("ready", this, nameof(ExecuteReady));
            _onReadyAction = action;
            return this;
        }
        public VideoPlayerAction RemoveOnReady() {
        ...
        public VideoPlayerAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public VideoPlayerAction RemoveOnScriptChanged() {
        ...
        public VideoPlayerAction OnSizeFlagsChanged(Action action) {
        ...
        public VideoPlayerAction RemoveOnSizeFlagsChanged() {
        ...
        public VideoPlayerAction OnVisibilityChanged(Action action) {
        ...
        public VideoPlayerAction RemoveOnVisibilityChanged() {
