...
namespace Betauer.GodotAction {
    public class InputEventJoypadMotionAction : InputEventJoypadMotion {


        private List<Action>? _onChangedAction; 
        public InputEventJoypadMotionAction OnChanged(Action action) {
        ...
        public InputEventJoypadMotionAction OnScriptChanged(Action action) {
