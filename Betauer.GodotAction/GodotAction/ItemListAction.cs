...
namespace Betauer.GodotAction {
    public class ItemListAction : ItemList {
        ...
        public ItemListAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public ItemListAction OnPhysicsProcess(Action<float> action) {
        ...
        public ItemListAction OnInput(Action<InputEvent> action) {
        ...
        public ItemListAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public ItemListAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public ItemListAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public ItemListAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public ItemListAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public ItemListAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public ItemListAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        private void _GodotSignalItemActivated(int index) {
        ...
        private void _GodotSignalItemRmbSelected(Vector2 at_position, int index) {
        ...
        private void _GodotSignalMultiSelected(int index, bool selected) {
        ...
        public ItemListAction OnRmbClicked(Action<Vector2> action) {
            if (_onRmbClickedAction == null || _onRmbClickedAction.Count == 0) {
                ...
                Connect("rmb_clicked", this, nameof(_GodotSignalRmbClicked));
            }
        ...
        public ItemListAction RemoveOnRmbClicked(Action<Vector2> action) {
            ...
            if (_onRmbClickedAction.Count == 0) {
                Disconnect("rmb_clicked", this, nameof(_GodotSignalRmbClicked));
            }
            return this;
        }
        private void _GodotSignalRmbClicked(Vector2 at_position) {
