...
namespace Betauer.GodotAction {
    public class ItemListAction : Node {
        ...
        public ItemListAction OnRmbClicked(Action<Vector2> action, bool oneShot = false, bool deferred = false) {
            if (_onRmbClickedAction == null || _onRmbClickedAction.Count == 0) {
                ...
                GetParent().Connect("rmb_clicked", this, nameof(_GodotSignalRmbClicked));
            }
        ...
        public ItemListAction RemoveOnRmbClicked(Action<Vector2> action) {
            ...
            if (_onRmbClickedAction.Count == 0) {
                GetParent().Disconnect("rmb_clicked", this, nameof(_GodotSignalRmbClicked));
            }
            return this;
        }
