...
namespace Betauer.GodotAction {
    public class ItemListAction : ProxyNode {
        ...
        public void OnItemActivated(Action<int> action, bool oneShot = false, bool deferred = false) =>
            AddSignal(ref _onItemActivatedAction, "item_activated", nameof(_GodotSignalItemActivated), action, oneShot, deferred);

        public void RemoveOnItemActivated(Action<int> action) =>
        ...
        public void OnItemRmbSelected(Action<Vector2, int> action, bool oneShot = false, bool deferred = false) =>
            AddSignal(ref _onItemRmbSelectedAction, "item_rmb_selected", nameof(_GodotSignalItemRmbSelected), action, oneShot, deferred);

        public void RemoveOnItemRmbSelected(Action<Vector2, int> action) =>
        ...
        public void OnItemSelected(Action<int> action, bool oneShot = false, bool deferred = false) =>
            AddSignal(ref _onItemSelectedAction, "item_selected", nameof(_GodotSignalItemSelected), action, oneShot, deferred);

        public void RemoveOnItemSelected(Action<int> action) =>
        ...
        public void OnMultiSelected(Action<int, bool> action, bool oneShot = false, bool deferred = false) =>
            AddSignal(ref _onMultiSelectedAction, "multi_selected", nameof(_GodotSignalMultiSelected), action, oneShot, deferred);

        public void RemoveOnMultiSelected(Action<int, bool> action) =>
        ...
        public void OnRmbClicked(Action<Vector2> action, bool oneShot = false, bool deferred = false) =>
            AddSignal(ref _onRmbClickedAction, "rmb_clicked", nameof(_GodotSignalRmbClicked), action, oneShot, deferred);

        public void RemoveOnRmbClicked(Action<Vector2> action) =>
