...
namespace Betauer.GodotAction {
    public class GLTFAnimationAction : GLTFAnimation {


        private Action? _onChangedAction; 
        public GLTFAnimationAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public GLTFAnimationAction RemoveOnChanged() {
        ...
        public GLTFAnimationAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public GLTFAnimationAction RemoveOnScriptChanged() {
