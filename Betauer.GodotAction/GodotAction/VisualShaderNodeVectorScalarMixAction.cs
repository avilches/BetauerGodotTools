...
namespace Betauer.GodotAction {
    public class VisualShaderNodeVectorScalarMixAction : VisualShaderNodeVectorScalarMix {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeVectorScalarMixAction OnChanged(Action action) {
        ...
        public VisualShaderNodeVectorScalarMixAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeVectorScalarMixAction OnScriptChanged(Action action) {
