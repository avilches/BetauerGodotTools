...
namespace Betauer.GodotAction {
    public class VisualShaderNodeOuterProductAction : VisualShaderNodeOuterProduct {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeOuterProductAction OnChanged(Action action) {
        ...
        public VisualShaderNodeOuterProductAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeOuterProductAction OnScriptChanged(Action action) {
