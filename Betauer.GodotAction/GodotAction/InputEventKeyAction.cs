...
namespace Betauer.GodotAction {
    public class InputEventKeyAction : InputEventKey {


        private List<Action>? _onChangedAction; 
        public InputEventKeyAction OnChanged(Action action) {
        ...
        public InputEventKeyAction OnScriptChanged(Action action) {
