...
namespace Betauer.GodotAction {
    public class VisualShaderNodeVectorComposeAction : VisualShaderNodeVectorCompose {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeVectorComposeAction OnChanged(Action action) {
        ...
        public VisualShaderNodeVectorComposeAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeVectorComposeAction OnScriptChanged(Action action) {
