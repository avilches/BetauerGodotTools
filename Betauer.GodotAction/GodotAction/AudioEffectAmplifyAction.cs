...
namespace Betauer.GodotAction {
    public class AudioEffectAmplifyAction : AudioEffectAmplify {


        private Action? _onChangedAction; 
        public AudioEffectAmplifyAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public AudioEffectAmplifyAction RemoveOnChanged() {
        ...
        public AudioEffectAmplifyAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public AudioEffectAmplifyAction RemoveOnScriptChanged() {
