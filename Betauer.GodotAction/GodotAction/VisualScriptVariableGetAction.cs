...
namespace Betauer.GodotAction {
    public class VisualScriptVariableGetAction : VisualScriptVariableGet {


        private List<Action>? _onChangedAction; 
        public VisualScriptVariableGetAction OnChanged(Action action) {
        ...
        public VisualScriptVariableGetAction OnPortsChanged(Action action) {
        ...
        public VisualScriptVariableGetAction OnScriptChanged(Action action) {
