...
namespace Betauer.GodotAction {
    public class AnimatedTextureAction : AnimatedTexture {


        private List<Action>? _onChangedAction; 
        public AnimatedTextureAction OnChanged(Action action) {
        ...
        public AnimatedTextureAction OnScriptChanged(Action action) {
