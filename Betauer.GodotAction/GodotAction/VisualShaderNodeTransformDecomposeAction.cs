...
namespace Betauer.GodotAction {
    public class VisualShaderNodeTransformDecomposeAction : VisualShaderNodeTransformDecompose {


        private Action? _onChangedAction; 
        public VisualShaderNodeTransformDecomposeAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public VisualShaderNodeTransformDecomposeAction RemoveOnChanged() {
        ...
        public VisualShaderNodeTransformDecomposeAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeTransformDecomposeAction RemoveOnEditorRefreshRequest() {
        ...
        public VisualShaderNodeTransformDecomposeAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public VisualShaderNodeTransformDecomposeAction RemoveOnScriptChanged() {
