...
namespace Betauer.GodotAction {
    public class AudioEffectRecordAction : AudioEffectRecord {


        private List<Action>? _onChangedAction; 
        public AudioEffectRecordAction OnChanged(Action action) {
        ...
        public AudioEffectRecordAction OnScriptChanged(Action action) {
