...
namespace Betauer.GodotAction {
    public class AudioEffectHighPassFilterAction : AudioEffectHighPassFilter {


        private List<Action>? _onChangedAction; 
        public AudioEffectHighPassFilterAction OnChanged(Action action) {
        ...
        public AudioEffectHighPassFilterAction OnScriptChanged(Action action) {
