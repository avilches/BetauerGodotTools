...
namespace Betauer.GodotAction {
    public class InterpolatedCameraAction : InterpolatedCamera {
        ...
        public InterpolatedCameraAction OnProcessAction(Action<float> action) {
            _onProcessAction ??= new List<Action<float>>(1);
            _onProcessAction.Add(action);
            SetProcess(true);
            return this;
        }
        public InterpolatedCameraAction OnPhysicsProcess(Action<float> action) {
        ...
        public InterpolatedCameraAction OnInput(Action<InputEvent> action) {
        ...
        public InterpolatedCameraAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public InterpolatedCameraAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public InterpolatedCameraAction RemoveOnProcessAction(Action<float> action) {
            _onProcessAction?.Remove(action);
            return this;
        }

        public InterpolatedCameraAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcess?.Remove(action);
            return this;
        }

        public InterpolatedCameraAction RemoveOnInput(Action<InputEvent> action) {
            _onInput?.Remove(action);
            return this;
        }

        public InterpolatedCameraAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInput?.Remove(action);
            return this;
        }

        public InterpolatedCameraAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public InterpolatedCameraAction OnGameplayEntered(Action action) {
        ...
        public InterpolatedCameraAction RemoveOnGameplayEntered() {
        ...
        public InterpolatedCameraAction OnReady(Action action) {
            if (_onReadyAction == null) 
                Connect("ready", this, nameof(ExecuteReady));
            _onReadyAction = action;
            return this;
        }
        public InterpolatedCameraAction RemoveOnReady() {
        ...
        public InterpolatedCameraAction OnRenamed(Action action) {
            if (_onRenamedAction == null) 
                Connect("renamed", this, nameof(ExecuteRenamed));
            _onRenamedAction = action;
            return this;
        }
        public InterpolatedCameraAction RemoveOnRenamed() {
        ...
        public InterpolatedCameraAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public InterpolatedCameraAction RemoveOnScriptChanged() {
        ...
        public InterpolatedCameraAction OnTreeEntered(Action action) {
            if (_onTreeEnteredAction == null) 
                Connect("tree_entered", this, nameof(ExecuteTreeEntered));
            _onTreeEnteredAction = action;
            return this;
        }
        public InterpolatedCameraAction RemoveOnTreeEntered() {
        ...
        public InterpolatedCameraAction OnTreeExited(Action action) {
            if (_onTreeExitedAction == null) 
                Connect("tree_exited", this, nameof(ExecuteTreeExited));
            _onTreeExitedAction = action;
            return this;
        }
        public InterpolatedCameraAction RemoveOnTreeExited() {
        ...
        public InterpolatedCameraAction OnTreeExiting(Action action) {
            if (_onTreeExitingAction == null) 
                Connect("tree_exiting", this, nameof(ExecuteTreeExiting));
            _onTreeExitingAction = action;
            return this;
        }
        public InterpolatedCameraAction RemoveOnTreeExiting() {
        ...
        public InterpolatedCameraAction OnVisibilityChanged(Action action) {
        ...
        public InterpolatedCameraAction RemoveOnVisibilityChanged() {
