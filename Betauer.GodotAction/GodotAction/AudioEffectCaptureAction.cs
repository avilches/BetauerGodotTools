...
namespace Betauer.GodotAction {
    public class AudioEffectCaptureAction : AudioEffectCapture {


        private List<Action>? _onChangedAction; 
        public AudioEffectCaptureAction OnChanged(Action action) {
        ...
        public AudioEffectCaptureAction OnScriptChanged(Action action) {
