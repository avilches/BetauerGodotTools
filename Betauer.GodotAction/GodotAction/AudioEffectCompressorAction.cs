...
namespace Betauer.GodotAction {
    public class AudioEffectCompressorAction : AudioEffectCompressor {


        private List<Action>? _onChangedAction; 
        public AudioEffectCompressorAction OnChanged(Action action) {
        ...
        public AudioEffectCompressorAction OnScriptChanged(Action action) {
