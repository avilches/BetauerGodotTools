...
namespace Betauer.GodotAction {
    public class AnimationNodeOneShotAction : ProxyNode {
        ...
        private AnimationNodeOneShotAction _GodotSignalChanged() {
        ...
        private AnimationNodeOneShotAction _GodotSignalRemovedFromGraph() {
        ...
        private AnimationNodeOneShotAction _GodotSignalScriptChanged() {
        ...
        private AnimationNodeOneShotAction _GodotSignalTreeChanged() {
