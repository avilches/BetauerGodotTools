...
namespace Betauer.GodotAction {
    public class ShaderMaterialAction : ShaderMaterial {


        private List<Action>? _onChangedAction; 
        public ShaderMaterialAction OnChanged(Action action) {
        ...
        public ShaderMaterialAction OnScriptChanged(Action action) {
