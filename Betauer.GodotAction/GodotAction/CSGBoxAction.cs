...
namespace Betauer.GodotAction {
    public class CSGBoxAction : CSGBox {
        ...
        public CSGBoxAction OnGameplayEntered(Action action) {
        ...
        public CSGBoxAction OnGameplayExited(Action action) {
        ...
        public CSGBoxAction OnReady(Action action) {
        ...
        public CSGBoxAction OnRenamed(Action action) {
        ...
        public CSGBoxAction OnScriptChanged(Action action) {
        ...
        public CSGBoxAction OnTreeEntered(Action action) {
        ...
        public CSGBoxAction OnTreeExited(Action action) {
        ...
        public CSGBoxAction OnTreeExiting(Action action) {
        ...
        public CSGBoxAction OnVisibilityChanged(Action action) {
