...
namespace Betauer.GodotAction {
    public class CSGBoxAction : Node {
        public CSGBoxAction() {
            SetProcess(false);
        ...
        public CSGBoxAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public CSGBoxAction OnPhysicsProcess(Action<float> action) {
        ...
        public CSGBoxAction OnInput(Action<InputEvent> action) {
        ...
        public CSGBoxAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public CSGBoxAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public CSGBoxAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public CSGBoxAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public CSGBoxAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public CSGBoxAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public CSGBoxAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
