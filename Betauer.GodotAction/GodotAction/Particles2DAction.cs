...
namespace Betauer.GodotAction {
    public class Particles2DAction : Node {
        public Particles2DAction() {
            SetProcess(false);
        ...
        public Particles2DAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public Particles2DAction OnPhysicsProcess(Action<float> action) {
        ...
        public Particles2DAction OnInput(Action<InputEvent> action) {
        ...
        public Particles2DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public Particles2DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public Particles2DAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public Particles2DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public Particles2DAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public Particles2DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public Particles2DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
