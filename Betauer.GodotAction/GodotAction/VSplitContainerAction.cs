...
namespace Betauer.GodotAction {
    public class VSplitContainerAction : VSplitContainer {
        ...
        public VSplitContainerAction OnDragged(Action<int> action) {
            if (_onDraggedAction == null || _onDraggedAction.Count == 0) {
                _onDraggedAction ??= new List<Action<int>>(); 
                Connect("dragged", this, nameof(_GodotSignalDragged));
            }
        ...
        public VSplitContainerAction RemoveOnDragged(Action<int> action) {
            ...
            if (_onDraggedAction.Count == 0) {
                Disconnect("dragged", this, nameof(_GodotSignalDragged));
            }
            return this;
        }
        ...
        public VSplitContainerAction OnDraw(Action action) {
        ...
        public VSplitContainerAction OnFocusEntered(Action action) {
        ...
        public VSplitContainerAction OnFocusExited(Action action) {
        ...
        public VSplitContainerAction OnGuiInput(Action<InputEvent> action) {
        ...
        public VSplitContainerAction OnHide(Action action) {
        ...
        public VSplitContainerAction OnItemRectChanged(Action action) {
        ...
        public VSplitContainerAction OnMinimumSizeChanged(Action action) {
        ...
        public VSplitContainerAction OnModalClosed(Action action) {
        ...
        public VSplitContainerAction OnMouseEntered(Action action) {
        ...
        public VSplitContainerAction OnMouseExited(Action action) {
        ...
        public VSplitContainerAction OnReady(Action action) {
        ...
        public VSplitContainerAction OnRenamed(Action action) {
        ...
        public VSplitContainerAction OnResized(Action action) {
        ...
        public VSplitContainerAction OnScriptChanged(Action action) {
        ...
        public VSplitContainerAction OnSizeFlagsChanged(Action action) {
        ...
        public VSplitContainerAction OnSortChildren(Action action) {
        ...
        public VSplitContainerAction OnTreeEntered(Action action) {
        ...
        public VSplitContainerAction OnTreeExited(Action action) {
        ...
        public VSplitContainerAction OnTreeExiting(Action action) {
        ...
        public VSplitContainerAction OnVisibilityChanged(Action action) {
