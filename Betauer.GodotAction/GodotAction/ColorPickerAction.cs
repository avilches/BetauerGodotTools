    ...
    public class ColorPickerAction : ColorPicker {
        ...
        public ColorPickerAction OnPresetAdded(Action<Color> action) {
            if (_onPresetAddedAction == null || _onPresetAddedAction.Count == 0) {
                ...
                Connect("preset_added", this, nameof(_GodotSignalPresetAdded));
            }
        ...
        public ColorPickerAction RemoveOnPresetAdded(Action<Color> action) {
            ...
            if (_onPresetAddedAction.Count == 0) {
                Disconnect("preset_added", this, nameof(_GodotSignalPresetAdded));
            }
            return this;
        }
        ...
        public ColorPickerAction OnPresetRemoved(Action<Color> action) {
            if (_onPresetRemovedAction == null || _onPresetRemovedAction.Count == 0) {
                ...
                Connect("preset_removed", this, nameof(_GodotSignalPresetRemoved));
            }
        ...
        public ColorPickerAction RemoveOnPresetRemoved(Action<Color> action) {
            ...
            if (_onPresetRemovedAction.Count == 0) {
                Disconnect("preset_removed", this, nameof(_GodotSignalPresetRemoved));
            }
            return this;
        }
