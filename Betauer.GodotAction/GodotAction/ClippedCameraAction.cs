...
namespace Betauer.GodotAction {
    public class ClippedCameraAction : Node {
        public ClippedCameraAction() {
            SetProcess(false);
        ...
        public ClippedCameraAction OnProcess(Action<float> action) {
        ...
        public ClippedCameraAction RemoveOnProcess(Action<float> action) {
