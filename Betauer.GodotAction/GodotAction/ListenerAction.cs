...
namespace Betauer.GodotAction {
    public class ListenerAction : Node {
        ...
        public ListenerAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public ListenerAction OnPhysicsProcess(Action<float> action) {
        ...
        public ListenerAction OnInput(Action<InputEvent> action) {
        ...
        public ListenerAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public ListenerAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public ListenerAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public ListenerAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public ListenerAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public ListenerAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public ListenerAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
