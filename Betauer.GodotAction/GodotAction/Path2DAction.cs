...
namespace Betauer.GodotAction {
    public class Path2DAction : Node {
        public Path2DAction() {
            SetProcess(false);
        ...
        public Path2DAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public Path2DAction OnPhysicsProcess(Action<float> action) {
        ...
        public Path2DAction OnInput(Action<InputEvent> action) {
        ...
        public Path2DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public Path2DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public Path2DAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public Path2DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public Path2DAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public Path2DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public Path2DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
