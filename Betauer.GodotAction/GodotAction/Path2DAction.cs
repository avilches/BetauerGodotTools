...
namespace Betauer.GodotAction {
    public class Path2DAction : Path2D {
        ...
        public Path2DAction OnDraw(Action action) {
        ...
        public Path2DAction OnHide(Action action) {
        ...
        public Path2DAction OnItemRectChanged(Action action) {
        ...
        public Path2DAction OnReady(Action action) {
        ...
        public Path2DAction OnRenamed(Action action) {
        ...
        public Path2DAction OnScriptChanged(Action action) {
        ...
        public Path2DAction OnTreeEntered(Action action) {
        ...
        public Path2DAction OnTreeExited(Action action) {
        ...
        public Path2DAction OnTreeExiting(Action action) {
        ...
        public Path2DAction OnVisibilityChanged(Action action) {
