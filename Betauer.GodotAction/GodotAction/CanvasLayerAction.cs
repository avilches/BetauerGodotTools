...
namespace Betauer.GodotAction {
    public class CanvasLayerAction : CanvasLayer {
        ...
        public CanvasLayerAction OnReady(Action action) {
            if (_onReadyAction == null) 
                Connect("ready", this, nameof(ExecuteReady));
            _onReadyAction = action;
            return this;
        }
        public CanvasLayerAction RemoveOnReady() {
        ...
        public CanvasLayerAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public CanvasLayerAction RemoveOnScriptChanged() {
