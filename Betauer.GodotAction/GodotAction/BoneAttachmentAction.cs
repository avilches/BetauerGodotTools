...
namespace Betauer.GodotAction {
    public class BoneAttachmentAction : Node {
        public BoneAttachmentAction() {
            SetProcess(false);
        ...
        public BoneAttachmentAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public BoneAttachmentAction OnPhysicsProcess(Action<float> action) {
        ...
        public BoneAttachmentAction OnInput(Action<InputEvent> action) {
        ...
        public BoneAttachmentAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public BoneAttachmentAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public BoneAttachmentAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public BoneAttachmentAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public BoneAttachmentAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public BoneAttachmentAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public BoneAttachmentAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
