...
namespace Betauer.GodotAction {
    public class Light2DAction : Node {
        public Light2DAction() {
            SetProcess(false);
        ...
        public Light2DAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public Light2DAction OnPhysicsProcess(Action<float> action) {
        ...
        public Light2DAction OnInput(Action<InputEvent> action) {
        ...
        public Light2DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public Light2DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public Light2DAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public Light2DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public Light2DAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public Light2DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public Light2DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
