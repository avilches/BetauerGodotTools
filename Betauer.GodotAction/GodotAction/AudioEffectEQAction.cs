...
namespace Betauer.GodotAction {
    public class AudioEffectEQAction : AudioEffectEQ {


        private List<Action>? _onChangedAction; 
        public AudioEffectEQAction OnChanged(Action action) {
        ...
        public AudioEffectEQAction OnScriptChanged(Action action) {
