...
namespace Betauer.GodotAction {
    public class ContainerAction : Node {
        ...
        public ContainerAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public ContainerAction OnPhysicsProcess(Action<float> action) {
        ...
        public ContainerAction OnInput(Action<InputEvent> action) {
        ...
        public ContainerAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public ContainerAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public ContainerAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public ContainerAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public ContainerAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public ContainerAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public ContainerAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
