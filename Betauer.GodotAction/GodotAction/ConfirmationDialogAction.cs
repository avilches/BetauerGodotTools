...
namespace Betauer.GodotAction {
    public class ConfirmationDialogAction : ConfirmationDialog {
        ...
        public ConfirmationDialogAction OnProcessAction(Action<float> action) {
        ...
        public ConfirmationDialogAction RemoveOnProcessAction(Action<float> action) {
        ...
        public ConfirmationDialogAction OnAboutToShow(Action action) {
            if (_onAboutToShowAction == null) 
                Connect("about_to_show", this, nameof(ExecuteAboutToShow));
            _onAboutToShowAction = action;
            return this;
        }
        public ConfirmationDialogAction RemoveOnAboutToShow() {
        ...
        private Action? _onConfirmedAction; 
        public ConfirmationDialogAction OnConfirmed(Action action) {
            if (_onConfirmedAction == null) 
                Connect("confirmed", this, nameof(ExecuteConfirmed));
            _onConfirmedAction = action;
            return this;
        }
        public ConfirmationDialogAction RemoveOnConfirmed() {
            if (_onConfirmedAction == null) return this; 
            Disconnect("confirmed", this, nameof(ExecuteConfirmed));
            _onConfirmedAction = null;
            return this;
        }
        private void ExecuteConfirmed() =>
            _onConfirmedAction?.Invoke();
        

        private Action<string>? _onCustomActionAction; 
        public ConfirmationDialogAction OnCustomAction(Action<string> action) {
            if (_onCustomActionAction == null) 
                Connect("custom_action", this, nameof(ExecuteCustomAction));
            _onCustomActionAction = action;
            return this;
        }
        public ConfirmationDialogAction RemoveOnCustomAction() {
            if (_onCustomActionAction == null) return this; 
            Disconnect("custom_action", this, nameof(ExecuteCustomAction));
            _onCustomActionAction = null;
            return this;
        }
        private void ExecuteCustomAction(string action) =>
            _onCustomActionAction?.Invoke(action);
        

        private Action? _onDrawAction; 
        public ConfirmationDialogAction OnDraw(Action action) {
            if (_onDrawAction == null) 
                Connect("draw", this, nameof(ExecuteDraw));
            _onDrawAction = action;
            return this;
        }
        public ConfirmationDialogAction RemoveOnDraw() {
        ...
        public ConfirmationDialogAction OnFocusEntered(Action action) {
            if (_onFocusEnteredAction == null) 
                Connect("focus_entered", this, nameof(ExecuteFocusEntered));
            _onFocusEnteredAction = action;
            return this;
        }
        public ConfirmationDialogAction RemoveOnFocusEntered() {
        ...
        public ConfirmationDialogAction OnFocusExited(Action action) {
            if (_onFocusExitedAction == null) 
                Connect("focus_exited", this, nameof(ExecuteFocusExited));
            _onFocusExitedAction = action;
            return this;
        }
        public ConfirmationDialogAction RemoveOnFocusExited() {
        ...
        public ConfirmationDialogAction OnGuiInput(Action<InputEvent> action) {
            if (_onGuiInputAction == null) 
                Connect("gui_input", this, nameof(ExecuteGuiInput));
            _onGuiInputAction = action;
            return this;
        }
        public ConfirmationDialogAction RemoveOnGuiInput() {
        ...
        public ConfirmationDialogAction OnHide(Action action) {
            if (_onHideAction == null) 
                Connect("hide", this, nameof(ExecuteHide));
            _onHideAction = action;
            return this;
        }
        public ConfirmationDialogAction RemoveOnHide() {
        ...
        public ConfirmationDialogAction OnItemRectChanged(Action action) {
        ...
        public ConfirmationDialogAction RemoveOnItemRectChanged() {
        ...
        public ConfirmationDialogAction OnMinimumSizeChanged(Action action) {
        ...
        public ConfirmationDialogAction RemoveOnMinimumSizeChanged() {
        ...
        public ConfirmationDialogAction OnModalClosed(Action action) {
            if (_onModalClosedAction == null) 
                Connect("modal_closed", this, nameof(ExecuteModalClosed));
            _onModalClosedAction = action;
            return this;
        }
        public ConfirmationDialogAction RemoveOnModalClosed() {
        ...
        public ConfirmationDialogAction OnMouseEntered(Action action) {
            if (_onMouseEnteredAction == null) 
                Connect("mouse_entered", this, nameof(ExecuteMouseEntered));
            _onMouseEnteredAction = action;
            return this;
        }
        public ConfirmationDialogAction RemoveOnMouseEntered() {
        ...
        public ConfirmationDialogAction OnMouseExited(Action action) {
            if (_onMouseExitedAction == null) 
                Connect("mouse_exited", this, nameof(ExecuteMouseExited));
            _onMouseExitedAction = action;
            return this;
        }
        public ConfirmationDialogAction RemoveOnMouseExited() {
        ...
        public ConfirmationDialogAction OnPopupHide(Action action) {
            if (_onPopupHideAction == null) 
                Connect("popup_hide", this, nameof(ExecutePopupHide));
            _onPopupHideAction = action;
            return this;
        }
        public ConfirmationDialogAction RemoveOnPopupHide() {
        ...
        public ConfirmationDialogAction OnReady(Action action) {
            if (_onReadyAction == null) 
                Connect("ready", this, nameof(ExecuteReady));
            _onReadyAction = action;
            return this;
        }
        public ConfirmationDialogAction RemoveOnReady() {
        ...
        public ConfirmationDialogAction OnRenamed(Action action) {
            if (_onRenamedAction == null) 
                Connect("renamed", this, nameof(ExecuteRenamed));
            _onRenamedAction = action;
            return this;
        }
        public ConfirmationDialogAction RemoveOnRenamed() {
        ...
        public ConfirmationDialogAction OnResized(Action action) {
            if (_onResizedAction == null) 
                Connect("resized", this, nameof(ExecuteResized));
            _onResizedAction = action;
            return this;
        }
        public ConfirmationDialogAction RemoveOnResized() {
        ...
        public ConfirmationDialogAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public ConfirmationDialogAction RemoveOnScriptChanged() {
        ...
        public ConfirmationDialogAction OnSizeFlagsChanged(Action action) {
        ...
        public ConfirmationDialogAction RemoveOnSizeFlagsChanged() {
        ...
        public ConfirmationDialogAction OnTreeEntered(Action action) {
            if (_onTreeEnteredAction == null) 
                Connect("tree_entered", this, nameof(ExecuteTreeEntered));
            _onTreeEnteredAction = action;
            return this;
        }
        public ConfirmationDialogAction RemoveOnTreeEntered() {
        ...
        public ConfirmationDialogAction OnTreeExited(Action action) {
            if (_onTreeExitedAction == null) 
                Connect("tree_exited", this, nameof(ExecuteTreeExited));
            _onTreeExitedAction = action;
            return this;
        }
        public ConfirmationDialogAction RemoveOnTreeExited() {
        ...
        public ConfirmationDialogAction OnTreeExiting(Action action) {
            if (_onTreeExitingAction == null) 
                Connect("tree_exiting", this, nameof(ExecuteTreeExiting));
            _onTreeExitingAction = action;
            return this;
        }
        public ConfirmationDialogAction RemoveOnTreeExiting() {
        ...
        public ConfirmationDialogAction OnVisibilityChanged(Action action) {
        ...
        public ConfirmationDialogAction RemoveOnVisibilityChanged() {
