...
namespace Betauer.GodotAction {
    public class ConfirmationDialogAction : Node {
        public ConfirmationDialogAction() {
            SetProcess(false);
        ...
        public ConfirmationDialogAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public ConfirmationDialogAction OnPhysicsProcess(Action<float> action) {
        ...
        public ConfirmationDialogAction OnInput(Action<InputEvent> action) {
        ...
        public ConfirmationDialogAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public ConfirmationDialogAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public ConfirmationDialogAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public ConfirmationDialogAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public ConfirmationDialogAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public ConfirmationDialogAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public ConfirmationDialogAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public ConfirmationDialogAction OnConfirmed(Action action, bool oneShot = false, bool deferred = false) {
            if (_onConfirmedAction == null || _onConfirmedAction.Count == 0) {
                ...
                GetParent().Connect("confirmed", this, nameof(_GodotSignalConfirmed));
            }
        ...
        public ConfirmationDialogAction RemoveOnConfirmed(Action action) {
            ...
            if (_onConfirmedAction.Count == 0) {
                GetParent().Disconnect("confirmed", this, nameof(_GodotSignalConfirmed));
            }
            return this;
        }
        ...
        public ConfirmationDialogAction OnCustomAction(Action<string> action, bool oneShot = false, bool deferred = false) {
            if (_onCustomActionAction == null || _onCustomActionAction.Count == 0) {
                ...
                GetParent().Connect("custom_action", this, nameof(_GodotSignalCustomAction));
            }
        ...
        public ConfirmationDialogAction RemoveOnCustomAction(Action<string> action) {
            ...
            if (_onCustomActionAction.Count == 0) {
                GetParent().Disconnect("custom_action", this, nameof(_GodotSignalCustomAction));
            }
            return this;
        }
