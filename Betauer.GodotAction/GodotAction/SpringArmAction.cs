...
namespace Betauer.GodotAction {
    public class SpringArmAction : Node {
        public SpringArmAction() {
            SetProcess(false);
        ...
        public SpringArmAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public SpringArmAction OnPhysicsProcess(Action<float> action) {
        ...
        public SpringArmAction OnInput(Action<InputEvent> action) {
        ...
        public SpringArmAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public SpringArmAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public SpringArmAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public SpringArmAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public SpringArmAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public SpringArmAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public SpringArmAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public SpringArmAction OnGameplayEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public SpringArmAction RemoveOnGameplayEntered(Action action) {
        ...
        public SpringArmAction OnGameplayExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public SpringArmAction RemoveOnGameplayExited(Action action) {
        ...
        public SpringArmAction OnReady(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public SpringArmAction RemoveOnReady(Action action) {
        ...
        public SpringArmAction OnRenamed(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public SpringArmAction RemoveOnRenamed(Action action) {
        ...
        public SpringArmAction OnScriptChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public SpringArmAction RemoveOnScriptChanged(Action action) {
        ...
        public SpringArmAction OnTreeEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public SpringArmAction RemoveOnTreeEntered(Action action) {
        ...
        public SpringArmAction OnTreeExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public SpringArmAction RemoveOnTreeExited(Action action) {
        ...
        public SpringArmAction OnTreeExiting(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public SpringArmAction RemoveOnTreeExiting(Action action) {
        ...
        public SpringArmAction OnVisibilityChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public SpringArmAction RemoveOnVisibilityChanged(Action action) {
