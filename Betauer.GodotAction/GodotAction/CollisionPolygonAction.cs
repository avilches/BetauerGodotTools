...
namespace Betauer.GodotAction {
    public class CollisionPolygonAction : Node {
        public CollisionPolygonAction() {
            SetProcess(false);
        ...
        public CollisionPolygonAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public CollisionPolygonAction OnPhysicsProcess(Action<float> action) {
        ...
        public CollisionPolygonAction OnInput(Action<InputEvent> action) {
        ...
        public CollisionPolygonAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public CollisionPolygonAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public CollisionPolygonAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public CollisionPolygonAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public CollisionPolygonAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public CollisionPolygonAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public CollisionPolygonAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
