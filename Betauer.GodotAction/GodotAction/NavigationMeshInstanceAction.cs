...
namespace Betauer.GodotAction {
    public class NavigationMeshInstanceAction : NavigationMeshInstance {
        ...
        public NavigationMeshInstanceAction OnProcessAction(Action<float> action) {
            _onProcessAction ??= new List<Action<float>>(1);
            _onProcessAction.Add(action);
            SetProcess(true);
            return this;
        }
        public NavigationMeshInstanceAction OnPhysicsProcess(Action<float> action) {
        ...
        public NavigationMeshInstanceAction OnInput(Action<InputEvent> action) {
        ...
        public NavigationMeshInstanceAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public NavigationMeshInstanceAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public NavigationMeshInstanceAction RemoveOnProcessAction(Action<float> action) {
            _onProcessAction?.Remove(action);
            return this;
        }

        public NavigationMeshInstanceAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcess?.Remove(action);
            return this;
        }

        public NavigationMeshInstanceAction RemoveOnInput(Action<InputEvent> action) {
            _onInput?.Remove(action);
            return this;
        }

        public NavigationMeshInstanceAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInput?.Remove(action);
            return this;
        }

        public NavigationMeshInstanceAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public NavigationMeshInstanceAction OnGameplayEntered(Action action) {
        ...
        public NavigationMeshInstanceAction RemoveOnGameplayEntered() {
        ...
        public NavigationMeshInstanceAction OnGameplayExited(Action action) {
            if (_onGameplayExitedAction == null) 
                Connect("gameplay_exited", this, nameof(ExecuteGameplayExited));
            _onGameplayExitedAction = action;
            return this;
        }
        public NavigationMeshInstanceAction RemoveOnGameplayExited() {
        ...
        public NavigationMeshInstanceAction OnReady(Action action) {
            if (_onReadyAction == null) 
                Connect("ready", this, nameof(ExecuteReady));
            _onReadyAction = action;
            return this;
        }
        public NavigationMeshInstanceAction RemoveOnReady() {
        ...
        public NavigationMeshInstanceAction OnRenamed(Action action) {
            if (_onRenamedAction == null) 
                Connect("renamed", this, nameof(ExecuteRenamed));
            _onRenamedAction = action;
            return this;
        }
        public NavigationMeshInstanceAction RemoveOnRenamed() {
        ...
        public NavigationMeshInstanceAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public NavigationMeshInstanceAction RemoveOnScriptChanged() {
        ...
        public NavigationMeshInstanceAction OnTreeEntered(Action action) {
            if (_onTreeEnteredAction == null) 
                Connect("tree_entered", this, nameof(ExecuteTreeEntered));
            _onTreeEnteredAction = action;
            return this;
        }
        public NavigationMeshInstanceAction RemoveOnTreeEntered() {
        ...
        public NavigationMeshInstanceAction OnTreeExited(Action action) {
            if (_onTreeExitedAction == null) 
                Connect("tree_exited", this, nameof(ExecuteTreeExited));
            _onTreeExitedAction = action;
            return this;
        }
        public NavigationMeshInstanceAction RemoveOnTreeExited() {
        ...
        public NavigationMeshInstanceAction OnTreeExiting(Action action) {
            if (_onTreeExitingAction == null) 
                Connect("tree_exiting", this, nameof(ExecuteTreeExiting));
            _onTreeExitingAction = action;
            return this;
        }
        public NavigationMeshInstanceAction RemoveOnTreeExiting() {
        ...
        public NavigationMeshInstanceAction OnVisibilityChanged(Action action) {
        ...
        public NavigationMeshInstanceAction RemoveOnVisibilityChanged() {
