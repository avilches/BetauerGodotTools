...
namespace Betauer.GodotAction {
    public class VisualShaderNodeScalarSwitchAction : VisualShaderNodeScalarSwitch {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeScalarSwitchAction OnChanged(Action action) {
        ...
        public VisualShaderNodeScalarSwitchAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeScalarSwitchAction OnScriptChanged(Action action) {
