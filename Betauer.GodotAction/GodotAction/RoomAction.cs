...
namespace Betauer.GodotAction {
    public class RoomAction : Node {
        ...
        public RoomAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public RoomAction OnPhysicsProcess(Action<float> action) {
        ...
        public RoomAction OnInput(Action<InputEvent> action) {
        ...
        public RoomAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public RoomAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public RoomAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public RoomAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public RoomAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public RoomAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public RoomAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
