...
namespace Betauer.GodotAction {
    public class ColorPickerButtonAction : Node {
        public ColorPickerButtonAction() {
            SetProcess(false);
        ...
        public ColorPickerButtonAction OnButtonDown(Action action, bool oneShot = false, bool deferred = false) {
            if (_onButtonDownAction == null || _onButtonDownAction.Count == 0) {
                ...
                GetParent().Connect("button_down", this, nameof(_GodotSignalButtonDown));
            }
        ...
        public ColorPickerButtonAction RemoveOnButtonDown(Action action) {
            ...
            if (_onButtonDownAction.Count == 0) {
                GetParent().Disconnect("button_down", this, nameof(_GodotSignalButtonDown));
            }
            return this;
        }
        ...
        public ColorPickerButtonAction OnButtonUp(Action action, bool oneShot = false, bool deferred = false) {
            if (_onButtonUpAction == null || _onButtonUpAction.Count == 0) {
                ...
                GetParent().Connect("button_up", this, nameof(_GodotSignalButtonUp));
            }
        ...
        public ColorPickerButtonAction RemoveOnButtonUp(Action action) {
            ...
            if (_onButtonUpAction.Count == 0) {
                GetParent().Disconnect("button_up", this, nameof(_GodotSignalButtonUp));
            }
            return this;
        }
        ...
        public ColorPickerButtonAction OnColorChanged(Action<Color> action, bool oneShot = false, bool deferred = false) {
            if (_onColorChangedAction == null || _onColorChangedAction.Count == 0) {
                _onColorChangedAction ??= new List<Action<Color>>(); 
                GetParent().Connect("color_changed", this, nameof(_GodotSignalColorChanged));
            }
            _onColorChangedAction.Add(action);
            return this;
        }
        public ColorPickerButtonAction RemoveOnColorChanged(Action<Color> action) {
            if (_onColorChangedAction == null || _onColorChangedAction.Count == 0) return this;
            _onColorChangedAction.Remove(action); 
            if (_onColorChangedAction.Count == 0) {
                GetParent().Disconnect("color_changed", this, nameof(_GodotSignalColorChanged));
            }
            return this;
        }
        private void _GodotSignalColorChanged(Color color) {
            if (_onColorChangedAction == null || _onColorChangedAction.Count == 0) return;
            for (var i = 0; i < _onColorChangedAction.Count; i++) _onColorChangedAction[i].Invoke(color);
        }
        ...
        public ColorPickerButtonAction OnPickerCreated(Action action, bool oneShot = false, bool deferred = false) {
            if (_onPickerCreatedAction == null || _onPickerCreatedAction.Count == 0) {
                _onPickerCreatedAction ??= new List<Action>(); 
                GetParent().Connect("picker_created", this, nameof(_GodotSignalPickerCreated));
            }
            _onPickerCreatedAction.Add(action);
            return this;
        }
        public ColorPickerButtonAction RemoveOnPickerCreated(Action action) {
            if (_onPickerCreatedAction == null || _onPickerCreatedAction.Count == 0) return this;
            _onPickerCreatedAction.Remove(action); 
            if (_onPickerCreatedAction.Count == 0) {
                GetParent().Disconnect("picker_created", this, nameof(_GodotSignalPickerCreated));
            }
            return this;
        }
        private void _GodotSignalPickerCreated() {
            if (_onPickerCreatedAction == null || _onPickerCreatedAction.Count == 0) return;
            for (var i = 0; i < _onPickerCreatedAction.Count; i++) _onPickerCreatedAction[i].Invoke();
        }
        ...
        public ColorPickerButtonAction OnPopupClosed(Action action, bool oneShot = false, bool deferred = false) {
            if (_onPopupClosedAction == null || _onPopupClosedAction.Count == 0) {
                _onPopupClosedAction ??= new List<Action>(); 
                GetParent().Connect("popup_closed", this, nameof(_GodotSignalPopupClosed));
            }
            _onPopupClosedAction.Add(action);
            return this;
        }
        public ColorPickerButtonAction RemoveOnPopupClosed(Action action) {
            if (_onPopupClosedAction == null || _onPopupClosedAction.Count == 0) return this;
            _onPopupClosedAction.Remove(action); 
            if (_onPopupClosedAction.Count == 0) {
                GetParent().Disconnect("popup_closed", this, nameof(_GodotSignalPopupClosed));
            }
            return this;
        }
        private void _GodotSignalPopupClosed() {
            if (_onPopupClosedAction == null || _onPopupClosedAction.Count == 0) return;
            for (var i = 0; i < _onPopupClosedAction.Count; i++) _onPopupClosedAction[i].Invoke();
        }
        ...
        public ColorPickerButtonAction OnPressed(Action action, bool oneShot = false, bool deferred = false) {
            if (_onPressedAction == null || _onPressedAction.Count == 0) {
                ...
                GetParent().Connect("pressed", this, nameof(_GodotSignalPressed));
            }
        ...
        public ColorPickerButtonAction RemoveOnPressed(Action action) {
            ...
            if (_onPressedAction.Count == 0) {
                GetParent().Disconnect("pressed", this, nameof(_GodotSignalPressed));
            }
            return this;
        }
        ...
        public ColorPickerButtonAction OnToggled(Action<bool> action, bool oneShot = false, bool deferred = false) {
            if (_onToggledAction == null || _onToggledAction.Count == 0) {
                ...
                GetParent().Connect("toggled", this, nameof(_GodotSignalToggled));
            }
        ...
        public ColorPickerButtonAction RemoveOnToggled(Action<bool> action) {
            ...
            if (_onToggledAction.Count == 0) {
                GetParent().Disconnect("toggled", this, nameof(_GodotSignalToggled));
            }
            return this;
        }
