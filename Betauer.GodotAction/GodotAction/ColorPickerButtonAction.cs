    ...
    public class ColorPickerButtonAction : ColorPickerButton {
        ...
        public ColorPickerButtonAction OnColorChanged(Action<Color> action) {
            if (_onColorChangedAction == null || _onColorChangedAction.Count == 0) {
                ...
                Connect("color_changed", this, nameof(_GodotSignalColorChanged));
            }
        ...
        public ColorPickerButtonAction RemoveOnColorChanged(Action<Color> action) {
            ...
            if (_onColorChangedAction.Count == 0) {
                Disconnect("color_changed", this, nameof(_GodotSignalColorChanged));
            }
            return this;
        }
        ...
        public ColorPickerButtonAction OnPickerCreated(Action action) {
            if (_onPickerCreatedAction == null || _onPickerCreatedAction.Count == 0) {
                ...
                Connect("picker_created", this, nameof(_GodotSignalPickerCreated));
            }
        ...
        public ColorPickerButtonAction RemoveOnPickerCreated(Action action) {
            ...
            if (_onPickerCreatedAction.Count == 0) {
                Disconnect("picker_created", this, nameof(_GodotSignalPickerCreated));
            }
            return this;
        }
        ...
        public ColorPickerButtonAction OnPopupClosed(Action action) {
            if (_onPopupClosedAction == null || _onPopupClosedAction.Count == 0) {
                ...
                Connect("popup_closed", this, nameof(_GodotSignalPopupClosed));
            }
        ...
        public ColorPickerButtonAction RemoveOnPopupClosed(Action action) {
            ...
            if (_onPopupClosedAction.Count == 0) {
                Disconnect("popup_closed", this, nameof(_GodotSignalPopupClosed));
            }
            return this;
        }
