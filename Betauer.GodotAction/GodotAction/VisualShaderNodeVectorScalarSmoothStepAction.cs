...
namespace Betauer.GodotAction {
    public class VisualShaderNodeVectorScalarSmoothStepAction : VisualShaderNodeVectorScalarSmoothStep {


        private Action? _onChangedAction; 
        public VisualShaderNodeVectorScalarSmoothStepAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public VisualShaderNodeVectorScalarSmoothStepAction RemoveOnChanged() {
        ...
        public VisualShaderNodeVectorScalarSmoothStepAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeVectorScalarSmoothStepAction RemoveOnEditorRefreshRequest() {
        ...
        public VisualShaderNodeVectorScalarSmoothStepAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public VisualShaderNodeVectorScalarSmoothStepAction RemoveOnScriptChanged() {
