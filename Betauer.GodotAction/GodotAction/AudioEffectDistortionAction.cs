...
namespace Betauer.GodotAction {
    public class AudioEffectDistortionAction : AudioEffectDistortion {


        private List<Action>? _onChangedAction; 
        public AudioEffectDistortionAction OnChanged(Action action) {
        ...
        public AudioEffectDistortionAction OnScriptChanged(Action action) {
