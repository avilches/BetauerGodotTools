...
namespace Betauer.GodotAction {
    public class VisualScriptGlobalConstantAction : VisualScriptGlobalConstant {


        private List<Action>? _onChangedAction; 
        public VisualScriptGlobalConstantAction OnChanged(Action action) {
        ...
        public VisualScriptGlobalConstantAction OnPortsChanged(Action action) {
        ...
        public VisualScriptGlobalConstantAction OnScriptChanged(Action action) {
