...
namespace Betauer.GodotAction {
    public class AudioEffectPannerAction : AudioEffectPanner {


        private List<Action>? _onChangedAction; 
        public AudioEffectPannerAction OnChanged(Action action) {
        ...
        public AudioEffectPannerAction OnScriptChanged(Action action) {
