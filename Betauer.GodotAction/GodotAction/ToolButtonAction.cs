...
namespace Betauer.GodotAction {
    public class ToolButtonAction : ToolButton {
        ...
        public ToolButtonAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public ToolButtonAction OnPhysicsProcess(Action<float> action) {
        ...
        public ToolButtonAction OnInput(Action<InputEvent> action) {
        ...
        public ToolButtonAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public ToolButtonAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public ToolButtonAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public ToolButtonAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public ToolButtonAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public ToolButtonAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public ToolButtonAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public ToolButtonAction OnButtonDown(Action action) {
        ...
        public ToolButtonAction OnButtonUp(Action action) {
        ...
        public ToolButtonAction OnDraw(Action action) {
        ...
        public ToolButtonAction OnFocusEntered(Action action) {
        ...
        public ToolButtonAction OnFocusExited(Action action) {
        ...
        public ToolButtonAction OnGuiInput(Action<InputEvent> action) {
        ...
        public ToolButtonAction OnHide(Action action) {
        ...
        public ToolButtonAction OnItemRectChanged(Action action) {
        ...
        public ToolButtonAction OnMinimumSizeChanged(Action action) {
        ...
        public ToolButtonAction OnModalClosed(Action action) {
        ...
        public ToolButtonAction OnMouseEntered(Action action) {
        ...
        public ToolButtonAction OnMouseExited(Action action) {
        ...
        public ToolButtonAction OnPressed(Action action) {
        ...
        public ToolButtonAction OnReady(Action action) {
        ...
        public ToolButtonAction OnRenamed(Action action) {
        ...
        public ToolButtonAction OnResized(Action action) {
        ...
        public ToolButtonAction OnScriptChanged(Action action) {
        ...
        public ToolButtonAction OnSizeFlagsChanged(Action action) {
        ...
        public ToolButtonAction OnToggled(Action<bool> action) {
        ...
        public ToolButtonAction OnTreeEntered(Action action) {
        ...
        public ToolButtonAction OnTreeExited(Action action) {
        ...
        public ToolButtonAction OnTreeExiting(Action action) {
        ...
        public ToolButtonAction OnVisibilityChanged(Action action) {
