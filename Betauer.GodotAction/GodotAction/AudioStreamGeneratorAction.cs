...
namespace Betauer.GodotAction {
    public class AudioStreamGeneratorAction : AudioStreamGenerator {


        private List<Action>? _onChangedAction; 
        public AudioStreamGeneratorAction OnChanged(Action action) {
        ...
        public AudioStreamGeneratorAction OnScriptChanged(Action action) {
