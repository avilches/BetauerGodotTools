...
namespace Betauer.GodotAction {
    public class InputEventActionAction : InputEventAction {


        private List<Action>? _onChangedAction; 
        public InputEventActionAction OnChanged(Action action) {
        ...
        public InputEventActionAction OnScriptChanged(Action action) {
