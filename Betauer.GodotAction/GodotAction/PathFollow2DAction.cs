...
namespace Betauer.GodotAction {
    public class PathFollow2DAction : PathFollow2D {
        ...
        public PathFollow2DAction OnProcessAction(Action<float> action) {
            _onProcessAction ??= new List<Action<float>>(1);
            _onProcessAction.Add(action);
            SetProcess(true);
            return this;
        }
        public PathFollow2DAction OnPhysicsProcess(Action<float> action) {
        ...
        public PathFollow2DAction OnInput(Action<InputEvent> action) {
        ...
        public PathFollow2DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public PathFollow2DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public PathFollow2DAction RemoveOnProcessAction(Action<float> action) {
            _onProcessAction?.Remove(action);
            return this;
        }

        public PathFollow2DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcess?.Remove(action);
            return this;
        }

        public PathFollow2DAction RemoveOnInput(Action<InputEvent> action) {
            _onInput?.Remove(action);
            return this;
        }

        public PathFollow2DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInput?.Remove(action);
            return this;
        }

        public PathFollow2DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public PathFollow2DAction OnDraw(Action action) {
            if (_onDrawAction == null) 
                Connect("draw", this, nameof(ExecuteDraw));
            _onDrawAction = action;
            return this;
        }
        public PathFollow2DAction RemoveOnDraw() {
        ...
        public PathFollow2DAction OnHide(Action action) {
            if (_onHideAction == null) 
                Connect("hide", this, nameof(ExecuteHide));
            _onHideAction = action;
            return this;
        }
        public PathFollow2DAction RemoveOnHide() {
        ...
        public PathFollow2DAction OnItemRectChanged(Action action) {
        ...
        public PathFollow2DAction RemoveOnItemRectChanged() {
        ...
        public PathFollow2DAction OnReady(Action action) {
            if (_onReadyAction == null) 
                Connect("ready", this, nameof(ExecuteReady));
            _onReadyAction = action;
            return this;
        }
        public PathFollow2DAction RemoveOnReady() {
        ...
        public PathFollow2DAction OnRenamed(Action action) {
            if (_onRenamedAction == null) 
                Connect("renamed", this, nameof(ExecuteRenamed));
            _onRenamedAction = action;
            return this;
        }
        public PathFollow2DAction RemoveOnRenamed() {
        ...
        public PathFollow2DAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public PathFollow2DAction RemoveOnScriptChanged() {
        ...
        public PathFollow2DAction OnVisibilityChanged(Action action) {
        ...
        public PathFollow2DAction RemoveOnVisibilityChanged() {
