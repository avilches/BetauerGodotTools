...
namespace Betauer.GodotAction {
    public class VisualScriptSceneTreeAction : VisualScriptSceneTree {


        private List<Action>? _onChangedAction; 
        public VisualScriptSceneTreeAction OnChanged(Action action) {
        ...
        public VisualScriptSceneTreeAction OnPortsChanged(Action action) {
        ...
        public VisualScriptSceneTreeAction OnScriptChanged(Action action) {
