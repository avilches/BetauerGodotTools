...
namespace Betauer.GodotAction {
    public class RoomGroupAction : Node {
        public RoomGroupAction() {
            SetProcess(false);
        ...
        public RoomGroupAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public RoomGroupAction OnPhysicsProcess(Action<float> action) {
        ...
        public RoomGroupAction OnInput(Action<InputEvent> action) {
        ...
        public RoomGroupAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public RoomGroupAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public RoomGroupAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public RoomGroupAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public RoomGroupAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public RoomGroupAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public RoomGroupAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
