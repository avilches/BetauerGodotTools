...
namespace Betauer.GodotAction {
    public class ConvexPolygonShapeAction : ConvexPolygonShape {


        private List<Action>? _onChangedAction; 
        public ConvexPolygonShapeAction OnChanged(Action action) {
        ...
        public ConvexPolygonShapeAction OnScriptChanged(Action action) {
