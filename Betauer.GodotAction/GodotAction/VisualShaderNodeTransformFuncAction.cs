...
namespace Betauer.GodotAction {
    public class VisualShaderNodeTransformFuncAction : VisualShaderNodeTransformFunc {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeTransformFuncAction OnChanged(Action action) {
        ...
        public VisualShaderNodeTransformFuncAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeTransformFuncAction OnScriptChanged(Action action) {
