...
namespace Betauer.GodotAction {
    public class VisualShaderNodeTransformConstantAction : VisualShaderNodeTransformConstant {


        private Action? _onChangedAction; 
        public VisualShaderNodeTransformConstantAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public VisualShaderNodeTransformConstantAction RemoveOnChanged() {
        ...
        public VisualShaderNodeTransformConstantAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeTransformConstantAction RemoveOnEditorRefreshRequest() {
        ...
        public VisualShaderNodeTransformConstantAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public VisualShaderNodeTransformConstantAction RemoveOnScriptChanged() {
