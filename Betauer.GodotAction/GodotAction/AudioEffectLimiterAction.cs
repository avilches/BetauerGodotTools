...
namespace Betauer.GodotAction {
    public class AudioEffectLimiterAction : AudioEffectLimiter {


        private List<Action>? _onChangedAction; 
        public AudioEffectLimiterAction OnChanged(Action action) {
        ...
        public AudioEffectLimiterAction OnScriptChanged(Action action) {
