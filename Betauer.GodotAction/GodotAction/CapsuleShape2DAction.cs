...
namespace Betauer.GodotAction {
    public class CapsuleShape2DAction : CapsuleShape2D {


        private Action? _onChangedAction; 
        public CapsuleShape2DAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public CapsuleShape2DAction RemoveOnChanged() {
        ...
        public CapsuleShape2DAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public CapsuleShape2DAction RemoveOnScriptChanged() {
