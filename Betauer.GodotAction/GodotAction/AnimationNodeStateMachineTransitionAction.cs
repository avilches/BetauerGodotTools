...
namespace Betauer.GodotAction {
    public class AnimationNodeStateMachineTransitionAction : Node {
        public AnimationNodeStateMachineTransitionAction() {
            SetProcess(false);
        ...
        public AnimationNodeStateMachineTransitionAction OnAdvanceConditionChanged(Action action, bool oneShot = false, bool deferred = false) {
            if (_onAdvanceConditionChangedAction == null || _onAdvanceConditionChangedAction.Count == 0) {
                ...
                GetParent().Connect("advance_condition_changed", this, nameof(_GodotSignalAdvanceConditionChanged));
            }
        ...
        public AnimationNodeStateMachineTransitionAction RemoveOnAdvanceConditionChanged(Action action) {
            ...
            if (_onAdvanceConditionChangedAction.Count == 0) {
                GetParent().Disconnect("advance_condition_changed", this, nameof(_GodotSignalAdvanceConditionChanged));
            }
            return this;
        }
