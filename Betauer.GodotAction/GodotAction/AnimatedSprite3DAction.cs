...
namespace Betauer.GodotAction {
    public class AnimatedSprite3DAction : AnimatedSprite3D {
        ...
        private Action? _onAnimationFinishedAction; 
        ...
        public AnimatedSprite3DAction RemoveOnAnimationFinished() {
        ...
        private void ExecuteAnimationFinished() =>
            _onAnimationFinishedAction?.Invoke();
        

        private Action? _onFrameChangedAction; 
        public AnimatedSprite3DAction OnFrameChanged(Action action) {
            if (_onFrameChangedAction == null) 
                Connect("frame_changed", this, nameof(ExecuteFrameChanged));
            _onFrameChangedAction = action;
            return this;
        }
        public AnimatedSprite3DAction RemoveOnFrameChanged() {
            if (_onFrameChangedAction == null) return this; 
            Disconnect("frame_changed", this, nameof(ExecuteFrameChanged));
            _onFrameChangedAction = null;
            return this;
        }
        private void ExecuteFrameChanged() =>
            _onFrameChangedAction?.Invoke();
        ...
        public AnimatedSprite3DAction RemoveOnGameplayEntered() {
        ...
        public AnimatedSprite3DAction RemoveOnGameplayExited() {
        ...
        public AnimatedSprite3DAction RemoveOnReady() {
        ...
        public AnimatedSprite3DAction RemoveOnRenamed() {
        ...
        public AnimatedSprite3DAction RemoveOnScriptChanged() {
        ...
        public AnimatedSprite3DAction RemoveOnTreeEntered() {
        ...
        public AnimatedSprite3DAction RemoveOnTreeExited() {
        ...
        public AnimatedSprite3DAction RemoveOnTreeExiting() {
        ...
        public AnimatedSprite3DAction RemoveOnVisibilityChanged() {
