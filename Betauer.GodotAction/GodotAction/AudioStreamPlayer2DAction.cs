...
namespace Betauer.GodotAction {
    public class AudioStreamPlayer2DAction : AudioStreamPlayer2D {
        ...
        public AudioStreamPlayer2DAction OnDraw(Action action) {
        ...
        public AudioStreamPlayer2DAction OnFinished(Action action) {
            if (_onFinishedAction == null || _onFinishedAction.Count == 0) {
                _onFinishedAction ??= new List<Action>(); 
                Connect("finished", this, nameof(_GodotSignalFinished));
            }
        ...
        public AudioStreamPlayer2DAction RemoveOnFinished(Action action) {
            ...
            if (_onFinishedAction.Count == 0) {
                Disconnect("finished", this, nameof(_GodotSignalFinished));
            }
            return this;
        }
        ...
        public AudioStreamPlayer2DAction OnHide(Action action) {
        ...
        public AudioStreamPlayer2DAction OnItemRectChanged(Action action) {
        ...
        public AudioStreamPlayer2DAction OnReady(Action action) {
        ...
        public AudioStreamPlayer2DAction OnRenamed(Action action) {
        ...
        public AudioStreamPlayer2DAction OnScriptChanged(Action action) {
        ...
        public AudioStreamPlayer2DAction OnTreeEntered(Action action) {
        ...
        public AudioStreamPlayer2DAction OnTreeExited(Action action) {
        ...
        public AudioStreamPlayer2DAction OnTreeExiting(Action action) {
        ...
        public AudioStreamPlayer2DAction OnVisibilityChanged(Action action) {
