...
namespace Betauer.GodotAction {
    public class AudioStreamPlayer2DAction : Node {
        public AudioStreamPlayer2DAction() {
            SetProcess(false);
        ...
        public AudioStreamPlayer2DAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public AudioStreamPlayer2DAction OnPhysicsProcess(Action<float> action) {
        ...
        public AudioStreamPlayer2DAction OnInput(Action<InputEvent> action) {
        ...
        public AudioStreamPlayer2DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public AudioStreamPlayer2DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public AudioStreamPlayer2DAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public AudioStreamPlayer2DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public AudioStreamPlayer2DAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public AudioStreamPlayer2DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public AudioStreamPlayer2DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public AudioStreamPlayer2DAction OnDraw(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public AudioStreamPlayer2DAction RemoveOnDraw(Action action) {
        ...
        public AudioStreamPlayer2DAction OnFinished(Action action, bool oneShot = false, bool deferred = false) {
            if (_onFinishedAction == null || _onFinishedAction.Count == 0) {
                _onFinishedAction ??= new List<Action>(); 
                GetParent().Connect("finished", this, nameof(_GodotSignalFinished));
            }
            _onFinishedAction.Add(action);
            return this;
        }
        public AudioStreamPlayer2DAction RemoveOnFinished(Action action) {
            if (_onFinishedAction == null || _onFinishedAction.Count == 0) return this;
            _onFinishedAction.Remove(action); 
            if (_onFinishedAction.Count == 0) {
                GetParent().Disconnect("finished", this, nameof(_GodotSignalFinished));
            }
            return this;
        }
        private void _GodotSignalFinished() {
            if (_onFinishedAction == null || _onFinishedAction.Count == 0) return;
            for (var i = 0; i < _onFinishedAction.Count; i++) _onFinishedAction[i].Invoke();
        }
        

        private List<Action>? _onHideAction; 
        public AudioStreamPlayer2DAction OnHide(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public AudioStreamPlayer2DAction RemoveOnHide(Action action) {
        ...
        public AudioStreamPlayer2DAction OnItemRectChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public AudioStreamPlayer2DAction RemoveOnItemRectChanged(Action action) {
        ...
        public AudioStreamPlayer2DAction OnReady(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public AudioStreamPlayer2DAction RemoveOnReady(Action action) {
        ...
        public AudioStreamPlayer2DAction OnRenamed(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public AudioStreamPlayer2DAction RemoveOnRenamed(Action action) {
        ...
        public AudioStreamPlayer2DAction OnScriptChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public AudioStreamPlayer2DAction RemoveOnScriptChanged(Action action) {
        ...
        public AudioStreamPlayer2DAction OnTreeEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public AudioStreamPlayer2DAction RemoveOnTreeEntered(Action action) {
        ...
        public AudioStreamPlayer2DAction OnTreeExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public AudioStreamPlayer2DAction RemoveOnTreeExited(Action action) {
        ...
        public AudioStreamPlayer2DAction OnTreeExiting(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public AudioStreamPlayer2DAction RemoveOnTreeExiting(Action action) {
        ...
        public AudioStreamPlayer2DAction OnVisibilityChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public AudioStreamPlayer2DAction RemoveOnVisibilityChanged(Action action) {
