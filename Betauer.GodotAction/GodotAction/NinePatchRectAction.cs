...
namespace Betauer.GodotAction {
    public class NinePatchRectAction : NinePatchRect {
        ...
        public NinePatchRectAction OnProcessAction(Action<float> action) {
            _onProcessAction ??= new List<Action<float>>(1);
            _onProcessAction.Add(action);
            SetProcess(true);
            return this;
        }
        public NinePatchRectAction OnPhysicsProcess(Action<float> action) {
        ...
        public NinePatchRectAction OnInput(Action<InputEvent> action) {
        ...
        public NinePatchRectAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public NinePatchRectAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public NinePatchRectAction RemoveOnProcessAction(Action<float> action) {
            _onProcessAction?.Remove(action);
            return this;
        }

        public NinePatchRectAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcess?.Remove(action);
            return this;
        }

        public NinePatchRectAction RemoveOnInput(Action<InputEvent> action) {
            _onInput?.Remove(action);
            return this;
        }

        public NinePatchRectAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInput?.Remove(action);
            return this;
        }

        public NinePatchRectAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public NinePatchRectAction OnDraw(Action action) {
            if (_onDrawAction == null) 
                Connect("draw", this, nameof(ExecuteDraw));
            _onDrawAction = action;
            return this;
        }
        public NinePatchRectAction RemoveOnDraw() {
        ...
        public NinePatchRectAction OnGuiInput(Action<InputEvent> action) {
            if (_onGuiInputAction == null) 
                Connect("gui_input", this, nameof(ExecuteGuiInput));
            _onGuiInputAction = action;
            return this;
        }
        public NinePatchRectAction RemoveOnGuiInput() {
        ...
        public NinePatchRectAction OnHide(Action action) {
            if (_onHideAction == null) 
                Connect("hide", this, nameof(ExecuteHide));
            _onHideAction = action;
            return this;
        }
        public NinePatchRectAction RemoveOnHide() {
        ...
        public NinePatchRectAction OnItemRectChanged(Action action) {
        ...
        public NinePatchRectAction RemoveOnItemRectChanged() {
        ...
        public NinePatchRectAction OnMinimumSizeChanged(Action action) {
        ...
        public NinePatchRectAction RemoveOnMinimumSizeChanged() {
        ...
        public NinePatchRectAction OnReady(Action action) {
            if (_onReadyAction == null) 
                Connect("ready", this, nameof(ExecuteReady));
            _onReadyAction = action;
            return this;
        }
        public NinePatchRectAction RemoveOnReady() {
        ...
        public NinePatchRectAction OnRenamed(Action action) {
            if (_onRenamedAction == null) 
                Connect("renamed", this, nameof(ExecuteRenamed));
            _onRenamedAction = action;
            return this;
        }
        public NinePatchRectAction RemoveOnRenamed() {
        ...
        public NinePatchRectAction OnResized(Action action) {
            if (_onResizedAction == null) 
                Connect("resized", this, nameof(ExecuteResized));
            _onResizedAction = action;
            return this;
        }
        public NinePatchRectAction RemoveOnResized() {
        ...
        public NinePatchRectAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public NinePatchRectAction RemoveOnScriptChanged() {
        ...
        public NinePatchRectAction OnSizeFlagsChanged(Action action) {
        ...
        public NinePatchRectAction RemoveOnSizeFlagsChanged() {
        ...
        public NinePatchRectAction OnVisibilityChanged(Action action) {
        ...
        public NinePatchRectAction RemoveOnVisibilityChanged() {
