...
namespace Betauer.GodotAction {
    public class VehicleWheelAction : Node {
        public VehicleWheelAction() {
            SetProcess(false);
        ...
        public VehicleWheelAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public VehicleWheelAction OnPhysicsProcess(Action<float> action) {
        ...
        public VehicleWheelAction OnInput(Action<InputEvent> action) {
        ...
        public VehicleWheelAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public VehicleWheelAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public VehicleWheelAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public VehicleWheelAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public VehicleWheelAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public VehicleWheelAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public VehicleWheelAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
