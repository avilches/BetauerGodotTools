...
namespace Betauer.GodotAction {
    public class SegmentShape2DAction : SegmentShape2D {


        private Action? _onChangedAction; 
        public SegmentShape2DAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public SegmentShape2DAction RemoveOnChanged() {
        ...
        public SegmentShape2DAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public SegmentShape2DAction RemoveOnScriptChanged() {
