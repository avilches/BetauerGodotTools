...
namespace Betauer.GodotAction {
    public class BakedLightmapDataAction : BakedLightmapData {


        private Action? _onChangedAction; 
        public BakedLightmapDataAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public BakedLightmapDataAction RemoveOnChanged() {
        ...
        public BakedLightmapDataAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public BakedLightmapDataAction RemoveOnScriptChanged() {
