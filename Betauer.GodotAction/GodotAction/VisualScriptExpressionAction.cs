...
namespace Betauer.GodotAction {
    public class VisualScriptExpressionAction : VisualScriptExpression {


        private List<Action>? _onChangedAction; 
        public VisualScriptExpressionAction OnChanged(Action action) {
        ...
        public VisualScriptExpressionAction OnPortsChanged(Action action) {
        ...
        public VisualScriptExpressionAction OnScriptChanged(Action action) {
