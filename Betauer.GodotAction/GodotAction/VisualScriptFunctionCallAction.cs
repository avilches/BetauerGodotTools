...
namespace Betauer.GodotAction {
    public class VisualScriptFunctionCallAction : VisualScriptFunctionCall {


        private Action? _onChangedAction; 
        public VisualScriptFunctionCallAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public VisualScriptFunctionCallAction RemoveOnChanged() {
        ...
        public VisualScriptFunctionCallAction OnPortsChanged(Action action) {
            if (_onPortsChangedAction == null) 
                Connect("ports_changed", this, nameof(ExecutePortsChanged));
            _onPortsChangedAction = action;
            return this;
        }
        public VisualScriptFunctionCallAction RemoveOnPortsChanged() {
        ...
        public VisualScriptFunctionCallAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public VisualScriptFunctionCallAction RemoveOnScriptChanged() {
