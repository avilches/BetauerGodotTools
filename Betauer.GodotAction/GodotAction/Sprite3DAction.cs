...
namespace Betauer.GodotAction {
    public class Sprite3DAction : Sprite3D {
        ...
        public Sprite3DAction OnProcessAction(Action<float> action) {
            _onProcessAction ??= new List<Action<float>>(1);
            _onProcessAction.Add(action);
            SetProcess(true);
            return this;
        }
        public Sprite3DAction OnPhysicsProcess(Action<float> action) {
        ...
        public Sprite3DAction OnInput(Action<InputEvent> action) {
        ...
        public Sprite3DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public Sprite3DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public Sprite3DAction RemoveOnProcessAction(Action<float> action) {
            _onProcessAction?.Remove(action);
            return this;
        }

        public Sprite3DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcess?.Remove(action);
            return this;
        }

        public Sprite3DAction RemoveOnInput(Action<InputEvent> action) {
            _onInput?.Remove(action);
            return this;
        }

        public Sprite3DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInput?.Remove(action);
            return this;
        }

        public Sprite3DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public Sprite3DAction OnGameplayEntered(Action action) {
        ...
        public Sprite3DAction RemoveOnGameplayEntered() {
        ...
        public Sprite3DAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public Sprite3DAction RemoveOnScriptChanged() {
        ...
        public Sprite3DAction OnVisibilityChanged(Action action) {
        ...
        public Sprite3DAction RemoveOnVisibilityChanged() {
