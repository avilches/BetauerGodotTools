...
namespace Betauer.GodotAction {
    public class RemoteTransform2DAction : Node {
        public RemoteTransform2DAction() {
            SetProcess(false);
        ...
        public RemoteTransform2DAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public RemoteTransform2DAction OnPhysicsProcess(Action<float> action) {
        ...
        public RemoteTransform2DAction OnInput(Action<InputEvent> action) {
        ...
        public RemoteTransform2DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public RemoteTransform2DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public RemoteTransform2DAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public RemoteTransform2DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public RemoteTransform2DAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public RemoteTransform2DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public RemoteTransform2DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public RemoteTransform2DAction OnDraw(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public RemoteTransform2DAction RemoveOnDraw(Action action) {
        ...
        public RemoteTransform2DAction OnHide(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public RemoteTransform2DAction RemoveOnHide(Action action) {
        ...
        public RemoteTransform2DAction OnItemRectChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public RemoteTransform2DAction RemoveOnItemRectChanged(Action action) {
        ...
        public RemoteTransform2DAction OnReady(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public RemoteTransform2DAction RemoveOnReady(Action action) {
        ...
        public RemoteTransform2DAction OnRenamed(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public RemoteTransform2DAction RemoveOnRenamed(Action action) {
        ...
        public RemoteTransform2DAction OnScriptChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public RemoteTransform2DAction RemoveOnScriptChanged(Action action) {
        ...
        public RemoteTransform2DAction OnTreeEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public RemoteTransform2DAction RemoveOnTreeEntered(Action action) {
        ...
        public RemoteTransform2DAction OnTreeExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public RemoteTransform2DAction RemoveOnTreeExited(Action action) {
        ...
        public RemoteTransform2DAction OnTreeExiting(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public RemoteTransform2DAction RemoveOnTreeExiting(Action action) {
        ...
        public RemoteTransform2DAction OnVisibilityChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public RemoteTransform2DAction RemoveOnVisibilityChanged(Action action) {
