...
namespace Betauer.GodotAction {
    public class AudioStreamPlayer3DAction : Node {
        public AudioStreamPlayer3DAction() {
            SetProcess(false);
        ...
        public AudioStreamPlayer3DAction OnProcess(Action<float> action) {
        ...
        public AudioStreamPlayer3DAction RemoveOnProcess(Action<float> action) {
