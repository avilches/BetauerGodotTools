...
namespace Betauer.GodotAction {
    public class MeshInstance2DAction : Node {
        public MeshInstance2DAction() {
            SetProcess(false);
        ...
        public MeshInstance2DAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public MeshInstance2DAction OnPhysicsProcess(Action<float> action) {
        ...
        public MeshInstance2DAction OnInput(Action<InputEvent> action) {
        ...
        public MeshInstance2DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public MeshInstance2DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public MeshInstance2DAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public MeshInstance2DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public MeshInstance2DAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public MeshInstance2DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public MeshInstance2DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public MeshInstance2DAction OnDraw(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public MeshInstance2DAction RemoveOnDraw(Action action) {
        ...
        public MeshInstance2DAction OnHide(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public MeshInstance2DAction RemoveOnHide(Action action) {
        ...
        public MeshInstance2DAction OnItemRectChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public MeshInstance2DAction RemoveOnItemRectChanged(Action action) {
        ...
        public MeshInstance2DAction OnReady(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public MeshInstance2DAction RemoveOnReady(Action action) {
        ...
        public MeshInstance2DAction OnRenamed(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public MeshInstance2DAction RemoveOnRenamed(Action action) {
        ...
        public MeshInstance2DAction OnScriptChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public MeshInstance2DAction RemoveOnScriptChanged(Action action) {
        ...
        public MeshInstance2DAction OnTextureChanged(Action action, bool oneShot = false, bool deferred = false) {
            if (_onTextureChangedAction == null || _onTextureChangedAction.Count == 0) {
                _onTextureChangedAction ??= new List<Action>(); 
                GetParent().Connect("texture_changed", this, nameof(_GodotSignalTextureChanged));
            }
            _onTextureChangedAction.Add(action);
            return this;
        }
        public MeshInstance2DAction RemoveOnTextureChanged(Action action) {
            ...
            if (_onTextureChangedAction.Count == 0) {
                GetParent().Disconnect("texture_changed", this, nameof(_GodotSignalTextureChanged));
            }
            return this;
        }
        ...
        public MeshInstance2DAction OnTreeEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public MeshInstance2DAction RemoveOnTreeEntered(Action action) {
        ...
        public MeshInstance2DAction OnTreeExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public MeshInstance2DAction RemoveOnTreeExited(Action action) {
        ...
        public MeshInstance2DAction OnTreeExiting(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public MeshInstance2DAction RemoveOnTreeExiting(Action action) {
        ...
        public MeshInstance2DAction OnVisibilityChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public MeshInstance2DAction RemoveOnVisibilityChanged(Action action) {
