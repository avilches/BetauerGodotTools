...
namespace Betauer.GodotAction {
    public class MeshInstance2DAction : MeshInstance2D {
        ...
        public MeshInstance2DAction OnDraw(Action action) {
        ...
        public MeshInstance2DAction OnHide(Action action) {
        ...
        public MeshInstance2DAction OnItemRectChanged(Action action) {
        ...
        public MeshInstance2DAction OnReady(Action action) {
        ...
        public MeshInstance2DAction OnRenamed(Action action) {
        ...
        public MeshInstance2DAction OnScriptChanged(Action action) {
        ...
        public MeshInstance2DAction OnTextureChanged(Action action) {
            if (_onTextureChangedAction == null || _onTextureChangedAction.Count == 0) {
                _onTextureChangedAction ??= new List<Action>(); 
                Connect("texture_changed", this, nameof(_GodotSignalTextureChanged));
            }
        ...
        public MeshInstance2DAction RemoveOnTextureChanged(Action action) {
            ...
            if (_onTextureChangedAction.Count == 0) {
                Disconnect("texture_changed", this, nameof(_GodotSignalTextureChanged));
            }
            return this;
        }
        ...
        public MeshInstance2DAction OnTreeEntered(Action action) {
        ...
        public MeshInstance2DAction OnTreeExited(Action action) {
        ...
        public MeshInstance2DAction OnTreeExiting(Action action) {
        ...
        public MeshInstance2DAction OnVisibilityChanged(Action action) {
