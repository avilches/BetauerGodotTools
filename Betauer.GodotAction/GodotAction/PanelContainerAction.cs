...
namespace Betauer.GodotAction {
    public class PanelContainerAction : Node {
        public PanelContainerAction() {
            SetProcess(false);
        ...
        public PanelContainerAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public PanelContainerAction OnPhysicsProcess(Action<float> action) {
        ...
        public PanelContainerAction OnInput(Action<InputEvent> action) {
        ...
        public PanelContainerAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public PanelContainerAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public PanelContainerAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public PanelContainerAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public PanelContainerAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public PanelContainerAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public PanelContainerAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
