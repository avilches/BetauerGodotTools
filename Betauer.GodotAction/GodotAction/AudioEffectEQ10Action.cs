...
namespace Betauer.GodotAction {
    public class AudioEffectEQ10Action : AudioEffectEQ10 {


        private Action? _onChangedAction; 
        public AudioEffectEQ10Action OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public AudioEffectEQ10Action RemoveOnChanged() {
        ...
        public AudioEffectEQ10Action OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public AudioEffectEQ10Action RemoveOnScriptChanged() {
