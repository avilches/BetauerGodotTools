...
namespace Betauer.GodotAction {
    public class CSGTorusAction : Node {
        public CSGTorusAction() {
            SetProcess(false);
        ...
        public CSGTorusAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public CSGTorusAction OnPhysicsProcess(Action<float> action) {
        ...
        public CSGTorusAction OnInput(Action<InputEvent> action) {
        ...
        public CSGTorusAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public CSGTorusAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public CSGTorusAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public CSGTorusAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public CSGTorusAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public CSGTorusAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public CSGTorusAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
