...
namespace Betauer.GodotAction {
    public class CSGTorusAction : CSGTorus {
        ...
        public CSGTorusAction OnGameplayEntered(Action action) {
        ...
        public CSGTorusAction OnGameplayExited(Action action) {
        ...
        public CSGTorusAction OnReady(Action action) {
        ...
        public CSGTorusAction OnRenamed(Action action) {
        ...
        public CSGTorusAction OnScriptChanged(Action action) {
        ...
        public CSGTorusAction OnTreeEntered(Action action) {
        ...
        public CSGTorusAction OnTreeExited(Action action) {
        ...
        public CSGTorusAction OnTreeExiting(Action action) {
        ...
        public CSGTorusAction OnVisibilityChanged(Action action) {
