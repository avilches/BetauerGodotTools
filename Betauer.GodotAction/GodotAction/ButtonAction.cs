...
namespace Betauer.GodotAction {
    public class ButtonAction : Button {
        ...
        public ButtonAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public ButtonAction OnPhysicsProcess(Action<float> action) {
        ...
        public ButtonAction OnInput(Action<InputEvent> action) {
        ...
        public ButtonAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public ButtonAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public ButtonAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public ButtonAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public ButtonAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public ButtonAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public ButtonAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public ButtonAction OnItemRectChanged(Action action) {
        ...
        public ButtonAction RemoveOnItemRectChanged() {
        ...
        public ButtonAction OnMinimumSizeChanged(Action action) {
        ...
        public ButtonAction RemoveOnMinimumSizeChanged() {
        ...
        public ButtonAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public ButtonAction RemoveOnScriptChanged() {
        ...
        public ButtonAction OnSizeFlagsChanged(Action action) {
        ...
        public ButtonAction RemoveOnSizeFlagsChanged() {
        ...
        public ButtonAction OnVisibilityChanged(Action action) {
        ...
        public ButtonAction RemoveOnVisibilityChanged() {
