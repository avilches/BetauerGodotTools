...
namespace Betauer.GodotAction {
    public class VisualScriptConstantAction : VisualScriptConstant {


        private Action? _onChangedAction; 
        public VisualScriptConstantAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public VisualScriptConstantAction RemoveOnChanged() {
        ...
        public VisualScriptConstantAction OnPortsChanged(Action action) {
            if (_onPortsChangedAction == null) 
                Connect("ports_changed", this, nameof(ExecutePortsChanged));
            _onPortsChangedAction = action;
            return this;
        }
        public VisualScriptConstantAction RemoveOnPortsChanged() {
        ...
        public VisualScriptConstantAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public VisualScriptConstantAction RemoveOnScriptChanged() {
