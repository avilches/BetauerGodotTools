...
namespace Betauer.GodotAction {
    public class VisualShaderNodeTextureAction : VisualShaderNodeTexture {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeTextureAction OnChanged(Action action) {
        ...
        public VisualShaderNodeTextureAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeTextureAction OnScriptChanged(Action action) {
