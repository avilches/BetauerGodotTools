...
namespace Betauer.GodotAction {
    public class AudioEffectBandPassFilterAction : AudioEffectBandPassFilter {


        private List<Action>? _onChangedAction; 
        public AudioEffectBandPassFilterAction OnChanged(Action action) {
        ...
        public AudioEffectBandPassFilterAction OnScriptChanged(Action action) {
