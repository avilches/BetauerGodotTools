...
namespace Betauer.GodotAction {
    public class AudioEffectReverbAction : AudioEffectReverb {


        private List<Action>? _onChangedAction; 
        public AudioEffectReverbAction OnChanged(Action action) {
        ...
        public AudioEffectReverbAction OnScriptChanged(Action action) {
