...
namespace Betauer.GodotAction {
    public class DampedSpringJoint2DAction : Node {
        public DampedSpringJoint2DAction() {
            SetProcess(false);
        ...
        public DampedSpringJoint2DAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public DampedSpringJoint2DAction OnPhysicsProcess(Action<float> action) {
        ...
        public DampedSpringJoint2DAction OnInput(Action<InputEvent> action) {
        ...
        public DampedSpringJoint2DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public DampedSpringJoint2DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public DampedSpringJoint2DAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public DampedSpringJoint2DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public DampedSpringJoint2DAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public DampedSpringJoint2DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public DampedSpringJoint2DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
