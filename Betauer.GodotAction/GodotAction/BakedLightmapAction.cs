...
namespace Betauer.GodotAction {
    public class BakedLightmapAction : Node {
        public BakedLightmapAction() {
            SetProcess(false);
        ...
        public BakedLightmapAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public BakedLightmapAction OnPhysicsProcess(Action<float> action) {
        ...
        public BakedLightmapAction OnInput(Action<InputEvent> action) {
        ...
        public BakedLightmapAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public BakedLightmapAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public BakedLightmapAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public BakedLightmapAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public BakedLightmapAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public BakedLightmapAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public BakedLightmapAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
