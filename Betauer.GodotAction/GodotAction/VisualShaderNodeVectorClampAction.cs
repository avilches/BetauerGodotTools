...
namespace Betauer.GodotAction {
    public class VisualShaderNodeVectorClampAction : VisualShaderNodeVectorClamp {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeVectorClampAction OnChanged(Action action) {
        ...
        public VisualShaderNodeVectorClampAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeVectorClampAction OnScriptChanged(Action action) {
