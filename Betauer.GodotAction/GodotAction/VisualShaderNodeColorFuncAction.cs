...
namespace Betauer.GodotAction {
    public class VisualShaderNodeColorFuncAction : VisualShaderNodeColorFunc {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeColorFuncAction OnChanged(Action action) {
        ...
        public VisualShaderNodeColorFuncAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeColorFuncAction OnScriptChanged(Action action) {
