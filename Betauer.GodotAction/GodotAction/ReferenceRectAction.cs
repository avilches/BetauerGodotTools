...
namespace Betauer.GodotAction {
    public class ReferenceRectAction : Node {
        public ReferenceRectAction() {
            SetProcess(false);
        ...
        public ReferenceRectAction OnProcess(Action<float> action) {
        ...
        public ReferenceRectAction RemoveOnProcess(Action<float> action) {
