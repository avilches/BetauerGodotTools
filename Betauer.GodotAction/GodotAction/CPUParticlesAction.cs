...
namespace Betauer.GodotAction {
    public class CPUParticlesAction : Node {
        public CPUParticlesAction() {
            SetProcess(false);
        ...
        public CPUParticlesAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public CPUParticlesAction OnPhysicsProcess(Action<float> action) {
        ...
        public CPUParticlesAction OnInput(Action<InputEvent> action) {
        ...
        public CPUParticlesAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public CPUParticlesAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public CPUParticlesAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public CPUParticlesAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public CPUParticlesAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public CPUParticlesAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public CPUParticlesAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
