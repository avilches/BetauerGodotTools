    ...
    public class GraphNodeAction : GraphNode {
        ...
        public GraphNodeAction OnCloseRequest(Action action) {
            if (_onCloseRequestAction == null || _onCloseRequestAction.Count == 0) {
                ...
                Connect("close_request", this, nameof(_GodotSignalCloseRequest));
            }
        ...
        public GraphNodeAction RemoveOnCloseRequest(Action action) {
            ...
            if (_onCloseRequestAction.Count == 0) {
                Disconnect("close_request", this, nameof(_GodotSignalCloseRequest));
            }
            return this;
        }
        ...
        public GraphNodeAction OnOffsetChanged(Action action) {
            if (_onOffsetChangedAction == null || _onOffsetChangedAction.Count == 0) {
                ...
                Connect("offset_changed", this, nameof(_GodotSignalOffsetChanged));
            }
        ...
        public GraphNodeAction RemoveOnOffsetChanged(Action action) {
            ...
            if (_onOffsetChangedAction.Count == 0) {
                Disconnect("offset_changed", this, nameof(_GodotSignalOffsetChanged));
            }
            return this;
        }
        ...
        public GraphNodeAction OnRaiseRequest(Action action) {
            if (_onRaiseRequestAction == null || _onRaiseRequestAction.Count == 0) {
                ...
                Connect("raise_request", this, nameof(_GodotSignalRaiseRequest));
            }
        ...
        public GraphNodeAction RemoveOnRaiseRequest(Action action) {
            ...
            if (_onRaiseRequestAction.Count == 0) {
                Disconnect("raise_request", this, nameof(_GodotSignalRaiseRequest));
            }
            return this;
        }
        ...
        public GraphNodeAction OnResizeRequest(Action<Vector2> action) {
            if (_onResizeRequestAction == null || _onResizeRequestAction.Count == 0) {
                ...
                Connect("resize_request", this, nameof(_GodotSignalResizeRequest));
            }
        ...
        public GraphNodeAction RemoveOnResizeRequest(Action<Vector2> action) {
            ...
            if (_onResizeRequestAction.Count == 0) {
                Disconnect("resize_request", this, nameof(_GodotSignalResizeRequest));
            }
            return this;
        }
        ...
        public GraphNodeAction OnSlotUpdated(Action<int> action) {
            if (_onSlotUpdatedAction == null || _onSlotUpdatedAction.Count == 0) {
                ...
                Connect("slot_updated", this, nameof(_GodotSignalSlotUpdated));
            }
        ...
        public GraphNodeAction RemoveOnSlotUpdated(Action<int> action) {
            ...
            if (_onSlotUpdatedAction.Count == 0) {
                Disconnect("slot_updated", this, nameof(_GodotSignalSlotUpdated));
            }
            return this;
        }
