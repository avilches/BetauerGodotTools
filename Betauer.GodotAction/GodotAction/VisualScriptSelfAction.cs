...
namespace Betauer.GodotAction {
    public class VisualScriptSelfAction : VisualScriptSelf {


        private List<Action>? _onChangedAction; 
        public VisualScriptSelfAction OnChanged(Action action) {
        ...
        public VisualScriptSelfAction OnPortsChanged(Action action) {
        ...
        public VisualScriptSelfAction OnScriptChanged(Action action) {
