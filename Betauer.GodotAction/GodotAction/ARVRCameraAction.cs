...
namespace Betauer.GodotAction {
    public class ARVRCameraAction : Node {
        public ARVRCameraAction() {
            SetProcess(false);
        ...
        public ARVRCameraAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public ARVRCameraAction OnPhysicsProcess(Action<float> action) {
        ...
        public ARVRCameraAction OnInput(Action<InputEvent> action) {
        ...
        public ARVRCameraAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public ARVRCameraAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public ARVRCameraAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public ARVRCameraAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public ARVRCameraAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public ARVRCameraAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public ARVRCameraAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
