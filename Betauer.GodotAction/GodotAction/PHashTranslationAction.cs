...
namespace Betauer.GodotAction {
    public class PHashTranslationAction : PHashTranslation {


        private List<Action>? _onChangedAction; 
        public PHashTranslationAction OnChanged(Action action) {
        ...
        public PHashTranslationAction OnScriptChanged(Action action) {
