...
namespace Betauer.GodotAction {
    public class VisualShaderNodeTextureUniformTriplanarAction : VisualShaderNodeTextureUniformTriplanar {


        private Action? _onChangedAction; 
        public VisualShaderNodeTextureUniformTriplanarAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public VisualShaderNodeTextureUniformTriplanarAction RemoveOnChanged() {
        ...
        public VisualShaderNodeTextureUniformTriplanarAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeTextureUniformTriplanarAction RemoveOnEditorRefreshRequest() {
        ...
        public VisualShaderNodeTextureUniformTriplanarAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public VisualShaderNodeTextureUniformTriplanarAction RemoveOnScriptChanged() {
