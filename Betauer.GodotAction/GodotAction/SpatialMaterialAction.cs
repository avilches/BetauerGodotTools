...
namespace Betauer.GodotAction {
    public class SpatialMaterialAction : SpatialMaterial {


        private List<Action>? _onChangedAction; 
        public SpatialMaterialAction OnChanged(Action action) {
        ...
        public SpatialMaterialAction OnScriptChanged(Action action) {
