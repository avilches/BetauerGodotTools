...
namespace Betauer.GodotAction {
    public class VisualScriptSwitchAction : VisualScriptSwitch {


        private Action? _onChangedAction; 
        public VisualScriptSwitchAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public VisualScriptSwitchAction RemoveOnChanged() {
        ...
        public VisualScriptSwitchAction OnPortsChanged(Action action) {
            if (_onPortsChangedAction == null) 
                Connect("ports_changed", this, nameof(ExecutePortsChanged));
            _onPortsChangedAction = action;
            return this;
        }
        public VisualScriptSwitchAction RemoveOnPortsChanged() {
        ...
        public VisualScriptSwitchAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public VisualScriptSwitchAction RemoveOnScriptChanged() {
