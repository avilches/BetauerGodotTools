...
namespace Betauer.GodotAction {
    public class FileDialogAction : Node {
        ...
        public FileDialogAction OnDirSelected(Action<string> action, bool oneShot = false, bool deferred = false) {
            if (_onDirSelectedAction == null || _onDirSelectedAction.Count == 0) {
                ...
                GetParent().Connect("dir_selected", this, nameof(_GodotSignalDirSelected));
            }
        ...
        public FileDialogAction RemoveOnDirSelected(Action<string> action) {
            ...
            if (_onDirSelectedAction.Count == 0) {
                GetParent().Disconnect("dir_selected", this, nameof(_GodotSignalDirSelected));
            }
            return this;
        }
        private void _GodotSignalDirSelected(string dir) {
        ...
        public FileDialogAction OnFileSelected(Action<string> action, bool oneShot = false, bool deferred = false) {
            if (_onFileSelectedAction == null || _onFileSelectedAction.Count == 0) {
                ...
                GetParent().Connect("file_selected", this, nameof(_GodotSignalFileSelected));
            }
        ...
        public FileDialogAction RemoveOnFileSelected(Action<string> action) {
            ...
            if (_onFileSelectedAction.Count == 0) {
                GetParent().Disconnect("file_selected", this, nameof(_GodotSignalFileSelected));
            }
            return this;
        }
        private void _GodotSignalFileSelected(string path) {
        ...
        public FileDialogAction OnFilesSelected(Action<string[]> action, bool oneShot = false, bool deferred = false) {
            if (_onFilesSelectedAction == null || _onFilesSelectedAction.Count == 0) {
                ...
                GetParent().Connect("files_selected", this, nameof(_GodotSignalFilesSelected));
            }
        ...
        public FileDialogAction RemoveOnFilesSelected(Action<string[]> action) {
            ...
            if (_onFilesSelectedAction.Count == 0) {
                GetParent().Disconnect("files_selected", this, nameof(_GodotSignalFilesSelected));
            }
            return this;
        }
        private void _GodotSignalFilesSelected(string[] paths) {
