...
namespace Betauer.GodotAction {
    public class FileDialogAction : ProxyNode {
        ...
        public void OnDirSelected(Action<string> action, bool oneShot = false, bool deferred = false) =>
            AddSignal(ref _onDirSelectedAction, "dir_selected", nameof(_GodotSignalDirSelected), action, oneShot, deferred);

        public void RemoveOnDirSelected(Action<string> action) =>
        ...
        public void OnFileSelected(Action<string> action, bool oneShot = false, bool deferred = false) =>
            AddSignal(ref _onFileSelectedAction, "file_selected", nameof(_GodotSignalFileSelected), action, oneShot, deferred);

        public void RemoveOnFileSelected(Action<string> action) =>
        ...
        public void OnFilesSelected(Action<string[]> action, bool oneShot = false, bool deferred = false) =>
            AddSignal(ref _onFilesSelectedAction, "files_selected", nameof(_GodotSignalFilesSelected), action, oneShot, deferred);

        public void RemoveOnFilesSelected(Action<string[]> action) =>
