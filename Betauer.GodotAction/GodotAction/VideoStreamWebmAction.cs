...
namespace Betauer.GodotAction {
    public class VideoStreamWebmAction : VideoStreamWebm {


        private Action? _onChangedAction; 
        public VideoStreamWebmAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public VideoStreamWebmAction RemoveOnChanged() {
        ...
        public VideoStreamWebmAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public VideoStreamWebmAction RemoveOnScriptChanged() {
