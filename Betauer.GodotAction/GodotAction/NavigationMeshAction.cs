...
namespace Betauer.GodotAction {
    public class NavigationMeshAction : NavigationMesh {


        private List<Action>? _onChangedAction; 
        public NavigationMeshAction OnChanged(Action action) {
        ...
        public NavigationMeshAction OnScriptChanged(Action action) {
