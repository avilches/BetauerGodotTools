...
namespace Betauer.GodotAction {
    public class VisualShaderNodeCompareAction : VisualShaderNodeCompare {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeCompareAction OnChanged(Action action) {
        ...
        public VisualShaderNodeCompareAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeCompareAction OnScriptChanged(Action action) {
