...
namespace Betauer.GodotAction {
    public class SkeletonAction : Node {
        ...
        public SkeletonAction OnSkeletonUpdated(Action action, bool oneShot = false, bool deferred = false) {
            if (_onSkeletonUpdatedAction == null || _onSkeletonUpdatedAction.Count == 0) {
                ...
                GetParent().Connect("skeleton_updated", this, nameof(_GodotSignalSkeletonUpdated));
            }
        ...
        public SkeletonAction RemoveOnSkeletonUpdated(Action action) {
            ...
            if (_onSkeletonUpdatedAction.Count == 0) {
                GetParent().Disconnect("skeleton_updated", this, nameof(_GodotSignalSkeletonUpdated));
            }
            return this;
        }
