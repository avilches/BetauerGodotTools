...
namespace Betauer.GodotAction {
    public class VisualScriptPropertyGetAction : VisualScriptPropertyGet {


        private List<Action>? _onChangedAction; 
        public VisualScriptPropertyGetAction OnChanged(Action action) {
        ...
        public VisualScriptPropertyGetAction OnPortsChanged(Action action) {
        ...
        public VisualScriptPropertyGetAction OnScriptChanged(Action action) {
