...
namespace Betauer.GodotAction {
    public class DynamicFontDataAction : DynamicFontData {


        private List<Action>? _onChangedAction; 
        public DynamicFontDataAction OnChanged(Action action) {
        ...
        public DynamicFontDataAction OnScriptChanged(Action action) {
