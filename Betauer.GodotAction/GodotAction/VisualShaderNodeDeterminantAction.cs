...
namespace Betauer.GodotAction {
    public class VisualShaderNodeDeterminantAction : VisualShaderNodeDeterminant {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeDeterminantAction OnChanged(Action action) {
        ...
        public VisualShaderNodeDeterminantAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeDeterminantAction OnScriptChanged(Action action) {
