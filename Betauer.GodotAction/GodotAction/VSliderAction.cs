...
namespace Betauer.GodotAction {
    public class VSliderAction : Node {
        public VSliderAction() {
            SetProcess(false);
        ...
        public VSliderAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public VSliderAction OnPhysicsProcess(Action<float> action) {
        ...
        public VSliderAction OnInput(Action<InputEvent> action) {
        ...
        public VSliderAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public VSliderAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public VSliderAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public VSliderAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public VSliderAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public VSliderAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public VSliderAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
