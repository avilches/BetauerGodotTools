...
namespace Betauer.GodotAction {
    public class VisualScriptResourcePathAction : VisualScriptResourcePath {


        private List<Action>? _onChangedAction; 
        public VisualScriptResourcePathAction OnChanged(Action action) {
        ...
        public VisualScriptResourcePathAction OnPortsChanged(Action action) {
        ...
        public VisualScriptResourcePathAction OnScriptChanged(Action action) {
