...
namespace Betauer.GodotAction {
    public class OccluderAction : Node {
        public OccluderAction() {
            SetProcess(false);
        ...
        public OccluderAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public OccluderAction OnPhysicsProcess(Action<float> action) {
        ...
        public OccluderAction OnInput(Action<InputEvent> action) {
        ...
        public OccluderAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public OccluderAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public OccluderAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public OccluderAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public OccluderAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public OccluderAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public OccluderAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
