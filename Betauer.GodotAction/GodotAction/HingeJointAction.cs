...
namespace Betauer.GodotAction {
    public class HingeJointAction : Node {
        public HingeJointAction() {
            SetProcess(false);
        ...
        public HingeJointAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public HingeJointAction OnPhysicsProcess(Action<float> action) {
        ...
        public HingeJointAction OnInput(Action<InputEvent> action) {
        ...
        public HingeJointAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public HingeJointAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public HingeJointAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public HingeJointAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public HingeJointAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public HingeJointAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public HingeJointAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public HingeJointAction OnGameplayEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public HingeJointAction RemoveOnGameplayEntered(Action action) {
        ...
        public HingeJointAction OnGameplayExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public HingeJointAction RemoveOnGameplayExited(Action action) {
        ...
        public HingeJointAction OnReady(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public HingeJointAction RemoveOnReady(Action action) {
        ...
        public HingeJointAction OnRenamed(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public HingeJointAction RemoveOnRenamed(Action action) {
        ...
        public HingeJointAction OnScriptChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public HingeJointAction RemoveOnScriptChanged(Action action) {
        ...
        public HingeJointAction OnTreeEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public HingeJointAction RemoveOnTreeEntered(Action action) {
        ...
        public HingeJointAction OnTreeExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public HingeJointAction RemoveOnTreeExited(Action action) {
        ...
        public HingeJointAction OnTreeExiting(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public HingeJointAction RemoveOnTreeExiting(Action action) {
        ...
        public HingeJointAction OnVisibilityChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public HingeJointAction RemoveOnVisibilityChanged(Action action) {
