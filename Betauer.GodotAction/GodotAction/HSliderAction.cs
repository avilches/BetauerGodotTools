...
namespace Betauer.GodotAction {
    public class HSliderAction : Node {
        public HSliderAction() {
            SetProcess(false);
        ...
        public HSliderAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public HSliderAction OnPhysicsProcess(Action<float> action) {
        ...
        public HSliderAction OnInput(Action<InputEvent> action) {
        ...
        public HSliderAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public HSliderAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public HSliderAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public HSliderAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public HSliderAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public HSliderAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public HSliderAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
