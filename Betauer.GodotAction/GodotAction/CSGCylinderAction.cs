...
namespace Betauer.GodotAction {
    public class CSGCylinderAction : CSGCylinder {
        ...
        public CSGCylinderAction OnProcessAction(Action<float> action) {
        ...
        public CSGCylinderAction RemoveOnProcessAction(Action<float> action) {
        ...
        public CSGCylinderAction OnGameplayEntered(Action action) {
        ...
        public CSGCylinderAction RemoveOnGameplayEntered() {
        ...
        public CSGCylinderAction OnReady(Action action) {
            if (_onReadyAction == null) 
                Connect("ready", this, nameof(ExecuteReady));
            _onReadyAction = action;
            return this;
        }
        public CSGCylinderAction RemoveOnReady() {
        ...
        public CSGCylinderAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public CSGCylinderAction RemoveOnScriptChanged() {
        ...
        public CSGCylinderAction OnVisibilityChanged(Action action) {
        ...
        public CSGCylinderAction RemoveOnVisibilityChanged() {
