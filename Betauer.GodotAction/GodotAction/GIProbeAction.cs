...
namespace Betauer.GodotAction {
    public class GIProbeAction : GIProbe {
        ...
        public GIProbeAction OnGameplayEntered(Action action) {
        ...
        public GIProbeAction OnGameplayExited(Action action) {
        ...
        public GIProbeAction OnReady(Action action) {
        ...
        public GIProbeAction OnRenamed(Action action) {
        ...
        public GIProbeAction OnScriptChanged(Action action) {
        ...
        public GIProbeAction OnTreeEntered(Action action) {
        ...
        public GIProbeAction OnTreeExited(Action action) {
        ...
        public GIProbeAction OnTreeExiting(Action action) {
        ...
        public GIProbeAction OnVisibilityChanged(Action action) {
