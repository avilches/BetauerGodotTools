...
namespace Betauer.GodotAction {
    public class GIProbeAction : Node {
        public GIProbeAction() {
            SetProcess(false);
        ...
        public GIProbeAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public GIProbeAction OnPhysicsProcess(Action<float> action) {
        ...
        public GIProbeAction OnInput(Action<InputEvent> action) {
        ...
        public GIProbeAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public GIProbeAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public GIProbeAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public GIProbeAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public GIProbeAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public GIProbeAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public GIProbeAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
