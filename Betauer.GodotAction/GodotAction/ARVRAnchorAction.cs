...
namespace Betauer.GodotAction {
    public class ARVRAnchorAction : Node {
        public ARVRAnchorAction() {
            SetProcess(false);
        ...
        public ARVRAnchorAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public ARVRAnchorAction OnPhysicsProcess(Action<float> action) {
        ...
        public ARVRAnchorAction OnInput(Action<InputEvent> action) {
        ...
        public ARVRAnchorAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public ARVRAnchorAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public ARVRAnchorAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public ARVRAnchorAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public ARVRAnchorAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public ARVRAnchorAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public ARVRAnchorAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public ARVRAnchorAction OnGameplayEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public ARVRAnchorAction RemoveOnGameplayEntered(Action action) {
        ...
        public ARVRAnchorAction OnGameplayExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public ARVRAnchorAction RemoveOnGameplayExited(Action action) {
        ...
        public ARVRAnchorAction OnMeshUpdated(Action<Mesh> action, bool oneShot = false, bool deferred = false) {
            if (_onMeshUpdatedAction == null || _onMeshUpdatedAction.Count == 0) {
                _onMeshUpdatedAction ??= new List<Action<Mesh>>(); 
                GetParent().Connect("mesh_updated", this, nameof(_GodotSignalMeshUpdated));
            }
            _onMeshUpdatedAction.Add(action);
            return this;
        }
        public ARVRAnchorAction RemoveOnMeshUpdated(Action<Mesh> action) {
            ...
            if (_onMeshUpdatedAction.Count == 0) {
                GetParent().Disconnect("mesh_updated", this, nameof(_GodotSignalMeshUpdated));
            }
            return this;
        }
        ...
        public ARVRAnchorAction OnReady(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public ARVRAnchorAction RemoveOnReady(Action action) {
        ...
        public ARVRAnchorAction OnRenamed(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public ARVRAnchorAction RemoveOnRenamed(Action action) {
        ...
        public ARVRAnchorAction OnScriptChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public ARVRAnchorAction RemoveOnScriptChanged(Action action) {
        ...
        public ARVRAnchorAction OnTreeEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public ARVRAnchorAction RemoveOnTreeEntered(Action action) {
        ...
        public ARVRAnchorAction OnTreeExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public ARVRAnchorAction RemoveOnTreeExited(Action action) {
        ...
        public ARVRAnchorAction OnTreeExiting(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public ARVRAnchorAction RemoveOnTreeExiting(Action action) {
        ...
        public ARVRAnchorAction OnVisibilityChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public ARVRAnchorAction RemoveOnVisibilityChanged(Action action) {
