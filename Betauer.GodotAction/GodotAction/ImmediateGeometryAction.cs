...
namespace Betauer.GodotAction {
    public class ImmediateGeometryAction : Node {
        public ImmediateGeometryAction() {
            SetProcess(false);
        ...
        public ImmediateGeometryAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public ImmediateGeometryAction OnPhysicsProcess(Action<float> action) {
        ...
        public ImmediateGeometryAction OnInput(Action<InputEvent> action) {
        ...
        public ImmediateGeometryAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public ImmediateGeometryAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public ImmediateGeometryAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public ImmediateGeometryAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public ImmediateGeometryAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public ImmediateGeometryAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public ImmediateGeometryAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
