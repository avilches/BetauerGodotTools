...
namespace Betauer.GodotAction {
    public class YSortAction : Node {
        ...
        public YSortAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public YSortAction OnPhysicsProcess(Action<float> action) {
        ...
        public YSortAction OnInput(Action<InputEvent> action) {
        ...
        public YSortAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public YSortAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public YSortAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public YSortAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public YSortAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public YSortAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public YSortAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public YSortAction OnDraw(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public YSortAction RemoveOnDraw(Action action) {
        ...
        public YSortAction OnHide(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public YSortAction RemoveOnHide(Action action) {
        ...
        public YSortAction OnItemRectChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public YSortAction RemoveOnItemRectChanged(Action action) {
        ...
        public YSortAction OnReady(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public YSortAction RemoveOnReady(Action action) {
        ...
        public YSortAction OnRenamed(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public YSortAction RemoveOnRenamed(Action action) {
        ...
        public YSortAction OnScriptChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public YSortAction RemoveOnScriptChanged(Action action) {
        ...
        public YSortAction OnTreeEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public YSortAction RemoveOnTreeEntered(Action action) {
        ...
        public YSortAction OnTreeExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public YSortAction RemoveOnTreeExited(Action action) {
        ...
        public YSortAction OnTreeExiting(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public YSortAction RemoveOnTreeExiting(Action action) {
        ...
        public YSortAction OnVisibilityChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public YSortAction RemoveOnVisibilityChanged(Action action) {
