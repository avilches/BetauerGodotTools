...
namespace Betauer.GodotAction {
    public class PhysicsMaterialAction : PhysicsMaterial {


        private Action? _onChangedAction; 
        public PhysicsMaterialAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public PhysicsMaterialAction RemoveOnChanged() {
        ...
        public PhysicsMaterialAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public PhysicsMaterialAction RemoveOnScriptChanged() {
