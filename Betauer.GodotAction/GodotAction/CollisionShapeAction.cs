...
namespace Betauer.GodotAction {
    public class CollisionShapeAction : Node {
        public CollisionShapeAction() {
            SetProcess(false);
        ...
        public CollisionShapeAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public CollisionShapeAction OnPhysicsProcess(Action<float> action) {
        ...
        public CollisionShapeAction OnInput(Action<InputEvent> action) {
        ...
        public CollisionShapeAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public CollisionShapeAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public CollisionShapeAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public CollisionShapeAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public CollisionShapeAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public CollisionShapeAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public CollisionShapeAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
