...
namespace Betauer.GodotAction {
    public class TextureRectAction : Node {
        public TextureRectAction() {
            SetProcess(false);
        ...
        public TextureRectAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public TextureRectAction OnPhysicsProcess(Action<float> action) {
        ...
        public TextureRectAction OnInput(Action<InputEvent> action) {
        ...
        public TextureRectAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public TextureRectAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public TextureRectAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public TextureRectAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public TextureRectAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public TextureRectAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public TextureRectAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
