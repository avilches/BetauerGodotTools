...
namespace Betauer.GodotAction {
    public class VisualShaderNodeExpressionAction : ProxyNode {
        ...
        private VisualShaderNodeExpressionAction _GodotSignalChanged() {
        ...
        private VisualShaderNodeExpressionAction _GodotSignalEditorRefreshRequest() {
        ...
        private VisualShaderNodeExpressionAction _GodotSignalScriptChanged() {
