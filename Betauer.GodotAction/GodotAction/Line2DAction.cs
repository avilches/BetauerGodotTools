...
namespace Betauer.GodotAction {
    public class Line2DAction : Node {
        public Line2DAction() {
            SetProcess(false);
        ...
        public Line2DAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public Line2DAction OnPhysicsProcess(Action<float> action) {
        ...
        public Line2DAction OnInput(Action<InputEvent> action) {
        ...
        public Line2DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public Line2DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public Line2DAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public Line2DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public Line2DAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public Line2DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public Line2DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
