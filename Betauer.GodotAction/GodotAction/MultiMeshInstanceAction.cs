...
namespace Betauer.GodotAction {
    public class MultiMeshInstanceAction : Node {
        public MultiMeshInstanceAction() {
            SetProcess(false);
        ...
        public MultiMeshInstanceAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public MultiMeshInstanceAction OnPhysicsProcess(Action<float> action) {
        ...
        public MultiMeshInstanceAction OnInput(Action<InputEvent> action) {
        ...
        public MultiMeshInstanceAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public MultiMeshInstanceAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public MultiMeshInstanceAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public MultiMeshInstanceAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public MultiMeshInstanceAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public MultiMeshInstanceAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public MultiMeshInstanceAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
