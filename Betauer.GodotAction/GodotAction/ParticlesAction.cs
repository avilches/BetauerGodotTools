...
namespace Betauer.GodotAction {
    public class ParticlesAction : Node {
        public ParticlesAction() {
            SetProcess(false);
        ...
        public ParticlesAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public ParticlesAction OnPhysicsProcess(Action<float> action) {
        ...
        public ParticlesAction OnInput(Action<InputEvent> action) {
        ...
        public ParticlesAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public ParticlesAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public ParticlesAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public ParticlesAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public ParticlesAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public ParticlesAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public ParticlesAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
