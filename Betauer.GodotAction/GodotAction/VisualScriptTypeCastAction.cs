...
namespace Betauer.GodotAction {
    public class VisualScriptTypeCastAction : VisualScriptTypeCast {


        private List<Action>? _onChangedAction; 
        public VisualScriptTypeCastAction OnChanged(Action action) {
        ...
        public VisualScriptTypeCastAction OnPortsChanged(Action action) {
        ...
        public VisualScriptTypeCastAction OnScriptChanged(Action action) {
