...
namespace Betauer.GodotAction {
    public class VisualShaderNodeIfAction : VisualShaderNodeIf {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeIfAction OnChanged(Action action) {
        ...
        public VisualShaderNodeIfAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeIfAction OnScriptChanged(Action action) {
