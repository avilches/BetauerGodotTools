...
namespace Betauer.GodotAction {
    public class ResourcePreloaderAction : Node {
        public ResourcePreloaderAction() {
            SetProcess(false);
        ...
        public ResourcePreloaderAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public ResourcePreloaderAction OnPhysicsProcess(Action<float> action) {
        ...
        public ResourcePreloaderAction OnInput(Action<InputEvent> action) {
        ...
        public ResourcePreloaderAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public ResourcePreloaderAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public ResourcePreloaderAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public ResourcePreloaderAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public ResourcePreloaderAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public ResourcePreloaderAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public ResourcePreloaderAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
