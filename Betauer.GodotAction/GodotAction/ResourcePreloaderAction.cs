...
namespace Betauer.GodotAction {
    public class ResourcePreloaderAction : ResourcePreloader {
        ...
        public ResourcePreloaderAction OnReady(Action action) {
        ...
        public ResourcePreloaderAction OnRenamed(Action action) {
        ...
        public ResourcePreloaderAction OnScriptChanged(Action action) {
        ...
        public ResourcePreloaderAction OnTreeEntered(Action action) {
        ...
        public ResourcePreloaderAction OnTreeExited(Action action) {
        ...
        public ResourcePreloaderAction OnTreeExiting(Action action) {
