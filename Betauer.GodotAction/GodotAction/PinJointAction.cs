...
namespace Betauer.GodotAction {
    public class PinJointAction : Node {
        public PinJointAction() {
            SetProcess(false);
        ...
        public PinJointAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public PinJointAction OnPhysicsProcess(Action<float> action) {
        ...
        public PinJointAction OnInput(Action<InputEvent> action) {
        ...
        public PinJointAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public PinJointAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public PinJointAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public PinJointAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public PinJointAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public PinJointAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public PinJointAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
