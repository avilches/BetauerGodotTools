...
namespace Betauer.GodotAction {
    public class AudioBusLayoutAction : AudioBusLayout {


        private List<Action>? _onChangedAction; 
        public AudioBusLayoutAction OnChanged(Action action) {
        ...
        public AudioBusLayoutAction OnScriptChanged(Action action) {
