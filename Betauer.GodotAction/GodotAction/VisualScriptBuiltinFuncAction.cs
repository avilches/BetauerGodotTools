...
namespace Betauer.GodotAction {
    public class VisualScriptBuiltinFuncAction : VisualScriptBuiltinFunc {


        private Action? _onChangedAction; 
        public VisualScriptBuiltinFuncAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public VisualScriptBuiltinFuncAction RemoveOnChanged() {
        ...
        public VisualScriptBuiltinFuncAction OnPortsChanged(Action action) {
            if (_onPortsChangedAction == null) 
                Connect("ports_changed", this, nameof(ExecutePortsChanged));
            _onPortsChangedAction = action;
            return this;
        }
        public VisualScriptBuiltinFuncAction RemoveOnPortsChanged() {
        ...
        public VisualScriptBuiltinFuncAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public VisualScriptBuiltinFuncAction RemoveOnScriptChanged() {
