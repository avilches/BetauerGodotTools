...
namespace Betauer.GodotAction {
    public class AudioStreamSampleAction : AudioStreamSample {


        private List<Action>? _onChangedAction; 
        public AudioStreamSampleAction OnChanged(Action action) {
        ...
        public AudioStreamSampleAction OnScriptChanged(Action action) {
