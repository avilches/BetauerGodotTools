...
namespace Betauer.GodotAction {
    public class HSplitContainerAction : Node {
        public HSplitContainerAction() {
            SetProcess(false);
        ...
        public HSplitContainerAction OnProcess(Action<float> action) {
        ...
        public HSplitContainerAction RemoveOnProcess(Action<float> action) {
