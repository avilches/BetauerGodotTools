...
namespace Betauer.GodotAction {
    public class VisualShaderNodeVec3UniformAction : VisualShaderNodeVec3Uniform {


        private Action? _onChangedAction; 
        public VisualShaderNodeVec3UniformAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public VisualShaderNodeVec3UniformAction RemoveOnChanged() {
        ...
        public VisualShaderNodeVec3UniformAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeVec3UniformAction RemoveOnEditorRefreshRequest() {
        ...
        public VisualShaderNodeVec3UniformAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public VisualShaderNodeVec3UniformAction RemoveOnScriptChanged() {
