...
namespace Betauer.GodotAction {
    public class ParallaxBackgroundAction : Node {
        public ParallaxBackgroundAction() {
            SetProcess(false);
        ...
        public ParallaxBackgroundAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public ParallaxBackgroundAction OnPhysicsProcess(Action<float> action) {
        ...
        public ParallaxBackgroundAction OnInput(Action<InputEvent> action) {
        ...
        public ParallaxBackgroundAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public ParallaxBackgroundAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public ParallaxBackgroundAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public ParallaxBackgroundAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public ParallaxBackgroundAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public ParallaxBackgroundAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public ParallaxBackgroundAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public ParallaxBackgroundAction RemoveOnReady(Action action) {
        ...
        public ParallaxBackgroundAction OnRenamed(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public ParallaxBackgroundAction RemoveOnRenamed(Action action) {
        ...
        public ParallaxBackgroundAction OnScriptChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public ParallaxBackgroundAction RemoveOnScriptChanged(Action action) {
        ...
        public ParallaxBackgroundAction OnTreeEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public ParallaxBackgroundAction RemoveOnTreeEntered(Action action) {
        ...
        public ParallaxBackgroundAction OnTreeExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public ParallaxBackgroundAction RemoveOnTreeExited(Action action) {
        ...
        public ParallaxBackgroundAction OnTreeExiting(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public ParallaxBackgroundAction RemoveOnTreeExiting(Action action) {
