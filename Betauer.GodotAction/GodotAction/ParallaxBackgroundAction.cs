...
namespace Betauer.GodotAction {
    public class ParallaxBackgroundAction : ParallaxBackground {
        ...
        public ParallaxBackgroundAction OnReady(Action action) {
        ...
        public ParallaxBackgroundAction OnRenamed(Action action) {
        ...
        public ParallaxBackgroundAction OnScriptChanged(Action action) {
        ...
        public ParallaxBackgroundAction OnTreeEntered(Action action) {
        ...
        public ParallaxBackgroundAction OnTreeExited(Action action) {
        ...
        public ParallaxBackgroundAction OnTreeExiting(Action action) {
