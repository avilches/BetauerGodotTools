...
namespace Betauer.GodotAction {
    public class CircleShape2DAction : CircleShape2D {


        private List<Action>? _onChangedAction; 
        public CircleShape2DAction OnChanged(Action action) {
        ...
        public CircleShape2DAction OnScriptChanged(Action action) {
