    ...
    public class RichTextLabelAction : RichTextLabel {
        ...
        public RichTextLabelAction OnMetaClicked(Action<object> action) {
            if (_onMetaClickedAction == null || _onMetaClickedAction.Count == 0) {
                ...
                Connect("meta_clicked", this, nameof(_GodotSignalMetaClicked));
            }
        ...
        public RichTextLabelAction RemoveOnMetaClicked(Action<object> action) {
            ...
            if (_onMetaClickedAction.Count == 0) {
                Disconnect("meta_clicked", this, nameof(_GodotSignalMetaClicked));
            }
            return this;
        }
        ...
        public RichTextLabelAction OnMetaHoverEnded(Action<object> action) {
            if (_onMetaHoverEndedAction == null || _onMetaHoverEndedAction.Count == 0) {
                ...
                Connect("meta_hover_ended", this, nameof(_GodotSignalMetaHoverEnded));
            }
        ...
        public RichTextLabelAction RemoveOnMetaHoverEnded(Action<object> action) {
            ...
            if (_onMetaHoverEndedAction.Count == 0) {
                Disconnect("meta_hover_ended", this, nameof(_GodotSignalMetaHoverEnded));
            }
            return this;
        }
        ...
        public RichTextLabelAction OnMetaHoverStarted(Action<object> action) {
            if (_onMetaHoverStartedAction == null || _onMetaHoverStartedAction.Count == 0) {
                ...
                Connect("meta_hover_started", this, nameof(_GodotSignalMetaHoverStarted));
            }
        ...
        public RichTextLabelAction RemoveOnMetaHoverStarted(Action<object> action) {
            ...
            if (_onMetaHoverStartedAction.Count == 0) {
                Disconnect("meta_hover_started", this, nameof(_GodotSignalMetaHoverStarted));
            }
            return this;
        }
