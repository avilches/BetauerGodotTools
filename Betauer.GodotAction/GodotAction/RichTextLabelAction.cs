...
namespace Betauer.GodotAction {
    public class RichTextLabelAction : Node {
        public RichTextLabelAction() {
            SetProcess(false);
        ...
        public RichTextLabelAction OnProcess(Action<float> action) {
        ...
        public RichTextLabelAction RemoveOnProcess(Action<float> action) {
        ...
        public RichTextLabelAction OnMetaClicked(Action<object> action, bool oneShot = false, bool deferred = false) {
            if (_onMetaClickedAction == null || _onMetaClickedAction.Count == 0) {
                _onMetaClickedAction ??= new List<Action<object>>(); 
                GetParent().Connect("meta_clicked", this, nameof(_GodotSignalMetaClicked));
            }
            _onMetaClickedAction.Add(action);
            return this;
        }
        public RichTextLabelAction RemoveOnMetaClicked(Action<object> action) {
            if (_onMetaClickedAction == null || _onMetaClickedAction.Count == 0) return this;
            _onMetaClickedAction.Remove(action); 
            if (_onMetaClickedAction.Count == 0) {
                GetParent().Disconnect("meta_clicked", this, nameof(_GodotSignalMetaClicked));
            }
            return this;
        }
        private void _GodotSignalMetaClicked(object meta) {
            if (_onMetaClickedAction == null || _onMetaClickedAction.Count == 0) return;
            for (var i = 0; i < _onMetaClickedAction.Count; i++) _onMetaClickedAction[i].Invoke(meta);
        }
        ...
        public RichTextLabelAction OnMetaHoverEnded(Action<object> action, bool oneShot = false, bool deferred = false) {
            if (_onMetaHoverEndedAction == null || _onMetaHoverEndedAction.Count == 0) {
                _onMetaHoverEndedAction ??= new List<Action<object>>(); 
                GetParent().Connect("meta_hover_ended", this, nameof(_GodotSignalMetaHoverEnded));
            }
            _onMetaHoverEndedAction.Add(action);
            return this;
        }
        public RichTextLabelAction RemoveOnMetaHoverEnded(Action<object> action) {
            if (_onMetaHoverEndedAction == null || _onMetaHoverEndedAction.Count == 0) return this;
            _onMetaHoverEndedAction.Remove(action); 
            if (_onMetaHoverEndedAction.Count == 0) {
                GetParent().Disconnect("meta_hover_ended", this, nameof(_GodotSignalMetaHoverEnded));
            }
            return this;
        }
        private void _GodotSignalMetaHoverEnded(object meta) {
            if (_onMetaHoverEndedAction == null || _onMetaHoverEndedAction.Count == 0) return;
            for (var i = 0; i < _onMetaHoverEndedAction.Count; i++) _onMetaHoverEndedAction[i].Invoke(meta);
        }
        ...
        public RichTextLabelAction OnMetaHoverStarted(Action<object> action, bool oneShot = false, bool deferred = false) {
            if (_onMetaHoverStartedAction == null || _onMetaHoverStartedAction.Count == 0) {
                _onMetaHoverStartedAction ??= new List<Action<object>>(); 
                GetParent().Connect("meta_hover_started", this, nameof(_GodotSignalMetaHoverStarted));
            }
            _onMetaHoverStartedAction.Add(action);
            return this;
        }
        public RichTextLabelAction RemoveOnMetaHoverStarted(Action<object> action) {
            if (_onMetaHoverStartedAction == null || _onMetaHoverStartedAction.Count == 0) return this;
            _onMetaHoverStartedAction.Remove(action); 
            if (_onMetaHoverStartedAction.Count == 0) {
                GetParent().Disconnect("meta_hover_started", this, nameof(_GodotSignalMetaHoverStarted));
            }
            return this;
        }
        private void _GodotSignalMetaHoverStarted(object meta) {
            if (_onMetaHoverStartedAction == null || _onMetaHoverStartedAction.Count == 0) return;
            for (var i = 0; i < _onMetaHoverStartedAction.Count; i++) _onMetaHoverStartedAction[i].Invoke(meta);
        }
