...
namespace Betauer.GodotAction {
    public class RichTextLabelAction : ProxyNode {
        ...
        public void OnMetaClicked(Action<object> action, bool oneShot = false, bool deferred = false) =>
            AddSignal(ref _onMetaClickedAction, "meta_clicked", nameof(_GodotSignalMetaClicked), action, oneShot, deferred);

        public void RemoveOnMetaClicked(Action<object> action) =>
        ...
        public void OnMetaHoverEnded(Action<object> action, bool oneShot = false, bool deferred = false) =>
            AddSignal(ref _onMetaHoverEndedAction, "meta_hover_ended", nameof(_GodotSignalMetaHoverEnded), action, oneShot, deferred);

        public void RemoveOnMetaHoverEnded(Action<object> action) =>
        ...
        public void OnMetaHoverStarted(Action<object> action, bool oneShot = false, bool deferred = false) =>
            AddSignal(ref _onMetaHoverStartedAction, "meta_hover_started", nameof(_GodotSignalMetaHoverStarted), action, oneShot, deferred);

        public void RemoveOnMetaHoverStarted(Action<object> action) =>
