...
namespace Betauer.GodotAction {
    public class AudioEffectStereoEnhanceAction : AudioEffectStereoEnhance {


        private List<Action>? _onChangedAction; 
        public AudioEffectStereoEnhanceAction OnChanged(Action action) {
        ...
        public AudioEffectStereoEnhanceAction OnScriptChanged(Action action) {
