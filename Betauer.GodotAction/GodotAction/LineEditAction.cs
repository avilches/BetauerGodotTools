...
namespace Betauer.GodotAction {
    public class LineEditAction : ProxyNode {
        ...
        public void OnTextChanged(Action<string> action, bool oneShot = false, bool deferred = false) =>
            AddSignal(ref _onTextChangedAction, "text_changed", nameof(_GodotSignalTextChanged), action, oneShot, deferred);

        public void RemoveOnTextChanged(Action<string> action) =>
        ...
        public void OnTextChangeRejected(Action<string> action, bool oneShot = false, bool deferred = false) =>
        ...
        public void RemoveOnTextChangeRejected(Action<string> action) =>
        ...
        public void OnTextEntered(Action<string> action, bool oneShot = false, bool deferred = false) =>
            AddSignal(ref _onTextEnteredAction, "text_entered", nameof(_GodotSignalTextEntered), action, oneShot, deferred);

        public void RemoveOnTextEntered(Action<string> action) =>
