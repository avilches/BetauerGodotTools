...
namespace Betauer.GodotAction {
    public class LineEditAction : LineEdit {
        ...
        public LineEditAction OnProcessAction(Action<float> action) {
        ...
        public LineEditAction RemoveOnProcessAction(Action<float> action) {
        ...
        public LineEditAction OnGuiInput(Action<InputEvent> action) {
            if (_onGuiInputAction == null) 
                Connect("gui_input", this, nameof(ExecuteGuiInput));
            _onGuiInputAction = action;
            return this;
        }
        public LineEditAction RemoveOnGuiInput() {
        ...
        public LineEditAction OnItemRectChanged(Action action) {
        ...
        public LineEditAction RemoveOnItemRectChanged() {
        ...
        public LineEditAction OnMinimumSizeChanged(Action action) {
        ...
        public LineEditAction RemoveOnMinimumSizeChanged() {
        ...
        public LineEditAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public LineEditAction RemoveOnScriptChanged() {
        ...
        public LineEditAction OnSizeFlagsChanged(Action action) {
        ...
        public LineEditAction RemoveOnSizeFlagsChanged() {
        ...
        private Action<string>? _onTextChangedAction; 
        public LineEditAction OnTextChanged(Action<string> action) {
            if (_onTextChangedAction == null) 
                Connect("text_changed", this, nameof(ExecuteTextChanged));
            _onTextChangedAction = action;
            return this;
        }
        public LineEditAction RemoveOnTextChanged() {
            if (_onTextChangedAction == null) return this; 
            Disconnect("text_changed", this, nameof(ExecuteTextChanged));
            _onTextChangedAction = null;
            return this;
        }
        private void ExecuteTextChanged(string new_text) =>
            _onTextChangedAction?.Invoke(new_text);
        

        private Action<string>? _onTextChangeRejectedAction; 
        public LineEditAction OnTextChangeRejected(Action<string> action) {
            if (_onTextChangeRejectedAction == null) 
                Connect("text_change_rejected", this, nameof(ExecuteTextChangeRejected));
            _onTextChangeRejectedAction = action;
            return this;
        }
        public LineEditAction RemoveOnTextChangeRejected() {
            if (_onTextChangeRejectedAction == null) return this; 
            Disconnect("text_change_rejected", this, nameof(ExecuteTextChangeRejected));
            _onTextChangeRejectedAction = null;
            return this;
        }
        private void ExecuteTextChangeRejected(string rejected_substring) =>
            _onTextChangeRejectedAction?.Invoke(rejected_substring);
        

        private Action<string>? _onTextEnteredAction; 
        public LineEditAction OnTextEntered(Action<string> action) {
            if (_onTextEnteredAction == null) 
                Connect("text_entered", this, nameof(ExecuteTextEntered));
            _onTextEnteredAction = action;
            return this;
        }
        public LineEditAction RemoveOnTextEntered() {
            if (_onTextEnteredAction == null) return this; 
            Disconnect("text_entered", this, nameof(ExecuteTextEntered));
            _onTextEnteredAction = null;
            return this;
        }
        private void ExecuteTextEntered(string new_text) =>
            _onTextEnteredAction?.Invoke(new_text);
        

        private Action? _onTreeEnteredAction; 
        public LineEditAction OnTreeEntered(Action action) {
            if (_onTreeEnteredAction == null) 
                Connect("tree_entered", this, nameof(ExecuteTreeEntered));
            _onTreeEnteredAction = action;
            return this;
        }
        public LineEditAction RemoveOnTreeEntered() {
        ...
        public LineEditAction OnVisibilityChanged(Action action) {
        ...
        public LineEditAction RemoveOnVisibilityChanged() {
