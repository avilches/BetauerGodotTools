...
namespace Betauer.GodotAction {
    public class VisualShaderNodeCubeMapAction : VisualShaderNodeCubeMap {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeCubeMapAction OnChanged(Action action) {
        ...
        public VisualShaderNodeCubeMapAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeCubeMapAction OnScriptChanged(Action action) {
