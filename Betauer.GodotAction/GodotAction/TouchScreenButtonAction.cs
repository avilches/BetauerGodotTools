...
namespace Betauer.GodotAction {
    public class TouchScreenButtonAction : Node {
        public TouchScreenButtonAction() {
            SetProcess(false);
        ...
        public TouchScreenButtonAction OnReleased(Action action, bool oneShot = false, bool deferred = false) {
            if (_onReleasedAction == null || _onReleasedAction.Count == 0) {
                ...
                GetParent().Connect("released", this, nameof(_GodotSignalReleased));
            }
        ...
        public TouchScreenButtonAction RemoveOnReleased(Action action) {
            ...
            if (_onReleasedAction.Count == 0) {
                GetParent().Disconnect("released", this, nameof(_GodotSignalReleased));
            }
            return this;
        }
        private void _GodotSignalReleased() {
