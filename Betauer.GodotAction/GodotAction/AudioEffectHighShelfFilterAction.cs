...
namespace Betauer.GodotAction {
    public class AudioEffectHighShelfFilterAction : AudioEffectHighShelfFilter {


        private List<Action>? _onChangedAction; 
        public AudioEffectHighShelfFilterAction OnChanged(Action action) {
        ...
        public AudioEffectHighShelfFilterAction OnScriptChanged(Action action) {
