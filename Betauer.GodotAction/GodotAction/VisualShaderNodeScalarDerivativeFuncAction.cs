...
namespace Betauer.GodotAction {
    public class VisualShaderNodeScalarDerivativeFuncAction : VisualShaderNodeScalarDerivativeFunc {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeScalarDerivativeFuncAction OnChanged(Action action) {
        ...
        public VisualShaderNodeScalarDerivativeFuncAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeScalarDerivativeFuncAction OnScriptChanged(Action action) {
