...
namespace Betauer.GodotAction {
    public class RichTextEffectAction : RichTextEffect {


        private Action? _onChangedAction; 
        public RichTextEffectAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public RichTextEffectAction RemoveOnChanged() {
        ...
        public RichTextEffectAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public RichTextEffectAction RemoveOnScriptChanged() {
