...
namespace Betauer.GodotAction {
    public class AudioEffectPhaserAction : AudioEffectPhaser {


        private Action? _onChangedAction; 
        public AudioEffectPhaserAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public AudioEffectPhaserAction RemoveOnChanged() {
        ...
        public AudioEffectPhaserAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public AudioEffectPhaserAction RemoveOnScriptChanged() {
