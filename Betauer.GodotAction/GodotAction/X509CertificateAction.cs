...
namespace Betauer.GodotAction {
    public class X509CertificateAction : X509Certificate {


        private List<Action>? _onChangedAction; 
        public X509CertificateAction OnChanged(Action action) {
        ...
        public X509CertificateAction OnScriptChanged(Action action) {
