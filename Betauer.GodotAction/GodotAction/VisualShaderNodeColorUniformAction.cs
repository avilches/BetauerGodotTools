...
namespace Betauer.GodotAction {
    public class VisualShaderNodeColorUniformAction : VisualShaderNodeColorUniform {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeColorUniformAction OnChanged(Action action) {
        ...
        public VisualShaderNodeColorUniformAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeColorUniformAction OnScriptChanged(Action action) {
