...
namespace Betauer.GodotAction {
    public class PackedDataContainerAction : PackedDataContainer {


        private List<Action>? _onChangedAction; 
        public PackedDataContainerAction OnChanged(Action action) {
        ...
        public PackedDataContainerAction OnScriptChanged(Action action) {
