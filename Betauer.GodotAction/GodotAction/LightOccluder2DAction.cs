...
namespace Betauer.GodotAction {
    public class LightOccluder2DAction : LightOccluder2D {
        ...
        public LightOccluder2DAction OnDraw(Action action) {
        ...
        public LightOccluder2DAction OnHide(Action action) {
        ...
        public LightOccluder2DAction OnItemRectChanged(Action action) {
        ...
        public LightOccluder2DAction OnReady(Action action) {
        ...
        public LightOccluder2DAction OnRenamed(Action action) {
        ...
        public LightOccluder2DAction OnScriptChanged(Action action) {
        ...
        public LightOccluder2DAction OnTreeEntered(Action action) {
        ...
        public LightOccluder2DAction OnTreeExited(Action action) {
        ...
        public LightOccluder2DAction OnTreeExiting(Action action) {
        ...
        public LightOccluder2DAction OnVisibilityChanged(Action action) {
