...
namespace Betauer.GodotAction {
    public class LightOccluder2DAction : Node {
        public LightOccluder2DAction() {
            SetProcess(false);
        ...
        public LightOccluder2DAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public LightOccluder2DAction OnPhysicsProcess(Action<float> action) {
        ...
        public LightOccluder2DAction OnInput(Action<InputEvent> action) {
        ...
        public LightOccluder2DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public LightOccluder2DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public LightOccluder2DAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public LightOccluder2DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public LightOccluder2DAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public LightOccluder2DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public LightOccluder2DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public LightOccluder2DAction OnDraw(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public LightOccluder2DAction RemoveOnDraw(Action action) {
        ...
        public LightOccluder2DAction OnHide(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public LightOccluder2DAction RemoveOnHide(Action action) {
        ...
        public LightOccluder2DAction OnItemRectChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public LightOccluder2DAction RemoveOnItemRectChanged(Action action) {
        ...
        public LightOccluder2DAction OnReady(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public LightOccluder2DAction RemoveOnReady(Action action) {
        ...
        public LightOccluder2DAction OnRenamed(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public LightOccluder2DAction RemoveOnRenamed(Action action) {
        ...
        public LightOccluder2DAction OnScriptChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public LightOccluder2DAction RemoveOnScriptChanged(Action action) {
        ...
        public LightOccluder2DAction OnTreeEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public LightOccluder2DAction RemoveOnTreeEntered(Action action) {
        ...
        public LightOccluder2DAction OnTreeExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public LightOccluder2DAction RemoveOnTreeExited(Action action) {
        ...
        public LightOccluder2DAction OnTreeExiting(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public LightOccluder2DAction RemoveOnTreeExiting(Action action) {
        ...
        public LightOccluder2DAction OnVisibilityChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public LightOccluder2DAction RemoveOnVisibilityChanged(Action action) {
