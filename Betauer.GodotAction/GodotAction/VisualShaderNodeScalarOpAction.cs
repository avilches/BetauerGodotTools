...
namespace Betauer.GodotAction {
    public class VisualShaderNodeScalarOpAction : VisualShaderNodeScalarOp {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeScalarOpAction OnChanged(Action action) {
        ...
        public VisualShaderNodeScalarOpAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeScalarOpAction OnScriptChanged(Action action) {
