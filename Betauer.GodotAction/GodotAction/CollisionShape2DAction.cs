...
namespace Betauer.GodotAction {
    public class CollisionShape2DAction : Node {
        public CollisionShape2DAction() {
            SetProcess(false);
        ...
        public CollisionShape2DAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public CollisionShape2DAction OnPhysicsProcess(Action<float> action) {
        ...
        public CollisionShape2DAction OnInput(Action<InputEvent> action) {
        ...
        public CollisionShape2DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public CollisionShape2DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public CollisionShape2DAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public CollisionShape2DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public CollisionShape2DAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public CollisionShape2DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public CollisionShape2DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
