...
namespace Betauer.GodotAction {
    public class StaticBodyAction : StaticBody {
        ...
        public StaticBodyAction OnProcessAction(Action<float> action) {
            _onProcessAction ??= new List<Action<float>>(1);
            _onProcessAction.Add(action);
            SetProcess(true);
            return this;
        }
        public StaticBodyAction OnPhysicsProcess(Action<float> action) {
        ...
        public StaticBodyAction OnInput(Action<InputEvent> action) {
        ...
        public StaticBodyAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public StaticBodyAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public StaticBodyAction RemoveOnProcessAction(Action<float> action) {
            _onProcessAction?.Remove(action);
            return this;
        }

        public StaticBodyAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcess?.Remove(action);
            return this;
        }

        public StaticBodyAction RemoveOnInput(Action<InputEvent> action) {
            _onInput?.Remove(action);
            return this;
        }

        public StaticBodyAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInput?.Remove(action);
            return this;
        }

        public StaticBodyAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public StaticBodyAction OnGameplayEntered(Action action) {
        ...
        public StaticBodyAction RemoveOnGameplayEntered() {
        ...
        public StaticBodyAction OnInputEvent(Action<InputEvent, Node, Vector3, Vector3, int> action) {
            if (_onInputEventAction == null) 
                Connect("input_event", this, nameof(ExecuteInputEvent));
            _onInputEventAction = action;
            return this;
        }
        public StaticBodyAction RemoveOnInputEvent() {
        ...
        public StaticBodyAction OnReady(Action action) {
            if (_onReadyAction == null) 
                Connect("ready", this, nameof(ExecuteReady));
            _onReadyAction = action;
            return this;
        }
        public StaticBodyAction RemoveOnReady() {
        ...
        public StaticBodyAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public StaticBodyAction RemoveOnScriptChanged() {
        ...
        public StaticBodyAction OnVisibilityChanged(Action action) {
        ...
        public StaticBodyAction RemoveOnVisibilityChanged() {
