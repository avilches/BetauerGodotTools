...
namespace Betauer.GodotAction {
    public class TileMapAction : TileMap {
        ...
        public TileMapAction OnProcessAction(Action<float> action) {
            _onProcessAction ??= new List<Action<float>>(1);
            _onProcessAction.Add(action);
            SetProcess(true);
            return this;
        }
        public TileMapAction OnPhysicsProcess(Action<float> action) {
        ...
        public TileMapAction OnInput(Action<InputEvent> action) {
        ...
        public TileMapAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public TileMapAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public TileMapAction RemoveOnProcessAction(Action<float> action) {
            _onProcessAction?.Remove(action);
            return this;
        }

        public TileMapAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcess?.Remove(action);
            return this;
        }

        public TileMapAction RemoveOnInput(Action<InputEvent> action) {
            _onInput?.Remove(action);
            return this;
        }

        public TileMapAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInput?.Remove(action);
            return this;
        }

        public TileMapAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public TileMapAction OnItemRectChanged(Action action) {
        ...
        public TileMapAction RemoveOnItemRectChanged() {
        ...
        public TileMapAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public TileMapAction RemoveOnScriptChanged() {
        ...
        private Action? _onSettingsChangedAction; 
        public TileMapAction OnSettingsChanged(Action action) {
            if (_onSettingsChangedAction == null) 
                Connect("settings_changed", this, nameof(ExecuteSettingsChanged));
            _onSettingsChangedAction = action;
            return this;
        }
        public TileMapAction RemoveOnSettingsChanged() {
            if (_onSettingsChangedAction == null) return this; 
            Disconnect("settings_changed", this, nameof(ExecuteSettingsChanged));
            _onSettingsChangedAction = null;
            return this;
        }
        private void ExecuteSettingsChanged() =>
            _onSettingsChangedAction?.Invoke();
        

        private Action? _onTreeEnteredAction; 
        public TileMapAction OnTreeEntered(Action action) {
            if (_onTreeEnteredAction == null) 
                Connect("tree_entered", this, nameof(ExecuteTreeEntered));
            _onTreeEnteredAction = action;
            return this;
        }
        public TileMapAction RemoveOnTreeEntered() {
        ...
        public TileMapAction OnVisibilityChanged(Action action) {
        ...
        public TileMapAction RemoveOnVisibilityChanged() {
