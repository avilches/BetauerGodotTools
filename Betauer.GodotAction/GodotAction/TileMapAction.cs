...
namespace Betauer.GodotAction {
    public class TileMapAction : Node {
        ...
        public TileMapAction OnSettingsChanged(Action action, bool oneShot = false, bool deferred = false) {
            if (_onSettingsChangedAction == null || _onSettingsChangedAction.Count == 0) {
                ...
                GetParent().Connect("settings_changed", this, nameof(_GodotSignalSettingsChanged));
            }
        ...
        public TileMapAction RemoveOnSettingsChanged(Action action) {
            ...
            if (_onSettingsChangedAction.Count == 0) {
                GetParent().Disconnect("settings_changed", this, nameof(_GodotSignalSettingsChanged));
            }
            return this;
        }
