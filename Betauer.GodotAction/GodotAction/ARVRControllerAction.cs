...
namespace Betauer.GodotAction {
    public class ARVRControllerAction : ARVRController {
        ...
        public ARVRControllerAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public ARVRControllerAction OnPhysicsProcess(Action<float> action) {
        ...
        public ARVRControllerAction OnInput(Action<InputEvent> action) {
        ...
        public ARVRControllerAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public ARVRControllerAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public ARVRControllerAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public ARVRControllerAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public ARVRControllerAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public ARVRControllerAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public ARVRControllerAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        private Action<int>? _onButtonPressedAction; 
        public ARVRControllerAction OnButtonPressed(Action<int> action) {
            if (_onButtonPressedAction == null) 
                Connect("button_pressed", this, nameof(ExecuteButtonPressed));
            _onButtonPressedAction = action;
            return this;
        }
        public ARVRControllerAction RemoveOnButtonPressed() {
        ...
        private void ExecuteButtonPressed(int button) =>
            _onButtonPressedAction?.Invoke(button);
        

        private Action<int>? _onButtonReleaseAction; 
        public ARVRControllerAction OnButtonRelease(Action<int> action) {
            if (_onButtonReleaseAction == null) 
                Connect("button_release", this, nameof(ExecuteButtonRelease));
            _onButtonReleaseAction = action;
            return this;
        }
        public ARVRControllerAction RemoveOnButtonRelease() {
            if (_onButtonReleaseAction == null) return this; 
            Disconnect("button_release", this, nameof(ExecuteButtonRelease));
            _onButtonReleaseAction = null;
            return this;
        }
        private void ExecuteButtonRelease(int button) =>
            _onButtonReleaseAction?.Invoke(button);
        

        private Action? _onGameplayEnteredAction; 
        public ARVRControllerAction OnGameplayEntered(Action action) {
        ...
        public ARVRControllerAction RemoveOnGameplayEntered() {
        ...
        private Action<Mesh>? _onMeshUpdatedAction; 
        public ARVRControllerAction OnMeshUpdated(Action<Mesh> action) {
            if (_onMeshUpdatedAction == null) 
                Connect("mesh_updated", this, nameof(ExecuteMeshUpdated));
            _onMeshUpdatedAction = action;
            return this;
        }
        public ARVRControllerAction RemoveOnMeshUpdated() {
            if (_onMeshUpdatedAction == null) return this; 
            Disconnect("mesh_updated", this, nameof(ExecuteMeshUpdated));
            _onMeshUpdatedAction = null;
            return this;
        }
        private void ExecuteMeshUpdated(Mesh mesh) =>
            _onMeshUpdatedAction?.Invoke(mesh);
        

        private Action? _onReadyAction; 
        public ARVRControllerAction OnReady(Action action) {
            if (_onReadyAction == null) 
                Connect("ready", this, nameof(ExecuteReady));
            _onReadyAction = action;
            return this;
        }
        public ARVRControllerAction RemoveOnReady() {
        ...
        public ARVRControllerAction OnRenamed(Action action) {
            if (_onRenamedAction == null) 
                Connect("renamed", this, nameof(ExecuteRenamed));
            _onRenamedAction = action;
            return this;
        }
        public ARVRControllerAction RemoveOnRenamed() {
        ...
        public ARVRControllerAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public ARVRControllerAction RemoveOnScriptChanged() {
        ...
        public ARVRControllerAction OnVisibilityChanged(Action action) {
        ...
        public ARVRControllerAction RemoveOnVisibilityChanged() {
