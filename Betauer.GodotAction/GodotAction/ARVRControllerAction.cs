...
namespace Betauer.GodotAction {
    public class ARVRControllerAction : Node {
        public ARVRControllerAction() {
            SetProcess(false);
        ...
        public ARVRControllerAction OnButtonRelease(Action<int> action, bool oneShot = false, bool deferred = false) {
            if (_onButtonReleaseAction == null || _onButtonReleaseAction.Count == 0) {
                ...
                GetParent().Connect("button_release", this, nameof(_GodotSignalButtonRelease));
            }
        ...
        public ARVRControllerAction RemoveOnButtonRelease(Action<int> action) {
            ...
            if (_onButtonReleaseAction.Count == 0) {
                GetParent().Disconnect("button_release", this, nameof(_GodotSignalButtonRelease));
            }
            return this;
        }
