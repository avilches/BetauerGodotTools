...
namespace Betauer.GodotAction {
    public class NavigationAction : Node {
        ...
        public NavigationAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public NavigationAction OnPhysicsProcess(Action<float> action) {
        ...
        public NavigationAction OnInput(Action<InputEvent> action) {
        ...
        public NavigationAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public NavigationAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public NavigationAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public NavigationAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public NavigationAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public NavigationAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public NavigationAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public NavigationAction RemoveOnGameplayEntered(Action action) {
        ...
        public NavigationAction OnGameplayExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public NavigationAction RemoveOnGameplayExited(Action action) {
        ...
        public NavigationAction OnReady(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public NavigationAction RemoveOnReady(Action action) {
        ...
        public NavigationAction OnRenamed(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public NavigationAction RemoveOnRenamed(Action action) {
        ...
        public NavigationAction OnScriptChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public NavigationAction RemoveOnScriptChanged(Action action) {
        ...
        public NavigationAction OnTreeEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public NavigationAction RemoveOnTreeEntered(Action action) {
        ...
        public NavigationAction OnTreeExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public NavigationAction RemoveOnTreeExited(Action action) {
        ...
        public NavigationAction OnTreeExiting(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public NavigationAction RemoveOnTreeExiting(Action action) {
        ...
        public NavigationAction OnVisibilityChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public NavigationAction RemoveOnVisibilityChanged(Action action) {
