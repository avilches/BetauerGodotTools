...
namespace Betauer.GodotAction {
    public class VisualScriptClassConstantAction : VisualScriptClassConstant {


        private List<Action>? _onChangedAction; 
        public VisualScriptClassConstantAction OnChanged(Action action) {
        ...
        public VisualScriptClassConstantAction OnPortsChanged(Action action) {
        ...
        public VisualScriptClassConstantAction OnScriptChanged(Action action) {
