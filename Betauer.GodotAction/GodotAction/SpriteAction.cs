...
namespace Betauer.GodotAction {
    public class SpriteAction : Node {
        public SpriteAction() {
            SetProcess(false);
        ...
        public SpriteAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public SpriteAction OnPhysicsProcess(Action<float> action) {
        ...
        public SpriteAction OnInput(Action<InputEvent> action) {
        ...
        public SpriteAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public SpriteAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public SpriteAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public SpriteAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public SpriteAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public SpriteAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public SpriteAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
