...
namespace Betauer.GodotAction {
    public class ParallaxLayerAction : Node {
        public ParallaxLayerAction() {
            SetProcess(false);
        ...
        public ParallaxLayerAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public ParallaxLayerAction OnPhysicsProcess(Action<float> action) {
        ...
        public ParallaxLayerAction OnInput(Action<InputEvent> action) {
        ...
        public ParallaxLayerAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public ParallaxLayerAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public ParallaxLayerAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public ParallaxLayerAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public ParallaxLayerAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public ParallaxLayerAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public ParallaxLayerAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
