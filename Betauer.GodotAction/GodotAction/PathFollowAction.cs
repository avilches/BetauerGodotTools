...
namespace Betauer.GodotAction {
    public class PathFollowAction : Node {
        ...
        public PathFollowAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public PathFollowAction OnPhysicsProcess(Action<float> action) {
        ...
        public PathFollowAction OnInput(Action<InputEvent> action) {
        ...
        public PathFollowAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public PathFollowAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public PathFollowAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public PathFollowAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public PathFollowAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public PathFollowAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public PathFollowAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
