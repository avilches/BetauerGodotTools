...
namespace Betauer.GodotAction {
    public class RectangleShape2DAction : RectangleShape2D {


        private List<Action>? _onChangedAction; 
        public RectangleShape2DAction OnChanged(Action action) {
        ...
        public RectangleShape2DAction OnScriptChanged(Action action) {
