...
namespace Betauer.GodotAction {
    public class PolygonPathFinderAction : PolygonPathFinder {


        private Action? _onChangedAction; 
        public PolygonPathFinderAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public PolygonPathFinderAction RemoveOnChanged() {
        ...
        public PolygonPathFinderAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public PolygonPathFinderAction RemoveOnScriptChanged() {
