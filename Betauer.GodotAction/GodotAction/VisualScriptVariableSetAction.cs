...
namespace Betauer.GodotAction {
    public class VisualScriptVariableSetAction : VisualScriptVariableSet {


        private List<Action>? _onChangedAction; 
        public VisualScriptVariableSetAction OnChanged(Action action) {
        ...
        public VisualScriptVariableSetAction OnPortsChanged(Action action) {
        ...
        public VisualScriptVariableSetAction OnScriptChanged(Action action) {
