...
namespace Betauer.GodotAction {
    public class VisualShaderNodeVectorRefractAction : VisualShaderNodeVectorRefract {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeVectorRefractAction OnChanged(Action action) {
        ...
        public VisualShaderNodeVectorRefractAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeVectorRefractAction OnScriptChanged(Action action) {
