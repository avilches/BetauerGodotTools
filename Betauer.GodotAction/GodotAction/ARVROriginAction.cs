...
namespace Betauer.GodotAction {
    public class ARVROriginAction : ARVROrigin {
        ...
        public ARVROriginAction OnGameplayEntered(Action action) {
        ...
        public ARVROriginAction OnGameplayExited(Action action) {
        ...
        public ARVROriginAction OnReady(Action action) {
        ...
        public ARVROriginAction OnRenamed(Action action) {
        ...
        public ARVROriginAction OnScriptChanged(Action action) {
        ...
        public ARVROriginAction OnTreeEntered(Action action) {
        ...
        public ARVROriginAction OnTreeExited(Action action) {
        ...
        public ARVROriginAction OnTreeExiting(Action action) {
        ...
        public ARVROriginAction OnVisibilityChanged(Action action) {
