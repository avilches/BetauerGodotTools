...
namespace Betauer.GodotAction {
    public class ARVROriginAction : Node {
        public ARVROriginAction() {
            SetProcess(false);
        ...
        public ARVROriginAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public ARVROriginAction OnPhysicsProcess(Action<float> action) {
        ...
        public ARVROriginAction OnInput(Action<InputEvent> action) {
        ...
        public ARVROriginAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public ARVROriginAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public ARVROriginAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public ARVROriginAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public ARVROriginAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public ARVROriginAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public ARVROriginAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
