...
namespace Betauer.GodotAction {
    public class OpenSimplexNoiseAction : OpenSimplexNoise {


        private Action? _onChangedAction; 
        public OpenSimplexNoiseAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public OpenSimplexNoiseAction RemoveOnChanged() {
        ...
        public OpenSimplexNoiseAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public OpenSimplexNoiseAction RemoveOnScriptChanged() {
