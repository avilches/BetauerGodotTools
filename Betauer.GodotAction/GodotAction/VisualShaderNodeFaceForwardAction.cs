...
namespace Betauer.GodotAction {
    public class VisualShaderNodeFaceForwardAction : VisualShaderNodeFaceForward {


        private Action? _onChangedAction; 
        public VisualShaderNodeFaceForwardAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public VisualShaderNodeFaceForwardAction RemoveOnChanged() {
        ...
        public VisualShaderNodeFaceForwardAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeFaceForwardAction RemoveOnEditorRefreshRequest() {
        ...
        public VisualShaderNodeFaceForwardAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public VisualShaderNodeFaceForwardAction RemoveOnScriptChanged() {
