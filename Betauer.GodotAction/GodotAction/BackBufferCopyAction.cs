...
namespace Betauer.GodotAction {
    public class BackBufferCopyAction : Node {
        public BackBufferCopyAction() {
            SetProcess(false);
        ...
        public BackBufferCopyAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public BackBufferCopyAction OnPhysicsProcess(Action<float> action) {
        ...
        public BackBufferCopyAction OnInput(Action<InputEvent> action) {
        ...
        public BackBufferCopyAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public BackBufferCopyAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public BackBufferCopyAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public BackBufferCopyAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public BackBufferCopyAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public BackBufferCopyAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public BackBufferCopyAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
