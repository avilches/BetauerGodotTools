...
namespace Betauer.GodotAction {
    public class CanvasModulateAction : Node {
        public CanvasModulateAction() {
            SetProcess(false);
        ...
        public CanvasModulateAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public CanvasModulateAction OnPhysicsProcess(Action<float> action) {
        ...
        public CanvasModulateAction OnInput(Action<InputEvent> action) {
        ...
        public CanvasModulateAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public CanvasModulateAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public CanvasModulateAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public CanvasModulateAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public CanvasModulateAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public CanvasModulateAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public CanvasModulateAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
