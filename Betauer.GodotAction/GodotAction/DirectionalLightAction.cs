...
namespace Betauer.GodotAction {
    public class DirectionalLightAction : Node {
        public DirectionalLightAction() {
            SetProcess(false);
        ...
        public DirectionalLightAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public DirectionalLightAction OnPhysicsProcess(Action<float> action) {
        ...
        public DirectionalLightAction OnInput(Action<InputEvent> action) {
        ...
        public DirectionalLightAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public DirectionalLightAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public DirectionalLightAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public DirectionalLightAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public DirectionalLightAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public DirectionalLightAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public DirectionalLightAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
