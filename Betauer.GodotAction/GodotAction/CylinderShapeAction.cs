...
namespace Betauer.GodotAction {
    public class CylinderShapeAction : CylinderShape {


        private List<Action>? _onChangedAction; 
        public CylinderShapeAction OnChanged(Action action) {
        ...
        public CylinderShapeAction OnScriptChanged(Action action) {
