...
namespace Betauer.GodotAction {
    public class AudioEffectEQ21Action : AudioEffectEQ21 {


        private List<Action>? _onChangedAction; 
        public AudioEffectEQ21Action OnChanged(Action action) {
        ...
        public AudioEffectEQ21Action OnScriptChanged(Action action) {
