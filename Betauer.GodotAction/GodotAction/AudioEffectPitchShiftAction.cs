...
namespace Betauer.GodotAction {
    public class AudioEffectPitchShiftAction : AudioEffectPitchShift {


        private List<Action>? _onChangedAction; 
        public AudioEffectPitchShiftAction OnChanged(Action action) {
        ...
        public AudioEffectPitchShiftAction OnScriptChanged(Action action) {
