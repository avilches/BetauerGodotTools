...
namespace Betauer.GodotAction {
    public class VisualScriptBasicTypeConstantAction : VisualScriptBasicTypeConstant {


        private List<Action>? _onChangedAction; 
        public VisualScriptBasicTypeConstantAction OnChanged(Action action) {
        ...
        public VisualScriptBasicTypeConstantAction OnPortsChanged(Action action) {
        ...
        public VisualScriptBasicTypeConstantAction OnScriptChanged(Action action) {
