...
namespace Betauer.GodotAction {
    public class Polygon2DAction : Node {
        public Polygon2DAction() {
            SetProcess(false);
        ...
        public Polygon2DAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public Polygon2DAction OnPhysicsProcess(Action<float> action) {
        ...
        public Polygon2DAction OnInput(Action<InputEvent> action) {
        ...
        public Polygon2DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public Polygon2DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public Polygon2DAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public Polygon2DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public Polygon2DAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public Polygon2DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public Polygon2DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
