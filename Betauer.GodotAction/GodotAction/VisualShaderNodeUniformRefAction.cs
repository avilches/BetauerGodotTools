...
namespace Betauer.GodotAction {
    public class VisualShaderNodeUniformRefAction : VisualShaderNodeUniformRef {


        private Action? _onChangedAction; 
        public VisualShaderNodeUniformRefAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public VisualShaderNodeUniformRefAction RemoveOnChanged() {
        ...
        public VisualShaderNodeUniformRefAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeUniformRefAction RemoveOnEditorRefreshRequest() {
        ...
        public VisualShaderNodeUniformRefAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public VisualShaderNodeUniformRefAction RemoveOnScriptChanged() {
