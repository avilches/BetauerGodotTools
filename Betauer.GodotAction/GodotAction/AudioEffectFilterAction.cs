...
namespace Betauer.GodotAction {
    public class AudioEffectFilterAction : AudioEffectFilter {


        private List<Action>? _onChangedAction; 
        public AudioEffectFilterAction OnChanged(Action action) {
        ...
        public AudioEffectFilterAction OnScriptChanged(Action action) {
