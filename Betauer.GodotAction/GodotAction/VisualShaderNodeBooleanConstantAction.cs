...
namespace Betauer.GodotAction {
    public class VisualShaderNodeBooleanConstantAction : VisualShaderNodeBooleanConstant {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeBooleanConstantAction OnChanged(Action action) {
        ...
        public VisualShaderNodeBooleanConstantAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeBooleanConstantAction OnScriptChanged(Action action) {
