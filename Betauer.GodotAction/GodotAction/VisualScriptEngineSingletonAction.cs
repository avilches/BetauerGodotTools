...
namespace Betauer.GodotAction {
    public class VisualScriptEngineSingletonAction : VisualScriptEngineSingleton {


        private List<Action>? _onChangedAction; 
        public VisualScriptEngineSingletonAction OnChanged(Action action) {
        ...
        public VisualScriptEngineSingletonAction OnPortsChanged(Action action) {
        ...
        public VisualScriptEngineSingletonAction OnScriptChanged(Action action) {
