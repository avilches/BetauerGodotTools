...
namespace Betauer.GodotAction {
    public class VisualShaderNodeSwitchAction : VisualShaderNodeSwitch {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeSwitchAction OnChanged(Action action) {
        ...
        public VisualShaderNodeSwitchAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeSwitchAction OnScriptChanged(Action action) {
