...
namespace Betauer.GodotAction {
    public class AudioEffectDelayAction : AudioEffectDelay {


        private Action? _onChangedAction; 
        public AudioEffectDelayAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public AudioEffectDelayAction RemoveOnChanged() {
        ...
        public AudioEffectDelayAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public AudioEffectDelayAction RemoveOnScriptChanged() {
