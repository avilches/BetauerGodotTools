...
namespace Betauer.GodotAction {
    public class SpotLightAction : Node {
        public SpotLightAction() {
            SetProcess(false);
        ...
        public SpotLightAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public SpotLightAction OnPhysicsProcess(Action<float> action) {
        ...
        public SpotLightAction OnInput(Action<InputEvent> action) {
        ...
        public SpotLightAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public SpotLightAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public SpotLightAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public SpotLightAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public SpotLightAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public SpotLightAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public SpotLightAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
