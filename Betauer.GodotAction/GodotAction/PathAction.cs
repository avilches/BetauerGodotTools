...
namespace Betauer.GodotAction {
    public class PathAction : Node {
        ...
        public PathAction OnProcess(Action<float> action) {
        ...
        public PathAction RemoveOnProcess(Action<float> action) {
        ...
        private List<Action>? _onCurveChangedAction; 
        public PathAction OnCurveChanged(Action action, bool oneShot = false, bool deferred = false) {
            if (_onCurveChangedAction == null || _onCurveChangedAction.Count == 0) {
                _onCurveChangedAction ??= new List<Action>(); 
                GetParent().Connect("curve_changed", this, nameof(_GodotSignalCurveChanged));
            }
            _onCurveChangedAction.Add(action);
            return this;
        }
        public PathAction RemoveOnCurveChanged(Action action) {
            if (_onCurveChangedAction == null || _onCurveChangedAction.Count == 0) return this;
            _onCurveChangedAction.Remove(action); 
            if (_onCurveChangedAction.Count == 0) {
                GetParent().Disconnect("curve_changed", this, nameof(_GodotSignalCurveChanged));
            }
            return this;
        }
        private void _GodotSignalCurveChanged() {
            if (_onCurveChangedAction == null || _onCurveChangedAction.Count == 0) return;
            for (var i = 0; i < _onCurveChangedAction.Count; i++) _onCurveChangedAction[i].Invoke();
        }
        

        private List<Action>? _onGameplayEnteredAction; 
        public PathAction OnGameplayEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public PathAction RemoveOnGameplayEntered(Action action) {
        ...
        public PathAction OnGameplayExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public PathAction RemoveOnGameplayExited(Action action) {
        ...
        public PathAction OnReady(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public PathAction RemoveOnReady(Action action) {
        ...
        public PathAction OnRenamed(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public PathAction RemoveOnRenamed(Action action) {
        ...
        public PathAction OnScriptChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public PathAction RemoveOnScriptChanged(Action action) {
        ...
        public PathAction OnTreeEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public PathAction RemoveOnTreeEntered(Action action) {
        ...
        public PathAction OnTreeExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public PathAction RemoveOnTreeExited(Action action) {
        ...
        public PathAction OnTreeExiting(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public PathAction RemoveOnTreeExiting(Action action) {
        ...
        public PathAction OnVisibilityChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public PathAction RemoveOnVisibilityChanged(Action action) {
