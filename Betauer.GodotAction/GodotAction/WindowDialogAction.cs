...
namespace Betauer.GodotAction {
    public class WindowDialogAction : Node {
        public WindowDialogAction() {
            SetProcess(false);
        ...
        public WindowDialogAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public WindowDialogAction OnPhysicsProcess(Action<float> action) {
        ...
        public WindowDialogAction OnInput(Action<InputEvent> action) {
        ...
        public WindowDialogAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public WindowDialogAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public WindowDialogAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public WindowDialogAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public WindowDialogAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public WindowDialogAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public WindowDialogAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
