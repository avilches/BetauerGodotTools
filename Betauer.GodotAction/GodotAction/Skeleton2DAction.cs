...
namespace Betauer.GodotAction {
    public class Skeleton2DAction : Skeleton2D {
        ...
        public Skeleton2DAction OnProcessAction(Action<float> action) {
            _onProcessAction ??= new List<Action<float>>(1);
            _onProcessAction.Add(action);
            SetProcess(true);
            return this;
        }
        public Skeleton2DAction OnPhysicsProcess(Action<float> action) {
        ...
        public Skeleton2DAction OnInput(Action<InputEvent> action) {
        ...
        public Skeleton2DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public Skeleton2DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public Skeleton2DAction RemoveOnProcessAction(Action<float> action) {
            _onProcessAction?.Remove(action);
            return this;
        }

        public Skeleton2DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcess?.Remove(action);
            return this;
        }

        public Skeleton2DAction RemoveOnInput(Action<InputEvent> action) {
            _onInput?.Remove(action);
            return this;
        }

        public Skeleton2DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInput?.Remove(action);
            return this;
        }

        public Skeleton2DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        private Action? _onBoneSetupChangedAction; 
        public Skeleton2DAction OnBoneSetupChanged(Action action) {
            if (_onBoneSetupChangedAction == null) 
                Connect("bone_setup_changed", this, nameof(ExecuteBoneSetupChanged));
            _onBoneSetupChangedAction = action;
            return this;
        }
        public Skeleton2DAction RemoveOnBoneSetupChanged() {
            if (_onBoneSetupChangedAction == null) return this; 
            Disconnect("bone_setup_changed", this, nameof(ExecuteBoneSetupChanged));
            _onBoneSetupChangedAction = null;
            return this;
        }
        private void ExecuteBoneSetupChanged() =>
            _onBoneSetupChangedAction?.Invoke();
        

        private Action? _onDrawAction; 
        public Skeleton2DAction OnDraw(Action action) {
            if (_onDrawAction == null) 
                Connect("draw", this, nameof(ExecuteDraw));
            _onDrawAction = action;
            return this;
        }
        public Skeleton2DAction RemoveOnDraw() {
        ...
        public Skeleton2DAction OnHide(Action action) {
            if (_onHideAction == null) 
                Connect("hide", this, nameof(ExecuteHide));
            _onHideAction = action;
            return this;
        }
        public Skeleton2DAction RemoveOnHide() {
        ...
        public Skeleton2DAction OnItemRectChanged(Action action) {
        ...
        public Skeleton2DAction RemoveOnItemRectChanged() {
        ...
        public Skeleton2DAction OnReady(Action action) {
            if (_onReadyAction == null) 
                Connect("ready", this, nameof(ExecuteReady));
            _onReadyAction = action;
            return this;
        }
        public Skeleton2DAction RemoveOnReady() {
        ...
        public Skeleton2DAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public Skeleton2DAction RemoveOnScriptChanged() {
        ...
        public Skeleton2DAction OnVisibilityChanged(Action action) {
        ...
        public Skeleton2DAction RemoveOnVisibilityChanged() {
