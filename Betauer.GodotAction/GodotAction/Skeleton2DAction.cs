...
namespace Betauer.GodotAction {
    public class Skeleton2DAction : Node {
        public Skeleton2DAction() {
            SetProcess(false);
        ...
        public Skeleton2DAction OnBoneSetupChanged(Action action, bool oneShot = false, bool deferred = false) {
            if (_onBoneSetupChangedAction == null || _onBoneSetupChangedAction.Count == 0) {
                ...
                GetParent().Connect("bone_setup_changed", this, nameof(_GodotSignalBoneSetupChanged));
            }
        ...
        public Skeleton2DAction RemoveOnBoneSetupChanged(Action action) {
            ...
            if (_onBoneSetupChangedAction.Count == 0) {
                GetParent().Disconnect("bone_setup_changed", this, nameof(_GodotSignalBoneSetupChanged));
            }
            return this;
        }
