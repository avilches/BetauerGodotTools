...
namespace Betauer.GodotAction {
    public class ProximityGroupAction : ProxyNode {
        ...
        public void OnBroadcast(Action<string, Godot.Collections.Array> action, bool oneShot = false, bool deferred = false) =>
            AddSignal(ref _onBroadcastAction, "broadcast", nameof(_GodotSignalBroadcast), action, oneShot, deferred);

        public void RemoveOnBroadcast(Action<string, Godot.Collections.Array> action) =>
