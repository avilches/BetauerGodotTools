...
namespace Betauer.GodotAction {
    public class CameraAction : Camera {
        ...
        public CameraAction OnProcessAction(Action<float> action) {
            _onProcessAction ??= new List<Action<float>>(1);
            _onProcessAction.Add(action);
            SetProcess(true);
            return this;
        }
        public CameraAction OnPhysicsProcess(Action<float> action) {
        ...
        public CameraAction OnInput(Action<InputEvent> action) {
        ...
        public CameraAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public CameraAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public CameraAction RemoveOnProcessAction(Action<float> action) {
            _onProcessAction?.Remove(action);
            return this;
        }

        public CameraAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcess?.Remove(action);
            return this;
        }

        public CameraAction RemoveOnInput(Action<InputEvent> action) {
            _onInput?.Remove(action);
            return this;
        }

        public CameraAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInput?.Remove(action);
            return this;
        }

        public CameraAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public CameraAction OnGameplayEntered(Action action) {
        ...
        public CameraAction RemoveOnGameplayEntered() {
        ...
        public CameraAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public CameraAction RemoveOnScriptChanged() {
        ...
        public CameraAction OnVisibilityChanged(Action action) {
        ...
        public CameraAction RemoveOnVisibilityChanged() {
