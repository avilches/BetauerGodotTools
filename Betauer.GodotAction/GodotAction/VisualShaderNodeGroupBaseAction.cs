...
namespace Betauer.GodotAction {
    public class VisualShaderNodeGroupBaseAction : VisualShaderNodeGroupBase {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeGroupBaseAction OnChanged(Action action) {
        ...
        public VisualShaderNodeGroupBaseAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeGroupBaseAction OnScriptChanged(Action action) {
