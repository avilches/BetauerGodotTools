...
namespace Betauer.GodotAction {
    public class ExternalTextureAction : ExternalTexture {


        private List<Action>? _onChangedAction; 
        public ExternalTextureAction OnChanged(Action action) {
        ...
        public ExternalTextureAction OnScriptChanged(Action action) {
