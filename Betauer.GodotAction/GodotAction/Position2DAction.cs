...
namespace Betauer.GodotAction {
    public class Position2DAction : Node {
        public Position2DAction() {
            SetProcess(false);
        ...
        public Position2DAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public Position2DAction OnPhysicsProcess(Action<float> action) {
        ...
        public Position2DAction OnInput(Action<InputEvent> action) {
        ...
        public Position2DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public Position2DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public Position2DAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public Position2DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public Position2DAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public Position2DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public Position2DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
