...
namespace Betauer.GodotAction {
    public class Position2DAction : Position2D {
        ...
        public Position2DAction OnDraw(Action action) {
        ...
        public Position2DAction OnHide(Action action) {
        ...
        public Position2DAction OnItemRectChanged(Action action) {
        ...
        public Position2DAction OnReady(Action action) {
        ...
        public Position2DAction OnRenamed(Action action) {
        ...
        public Position2DAction OnScriptChanged(Action action) {
        ...
        public Position2DAction OnTreeEntered(Action action) {
        ...
        public Position2DAction OnTreeExited(Action action) {
        ...
        public Position2DAction OnTreeExiting(Action action) {
        ...
        public Position2DAction OnVisibilityChanged(Action action) {
