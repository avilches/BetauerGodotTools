...
namespace Betauer.GodotAction {
    public class ParticlesMaterialAction : ParticlesMaterial {


        private Action? _onChangedAction; 
        public ParticlesMaterialAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public ParticlesMaterialAction RemoveOnChanged() {
        ...
        public ParticlesMaterialAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public ParticlesMaterialAction RemoveOnScriptChanged() {
