...
namespace Betauer.GodotAction {
    public class Camera2DAction : Node {
        public Camera2DAction() {
            SetProcess(false);
        ...
        public Camera2DAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public Camera2DAction OnPhysicsProcess(Action<float> action) {
        ...
        public Camera2DAction OnInput(Action<InputEvent> action) {
        ...
        public Camera2DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public Camera2DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public Camera2DAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public Camera2DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public Camera2DAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public Camera2DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public Camera2DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
