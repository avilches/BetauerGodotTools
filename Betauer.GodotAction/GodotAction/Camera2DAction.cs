...
namespace Betauer.GodotAction {
    public class Camera2DAction : Camera2D {
        ...
        public Camera2DAction OnDraw(Action action) {
        ...
        public Camera2DAction OnHide(Action action) {
        ...
        public Camera2DAction OnItemRectChanged(Action action) {
        ...
        public Camera2DAction OnReady(Action action) {
        ...
        public Camera2DAction OnRenamed(Action action) {
        ...
        public Camera2DAction OnScriptChanged(Action action) {
        ...
        public Camera2DAction OnTreeEntered(Action action) {
        ...
        public Camera2DAction OnTreeExited(Action action) {
        ...
        public Camera2DAction OnTreeExiting(Action action) {
        ...
        public Camera2DAction OnVisibilityChanged(Action action) {
