...
namespace Betauer.GodotAction {
    public class VisualShaderNodeVectorScalarStepAction : VisualShaderNodeVectorScalarStep {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeVectorScalarStepAction OnChanged(Action action) {
        ...
        public VisualShaderNodeVectorScalarStepAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeVectorScalarStepAction OnScriptChanged(Action action) {
