...
namespace Betauer.GodotAction {
    public class SkeletonIKAction : Node {
        public SkeletonIKAction() {
            SetProcess(false);
        ...
        public SkeletonIKAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public SkeletonIKAction OnPhysicsProcess(Action<float> action) {
        ...
        public SkeletonIKAction OnInput(Action<InputEvent> action) {
        ...
        public SkeletonIKAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public SkeletonIKAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public SkeletonIKAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public SkeletonIKAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public SkeletonIKAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public SkeletonIKAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public SkeletonIKAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
