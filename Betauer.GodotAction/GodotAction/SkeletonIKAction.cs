...
namespace Betauer.GodotAction {
    public class SkeletonIKAction : SkeletonIK {
        ...
        public SkeletonIKAction OnReady(Action action) {
        ...
        public SkeletonIKAction OnRenamed(Action action) {
        ...
        public SkeletonIKAction OnScriptChanged(Action action) {
        ...
        public SkeletonIKAction OnTreeEntered(Action action) {
        ...
        public SkeletonIKAction OnTreeExited(Action action) {
        ...
        public SkeletonIKAction OnTreeExiting(Action action) {
