...
namespace Betauer.GodotAction {
    public class StyleBoxEmptyAction : StyleBoxEmpty {


        private List<Action>? _onChangedAction; 
        public StyleBoxEmptyAction OnChanged(Action action) {
        ...
        public StyleBoxEmptyAction OnScriptChanged(Action action) {
