...
namespace Betauer.GodotAction {
    public class VisualShaderNodeScalarUniformAction : VisualShaderNodeScalarUniform {


        private Action? _onChangedAction; 
        public VisualShaderNodeScalarUniformAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public VisualShaderNodeScalarUniformAction RemoveOnChanged() {
        ...
        public VisualShaderNodeScalarUniformAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeScalarUniformAction RemoveOnEditorRefreshRequest() {
        ...
        public VisualShaderNodeScalarUniformAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public VisualShaderNodeScalarUniformAction RemoveOnScriptChanged() {
