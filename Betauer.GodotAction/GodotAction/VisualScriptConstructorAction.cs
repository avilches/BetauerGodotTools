...
namespace Betauer.GodotAction {
    public class VisualScriptConstructorAction : VisualScriptConstructor {


        private List<Action>? _onChangedAction; 
        public VisualScriptConstructorAction OnChanged(Action action) {
        ...
        public VisualScriptConstructorAction OnPortsChanged(Action action) {
        ...
        public VisualScriptConstructorAction OnScriptChanged(Action action) {
