...
namespace Betauer.GodotAction {
    public class VisualScriptYieldAction : VisualScriptYield {


        private Action? _onChangedAction; 
        public VisualScriptYieldAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public VisualScriptYieldAction RemoveOnChanged() {
        ...
        public VisualScriptYieldAction OnPortsChanged(Action action) {
            if (_onPortsChangedAction == null) 
                Connect("ports_changed", this, nameof(ExecutePortsChanged));
            _onPortsChangedAction = action;
            return this;
        }
        public VisualScriptYieldAction RemoveOnPortsChanged() {
        ...
        public VisualScriptYieldAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public VisualScriptYieldAction RemoveOnScriptChanged() {
