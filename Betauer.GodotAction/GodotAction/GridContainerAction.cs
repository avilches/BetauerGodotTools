...
namespace Betauer.GodotAction {
    public class GridContainerAction : GridContainer {
        ...
        public GridContainerAction OnProcessAction(Action<float> action) {
            _onProcessAction ??= new List<Action<float>>(1);
            _onProcessAction.Add(action);
            SetProcess(true);
            return this;
        }
        public GridContainerAction OnPhysicsProcess(Action<float> action) {
        ...
        public GridContainerAction OnInput(Action<InputEvent> action) {
        ...
        public GridContainerAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public GridContainerAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public GridContainerAction RemoveOnProcessAction(Action<float> action) {
            _onProcessAction?.Remove(action);
            return this;
        }

        public GridContainerAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcess?.Remove(action);
            return this;
        }

        public GridContainerAction RemoveOnInput(Action<InputEvent> action) {
            _onInput?.Remove(action);
            return this;
        }

        public GridContainerAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInput?.Remove(action);
            return this;
        }

        public GridContainerAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public GridContainerAction OnDraw(Action action) {
            if (_onDrawAction == null) 
                Connect("draw", this, nameof(ExecuteDraw));
            _onDrawAction = action;
            return this;
        }
        public GridContainerAction RemoveOnDraw() {
        ...
        public GridContainerAction OnGuiInput(Action<InputEvent> action) {
            if (_onGuiInputAction == null) 
                Connect("gui_input", this, nameof(ExecuteGuiInput));
            _onGuiInputAction = action;
            return this;
        }
        public GridContainerAction RemoveOnGuiInput() {
        ...
        public GridContainerAction OnHide(Action action) {
            if (_onHideAction == null) 
                Connect("hide", this, nameof(ExecuteHide));
            _onHideAction = action;
            return this;
        }
        public GridContainerAction RemoveOnHide() {
        ...
        public GridContainerAction OnItemRectChanged(Action action) {
        ...
        public GridContainerAction RemoveOnItemRectChanged() {
        ...
        public GridContainerAction OnMinimumSizeChanged(Action action) {
        ...
        public GridContainerAction RemoveOnMinimumSizeChanged() {
        ...
        public GridContainerAction OnReady(Action action) {
            if (_onReadyAction == null) 
                Connect("ready", this, nameof(ExecuteReady));
            _onReadyAction = action;
            return this;
        }
        public GridContainerAction RemoveOnReady() {
        ...
        public GridContainerAction OnRenamed(Action action) {
            if (_onRenamedAction == null) 
                Connect("renamed", this, nameof(ExecuteRenamed));
            _onRenamedAction = action;
            return this;
        }
        public GridContainerAction RemoveOnRenamed() {
        ...
        public GridContainerAction OnResized(Action action) {
            if (_onResizedAction == null) 
                Connect("resized", this, nameof(ExecuteResized));
            _onResizedAction = action;
            return this;
        }
        public GridContainerAction RemoveOnResized() {
        ...
        public GridContainerAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public GridContainerAction RemoveOnScriptChanged() {
        ...
        public GridContainerAction OnSizeFlagsChanged(Action action) {
        ...
        public GridContainerAction RemoveOnSizeFlagsChanged() {
        ...
        public GridContainerAction OnVisibilityChanged(Action action) {
        ...
        public GridContainerAction RemoveOnVisibilityChanged() {
