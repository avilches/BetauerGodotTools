...
namespace Betauer.GodotAction {
    public class Node2DAction : Node2D {
        ...
        public Node2DAction OnDraw(Action action) {
        ...
        public Node2DAction OnHide(Action action) {
        ...
        public Node2DAction OnItemRectChanged(Action action) {
        ...
        public Node2DAction OnReady(Action action) {
        ...
        public Node2DAction OnRenamed(Action action) {
        ...
        public Node2DAction OnScriptChanged(Action action) {
        ...
        public Node2DAction OnTreeEntered(Action action) {
        ...
        public Node2DAction OnTreeExited(Action action) {
        ...
        public Node2DAction OnTreeExiting(Action action) {
        ...
        public Node2DAction OnVisibilityChanged(Action action) {
