...
namespace Betauer.GodotAction {
    public class Node2DAction : Node {
        public Node2DAction() {
            SetProcess(false);
        ...
        public Node2DAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public Node2DAction OnPhysicsProcess(Action<float> action) {
        ...
        public Node2DAction OnInput(Action<InputEvent> action) {
        ...
        public Node2DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public Node2DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public Node2DAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public Node2DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public Node2DAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public Node2DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public Node2DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
