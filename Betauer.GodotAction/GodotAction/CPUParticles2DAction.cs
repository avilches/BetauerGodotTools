...
namespace Betauer.GodotAction {
    public class CPUParticles2DAction : Node {
        public CPUParticles2DAction() {
            SetProcess(false);
        ...
        public CPUParticles2DAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public CPUParticles2DAction OnPhysicsProcess(Action<float> action) {
        ...
        public CPUParticles2DAction OnInput(Action<InputEvent> action) {
        ...
        public CPUParticles2DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public CPUParticles2DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public CPUParticles2DAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public CPUParticles2DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public CPUParticles2DAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public CPUParticles2DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public CPUParticles2DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public CPUParticles2DAction OnDraw(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public CPUParticles2DAction RemoveOnDraw(Action action) {
        ...
        public CPUParticles2DAction OnHide(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public CPUParticles2DAction RemoveOnHide(Action action) {
        ...
        public CPUParticles2DAction OnItemRectChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public CPUParticles2DAction RemoveOnItemRectChanged(Action action) {
        ...
        public CPUParticles2DAction OnReady(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public CPUParticles2DAction RemoveOnReady(Action action) {
        ...
        public CPUParticles2DAction OnRenamed(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public CPUParticles2DAction RemoveOnRenamed(Action action) {
        ...
        public CPUParticles2DAction OnScriptChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public CPUParticles2DAction RemoveOnScriptChanged(Action action) {
        ...
        public CPUParticles2DAction OnTreeEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public CPUParticles2DAction RemoveOnTreeEntered(Action action) {
        ...
        public CPUParticles2DAction OnTreeExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public CPUParticles2DAction RemoveOnTreeExited(Action action) {
        ...
        public CPUParticles2DAction OnTreeExiting(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public CPUParticles2DAction RemoveOnTreeExiting(Action action) {
        ...
        public CPUParticles2DAction OnVisibilityChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public CPUParticles2DAction RemoveOnVisibilityChanged(Action action) {
