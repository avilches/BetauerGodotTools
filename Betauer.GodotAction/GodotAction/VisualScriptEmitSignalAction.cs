...
namespace Betauer.GodotAction {
    public class VisualScriptEmitSignalAction : VisualScriptEmitSignal {


        private Action? _onChangedAction; 
        public VisualScriptEmitSignalAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public VisualScriptEmitSignalAction RemoveOnChanged() {
        ...
        public VisualScriptEmitSignalAction OnPortsChanged(Action action) {
            if (_onPortsChangedAction == null) 
                Connect("ports_changed", this, nameof(ExecutePortsChanged));
            _onPortsChangedAction = action;
            return this;
        }
        public VisualScriptEmitSignalAction RemoveOnPortsChanged() {
        ...
        public VisualScriptEmitSignalAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public VisualScriptEmitSignalAction RemoveOnScriptChanged() {
