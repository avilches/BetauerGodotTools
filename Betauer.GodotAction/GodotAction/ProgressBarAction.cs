...
namespace Betauer.GodotAction {
    public class ProgressBarAction : Node {
        ...
        public ProgressBarAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public ProgressBarAction OnPhysicsProcess(Action<float> action) {
        ...
        public ProgressBarAction OnInput(Action<InputEvent> action) {
        ...
        public ProgressBarAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public ProgressBarAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public ProgressBarAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public ProgressBarAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public ProgressBarAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public ProgressBarAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public ProgressBarAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
