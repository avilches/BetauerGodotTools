...
namespace Betauer.GodotAction {
    public class ProgressBarAction : ProgressBar {
        ...
        public ProgressBarAction OnChanged(Action action) {
        ...
        public ProgressBarAction OnDraw(Action action) {
        ...
        public ProgressBarAction OnFocusEntered(Action action) {
        ...
        public ProgressBarAction OnFocusExited(Action action) {
        ...
        public ProgressBarAction OnGuiInput(Action<InputEvent> action) {
        ...
        public ProgressBarAction OnHide(Action action) {
        ...
        public ProgressBarAction OnItemRectChanged(Action action) {
        ...
        public ProgressBarAction OnMinimumSizeChanged(Action action) {
        ...
        public ProgressBarAction OnModalClosed(Action action) {
        ...
        public ProgressBarAction OnMouseEntered(Action action) {
        ...
        public ProgressBarAction OnMouseExited(Action action) {
        ...
        public ProgressBarAction OnReady(Action action) {
        ...
        public ProgressBarAction OnRenamed(Action action) {
        ...
        public ProgressBarAction OnResized(Action action) {
        ...
        public ProgressBarAction OnScriptChanged(Action action) {
        ...
        public ProgressBarAction OnSizeFlagsChanged(Action action) {
        ...
        public ProgressBarAction OnTreeEntered(Action action) {
        ...
        public ProgressBarAction OnTreeExited(Action action) {
        ...
        public ProgressBarAction OnTreeExiting(Action action) {
        ...
        public ProgressBarAction OnValueChanged(Action<float> action) {
            if (_onValueChangedAction == null || _onValueChangedAction.Count == 0) {
                _onValueChangedAction ??= new List<Action<float>>(); 
                Connect("value_changed", this, nameof(_GodotSignalValueChanged));
            }
        ...
        public ProgressBarAction RemoveOnValueChanged(Action<float> action) {
            ...
            if (_onValueChangedAction.Count == 0) {
                Disconnect("value_changed", this, nameof(_GodotSignalValueChanged));
            }
            return this;
        }
        ...
        public ProgressBarAction OnVisibilityChanged(Action action) {
