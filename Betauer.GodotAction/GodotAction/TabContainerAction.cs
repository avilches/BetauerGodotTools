    ...
    public class TabContainerAction : TabContainer {
        ...
        public TabContainerAction OnPrePopupPressed(Action action) {
            if (_onPrePopupPressedAction == null || _onPrePopupPressedAction.Count == 0) {
                ...
                Connect("pre_popup_pressed", this, nameof(_GodotSignalPrePopupPressed));
            }
        ...
        public TabContainerAction RemoveOnPrePopupPressed(Action action) {
            ...
            if (_onPrePopupPressedAction.Count == 0) {
                Disconnect("pre_popup_pressed", this, nameof(_GodotSignalPrePopupPressed));
            }
            return this;
        }
        ...
        public TabContainerAction OnTabChanged(Action<int> action) {
            if (_onTabChangedAction == null || _onTabChangedAction.Count == 0) {
                ...
                Connect("tab_changed", this, nameof(_GodotSignalTabChanged));
            }
        ...
        public TabContainerAction RemoveOnTabChanged(Action<int> action) {
            ...
            if (_onTabChangedAction.Count == 0) {
                Disconnect("tab_changed", this, nameof(_GodotSignalTabChanged));
            }
            return this;
        }
        ...
        public TabContainerAction OnTabSelected(Action<int> action) {
            if (_onTabSelectedAction == null || _onTabSelectedAction.Count == 0) {
                ...
                Connect("tab_selected", this, nameof(_GodotSignalTabSelected));
            }
        ...
        public TabContainerAction RemoveOnTabSelected(Action<int> action) {
            ...
            if (_onTabSelectedAction.Count == 0) {
                Disconnect("tab_selected", this, nameof(_GodotSignalTabSelected));
            }
            return this;
        }
