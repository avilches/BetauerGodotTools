...
namespace Betauer.GodotAction {
    public class ColorRectAction : ColorRect {
        ...
        public ColorRectAction OnProcessAction(Action<float> action) {
        ...
        public ColorRectAction RemoveOnProcessAction(Action<float> action) {
        ...
        public ColorRectAction OnDraw(Action action) {
            if (_onDrawAction == null) 
                Connect("draw", this, nameof(ExecuteDraw));
            _onDrawAction = action;
            return this;
        }
        public ColorRectAction RemoveOnDraw() {
        ...
        public ColorRectAction OnGuiInput(Action<InputEvent> action) {
            if (_onGuiInputAction == null) 
                Connect("gui_input", this, nameof(ExecuteGuiInput));
            _onGuiInputAction = action;
            return this;
        }
        public ColorRectAction RemoveOnGuiInput() {
        ...
        public ColorRectAction OnHide(Action action) {
            if (_onHideAction == null) 
                Connect("hide", this, nameof(ExecuteHide));
            _onHideAction = action;
            return this;
        }
        public ColorRectAction RemoveOnHide() {
        ...
        public ColorRectAction OnItemRectChanged(Action action) {
        ...
        public ColorRectAction RemoveOnItemRectChanged() {
        ...
        public ColorRectAction OnMinimumSizeChanged(Action action) {
        ...
        public ColorRectAction RemoveOnMinimumSizeChanged() {
        ...
        public ColorRectAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public ColorRectAction RemoveOnScriptChanged() {
        ...
        public ColorRectAction OnSizeFlagsChanged(Action action) {
        ...
        public ColorRectAction RemoveOnSizeFlagsChanged() {
        ...
        public ColorRectAction OnVisibilityChanged(Action action) {
        ...
        public ColorRectAction RemoveOnVisibilityChanged() {
