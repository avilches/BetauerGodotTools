...
namespace Betauer.GodotAction {
    public class MultiMeshInstance2DAction : MultiMeshInstance2D {
        ...
        public MultiMeshInstance2DAction OnProcessAction(Action<float> action) {
            _onProcessAction ??= new List<Action<float>>(1);
            _onProcessAction.Add(action);
            SetProcess(true);
            return this;
        }
        public MultiMeshInstance2DAction OnPhysicsProcess(Action<float> action) {
        ...
        public MultiMeshInstance2DAction OnInput(Action<InputEvent> action) {
        ...
        public MultiMeshInstance2DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public MultiMeshInstance2DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public MultiMeshInstance2DAction RemoveOnProcessAction(Action<float> action) {
            _onProcessAction?.Remove(action);
            return this;
        }

        public MultiMeshInstance2DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcess?.Remove(action);
            return this;
        }

        public MultiMeshInstance2DAction RemoveOnInput(Action<InputEvent> action) {
            _onInput?.Remove(action);
            return this;
        }

        public MultiMeshInstance2DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInput?.Remove(action);
            return this;
        }

        public MultiMeshInstance2DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public MultiMeshInstance2DAction OnDraw(Action action) {
            if (_onDrawAction == null) 
                Connect("draw", this, nameof(ExecuteDraw));
            _onDrawAction = action;
            return this;
        }
        public MultiMeshInstance2DAction RemoveOnDraw() {
        ...
        public MultiMeshInstance2DAction OnHide(Action action) {
            if (_onHideAction == null) 
                Connect("hide", this, nameof(ExecuteHide));
            _onHideAction = action;
            return this;
        }
        public MultiMeshInstance2DAction RemoveOnHide() {
        ...
        public MultiMeshInstance2DAction OnItemRectChanged(Action action) {
        ...
        public MultiMeshInstance2DAction RemoveOnItemRectChanged() {
        ...
        public MultiMeshInstance2DAction OnReady(Action action) {
            if (_onReadyAction == null) 
                Connect("ready", this, nameof(ExecuteReady));
            _onReadyAction = action;
            return this;
        }
        public MultiMeshInstance2DAction RemoveOnReady() {
        ...
        public MultiMeshInstance2DAction OnRenamed(Action action) {
            if (_onRenamedAction == null) 
                Connect("renamed", this, nameof(ExecuteRenamed));
            _onRenamedAction = action;
            return this;
        }
        public MultiMeshInstance2DAction RemoveOnRenamed() {
        ...
        public MultiMeshInstance2DAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public MultiMeshInstance2DAction RemoveOnScriptChanged() {
        ...
        public MultiMeshInstance2DAction OnTextureChanged(Action action) {
            if (_onTextureChangedAction == null) 
                Connect("texture_changed", this, nameof(ExecuteTextureChanged));
            _onTextureChangedAction = action;
            return this;
        }
        public MultiMeshInstance2DAction RemoveOnTextureChanged() {
        ...
        public MultiMeshInstance2DAction OnTreeEntered(Action action) {
            if (_onTreeEnteredAction == null) 
                Connect("tree_entered", this, nameof(ExecuteTreeEntered));
            _onTreeEnteredAction = action;
            return this;
        }
        public MultiMeshInstance2DAction RemoveOnTreeEntered() {
        ...
        public MultiMeshInstance2DAction OnTreeExited(Action action) {
            if (_onTreeExitedAction == null) 
                Connect("tree_exited", this, nameof(ExecuteTreeExited));
            _onTreeExitedAction = action;
            return this;
        }
        public MultiMeshInstance2DAction RemoveOnTreeExited() {
        ...
        public MultiMeshInstance2DAction OnTreeExiting(Action action) {
            if (_onTreeExitingAction == null) 
                Connect("tree_exiting", this, nameof(ExecuteTreeExiting));
            _onTreeExitingAction = action;
            return this;
        }
        public MultiMeshInstance2DAction RemoveOnTreeExiting() {
        ...
        public MultiMeshInstance2DAction OnVisibilityChanged(Action action) {
        ...
        public MultiMeshInstance2DAction RemoveOnVisibilityChanged() {
