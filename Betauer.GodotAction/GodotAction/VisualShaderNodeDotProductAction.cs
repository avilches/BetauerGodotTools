...
namespace Betauer.GodotAction {
    public class VisualShaderNodeDotProductAction : VisualShaderNodeDotProduct {


        private Action? _onChangedAction; 
        public VisualShaderNodeDotProductAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public VisualShaderNodeDotProductAction RemoveOnChanged() {
        ...
        public VisualShaderNodeDotProductAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeDotProductAction RemoveOnEditorRefreshRequest() {
        ...
        public VisualShaderNodeDotProductAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public VisualShaderNodeDotProductAction RemoveOnScriptChanged() {
