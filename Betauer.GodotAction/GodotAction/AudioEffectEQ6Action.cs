...
namespace Betauer.GodotAction {
    public class AudioEffectEQ6Action : AudioEffectEQ6 {


        private List<Action>? _onChangedAction; 
        public AudioEffectEQ6Action OnChanged(Action action) {
        ...
        public AudioEffectEQ6Action OnScriptChanged(Action action) {
