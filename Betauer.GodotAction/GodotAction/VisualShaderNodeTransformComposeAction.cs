...
namespace Betauer.GodotAction {
    public class VisualShaderNodeTransformComposeAction : VisualShaderNodeTransformCompose {


        private Action? _onChangedAction; 
        public VisualShaderNodeTransformComposeAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public VisualShaderNodeTransformComposeAction RemoveOnChanged() {
        ...
        public VisualShaderNodeTransformComposeAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeTransformComposeAction RemoveOnEditorRefreshRequest() {
        ...
        public VisualShaderNodeTransformComposeAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public VisualShaderNodeTransformComposeAction RemoveOnScriptChanged() {
