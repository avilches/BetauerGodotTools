...
namespace Betauer.GodotAction {
    public class RoomManagerAction : Node {
        public RoomManagerAction() {
            SetProcess(false);
        ...
        public RoomManagerAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public RoomManagerAction OnPhysicsProcess(Action<float> action) {
        ...
        public RoomManagerAction OnInput(Action<InputEvent> action) {
        ...
        public RoomManagerAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public RoomManagerAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public RoomManagerAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public RoomManagerAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public RoomManagerAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public RoomManagerAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public RoomManagerAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
