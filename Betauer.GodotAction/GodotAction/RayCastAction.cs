...
namespace Betauer.GodotAction {
    public class RayCastAction : RayCast {
        ...
        public RayCastAction OnGameplayEntered(Action action) {
        ...
        public RayCastAction OnGameplayExited(Action action) {
        ...
        public RayCastAction OnReady(Action action) {
        ...
        public RayCastAction OnRenamed(Action action) {
        ...
        public RayCastAction OnScriptChanged(Action action) {
        ...
        public RayCastAction OnTreeEntered(Action action) {
        ...
        public RayCastAction OnTreeExited(Action action) {
        ...
        public RayCastAction OnTreeExiting(Action action) {
        ...
        public RayCastAction OnVisibilityChanged(Action action) {
