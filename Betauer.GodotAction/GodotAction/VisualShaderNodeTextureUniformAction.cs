...
namespace Betauer.GodotAction {
    public class VisualShaderNodeTextureUniformAction : VisualShaderNodeTextureUniform {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeTextureUniformAction OnChanged(Action action) {
        ...
        public VisualShaderNodeTextureUniformAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeTextureUniformAction OnScriptChanged(Action action) {
