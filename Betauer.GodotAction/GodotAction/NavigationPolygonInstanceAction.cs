...
namespace Betauer.GodotAction {
    public class NavigationPolygonInstanceAction : Node {
        public NavigationPolygonInstanceAction() {
            SetProcess(false);
        ...
        public NavigationPolygonInstanceAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public NavigationPolygonInstanceAction OnPhysicsProcess(Action<float> action) {
        ...
        public NavigationPolygonInstanceAction OnInput(Action<InputEvent> action) {
        ...
        public NavigationPolygonInstanceAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public NavigationPolygonInstanceAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public NavigationPolygonInstanceAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public NavigationPolygonInstanceAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public NavigationPolygonInstanceAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public NavigationPolygonInstanceAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public NavigationPolygonInstanceAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
