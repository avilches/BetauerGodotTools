...
namespace Betauer.GodotAction {
    public class GLTFSpecGlossAction : GLTFSpecGloss {


        private List<Action>? _onChangedAction; 
        public GLTFSpecGlossAction OnChanged(Action action) {
        ...
        public GLTFSpecGlossAction OnScriptChanged(Action action) {
