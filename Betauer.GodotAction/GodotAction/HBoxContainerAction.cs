...
namespace Betauer.GodotAction {
    public class HBoxContainerAction : Node {
        public HBoxContainerAction() {
            SetProcess(false);
        ...
        public HBoxContainerAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public HBoxContainerAction OnPhysicsProcess(Action<float> action) {
        ...
        public HBoxContainerAction OnInput(Action<InputEvent> action) {
        ...
        public HBoxContainerAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public HBoxContainerAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public HBoxContainerAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public HBoxContainerAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public HBoxContainerAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public HBoxContainerAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public HBoxContainerAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
