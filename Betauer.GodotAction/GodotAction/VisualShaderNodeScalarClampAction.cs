...
namespace Betauer.GodotAction {
    public class VisualShaderNodeScalarClampAction : VisualShaderNodeScalarClamp {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeScalarClampAction OnChanged(Action action) {
        ...
        public VisualShaderNodeScalarClampAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeScalarClampAction OnScriptChanged(Action action) {
