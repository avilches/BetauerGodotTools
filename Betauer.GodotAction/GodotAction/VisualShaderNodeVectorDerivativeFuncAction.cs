...
namespace Betauer.GodotAction {
    public class VisualShaderNodeVectorDerivativeFuncAction : VisualShaderNodeVectorDerivativeFunc {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeVectorDerivativeFuncAction OnChanged(Action action) {
        ...
        public VisualShaderNodeVectorDerivativeFuncAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeVectorDerivativeFuncAction OnScriptChanged(Action action) {
