...
namespace Betauer.GodotAction {
    public class PinJoint2DAction : PinJoint2D {
        ...
        public PinJoint2DAction OnProcessAction(Action<float> action) {
            _onProcessAction ??= new List<Action<float>>(1);
            _onProcessAction.Add(action);
            SetProcess(true);
            return this;
        }
        public PinJoint2DAction OnPhysicsProcess(Action<float> action) {
        ...
        public PinJoint2DAction OnInput(Action<InputEvent> action) {
        ...
        public PinJoint2DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public PinJoint2DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public PinJoint2DAction RemoveOnProcessAction(Action<float> action) {
            _onProcessAction?.Remove(action);
            return this;
        }

        public PinJoint2DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcess?.Remove(action);
            return this;
        }

        public PinJoint2DAction RemoveOnInput(Action<InputEvent> action) {
            _onInput?.Remove(action);
            return this;
        }

        public PinJoint2DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInput?.Remove(action);
            return this;
        }

        public PinJoint2DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public PinJoint2DAction OnDraw(Action action) {
            if (_onDrawAction == null) 
                Connect("draw", this, nameof(ExecuteDraw));
            _onDrawAction = action;
            return this;
        }
        public PinJoint2DAction RemoveOnDraw() {
        ...
        public PinJoint2DAction OnHide(Action action) {
            if (_onHideAction == null) 
                Connect("hide", this, nameof(ExecuteHide));
            _onHideAction = action;
            return this;
        }
        public PinJoint2DAction RemoveOnHide() {
        ...
        public PinJoint2DAction OnItemRectChanged(Action action) {
        ...
        public PinJoint2DAction RemoveOnItemRectChanged() {
        ...
        public PinJoint2DAction OnReady(Action action) {
            if (_onReadyAction == null) 
                Connect("ready", this, nameof(ExecuteReady));
            _onReadyAction = action;
            return this;
        }
        public PinJoint2DAction RemoveOnReady() {
        ...
        public PinJoint2DAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public PinJoint2DAction RemoveOnScriptChanged() {
        ...
        public PinJoint2DAction OnVisibilityChanged(Action action) {
        ...
        public PinJoint2DAction RemoveOnVisibilityChanged() {
