...
namespace Betauer.GodotAction {
    public class VisualShaderNodeIsAction : VisualShaderNodeIs {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeIsAction OnChanged(Action action) {
        ...
        public VisualShaderNodeIsAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeIsAction OnScriptChanged(Action action) {
