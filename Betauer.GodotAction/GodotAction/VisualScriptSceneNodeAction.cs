...
namespace Betauer.GodotAction {
    public class VisualScriptSceneNodeAction : VisualScriptSceneNode {


        private List<Action>? _onChangedAction; 
        public VisualScriptSceneNodeAction OnChanged(Action action) {
        ...
        public VisualScriptSceneNodeAction OnPortsChanged(Action action) {
        ...
        public VisualScriptSceneNodeAction OnScriptChanged(Action action) {
