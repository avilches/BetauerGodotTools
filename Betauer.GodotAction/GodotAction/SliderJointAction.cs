...
namespace Betauer.GodotAction {
    public class SliderJointAction : Node {
        public SliderJointAction() {
            SetProcess(false);
        ...
        public SliderJointAction OnProcess(Action<float> action) {
        ...
        public SliderJointAction RemoveOnProcess(Action<float> action) {
