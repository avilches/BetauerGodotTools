...
namespace Betauer.GodotAction {
    public class GradientTextureAction : GradientTexture {


        private Action? _onChangedAction; 
        public GradientTextureAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public GradientTextureAction RemoveOnChanged() {
        ...
        public GradientTextureAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public GradientTextureAction RemoveOnScriptChanged() {
