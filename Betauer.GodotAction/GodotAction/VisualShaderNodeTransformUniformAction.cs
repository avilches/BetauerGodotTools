...
namespace Betauer.GodotAction {
    public class VisualShaderNodeTransformUniformAction : VisualShaderNodeTransformUniform {


        private Action? _onChangedAction; 
        public VisualShaderNodeTransformUniformAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public VisualShaderNodeTransformUniformAction RemoveOnChanged() {
        ...
        public VisualShaderNodeTransformUniformAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeTransformUniformAction RemoveOnEditorRefreshRequest() {
        ...
        public VisualShaderNodeTransformUniformAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public VisualShaderNodeTransformUniformAction RemoveOnScriptChanged() {
