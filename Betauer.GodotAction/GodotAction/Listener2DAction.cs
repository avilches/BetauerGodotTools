...
namespace Betauer.GodotAction {
    public class Listener2DAction : Node {
        public Listener2DAction() {
            SetProcess(false);
        ...
        public Listener2DAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public Listener2DAction OnPhysicsProcess(Action<float> action) {
        ...
        public Listener2DAction OnInput(Action<InputEvent> action) {
        ...
        public Listener2DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public Listener2DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public Listener2DAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public Listener2DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public Listener2DAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public Listener2DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public Listener2DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
