...
namespace Betauer.GodotAction {
    public class Listener2DAction : Listener2D {
        ...
        public Listener2DAction OnDraw(Action action) {
        ...
        public Listener2DAction OnHide(Action action) {
        ...
        public Listener2DAction OnItemRectChanged(Action action) {
        ...
        public Listener2DAction OnReady(Action action) {
        ...
        public Listener2DAction OnRenamed(Action action) {
        ...
        public Listener2DAction OnScriptChanged(Action action) {
        ...
        public Listener2DAction OnTreeEntered(Action action) {
        ...
        public Listener2DAction OnTreeExited(Action action) {
        ...
        public Listener2DAction OnTreeExiting(Action action) {
        ...
        public Listener2DAction OnVisibilityChanged(Action action) {
