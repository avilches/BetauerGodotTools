...
namespace Betauer.GodotAction {
    public class VisualShaderNodeCubeMapUniformAction : VisualShaderNodeCubeMapUniform {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeCubeMapUniformAction OnChanged(Action action) {
        ...
        public VisualShaderNodeCubeMapUniformAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeCubeMapUniformAction OnScriptChanged(Action action) {
