...
namespace Betauer.GodotAction {
    public class Navigation2DAction : Node {
        public Navigation2DAction() {
            SetProcess(false);
        ...
        public Navigation2DAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public Navigation2DAction OnPhysicsProcess(Action<float> action) {
        ...
        public Navigation2DAction OnInput(Action<InputEvent> action) {
        ...
        public Navigation2DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public Navigation2DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public Navigation2DAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public Navigation2DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public Navigation2DAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public Navigation2DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public Navigation2DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
