...
namespace Betauer.GodotAction {
    public class HSeparatorAction : HSeparator {
        ...
        public HSeparatorAction OnProcessAction(Action<float> action) {
            _onProcessAction ??= new List<Action<float>>(1);
            _onProcessAction.Add(action);
            SetProcess(true);
            return this;
        }
        public HSeparatorAction OnPhysicsProcess(Action<float> action) {
        ...
        public HSeparatorAction OnInput(Action<InputEvent> action) {
        ...
        public HSeparatorAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public HSeparatorAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public HSeparatorAction RemoveOnProcessAction(Action<float> action) {
            _onProcessAction?.Remove(action);
            return this;
        }

        public HSeparatorAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcess?.Remove(action);
            return this;
        }

        public HSeparatorAction RemoveOnInput(Action<InputEvent> action) {
            _onInput?.Remove(action);
            return this;
        }

        public HSeparatorAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInput?.Remove(action);
            return this;
        }

        public HSeparatorAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public HSeparatorAction OnDraw(Action action) {
            if (_onDrawAction == null) 
                Connect("draw", this, nameof(ExecuteDraw));
            _onDrawAction = action;
            return this;
        }
        public HSeparatorAction RemoveOnDraw() {
        ...
        public HSeparatorAction OnGuiInput(Action<InputEvent> action) {
            if (_onGuiInputAction == null) 
                Connect("gui_input", this, nameof(ExecuteGuiInput));
            _onGuiInputAction = action;
            return this;
        }
        public HSeparatorAction RemoveOnGuiInput() {
        ...
        public HSeparatorAction OnHide(Action action) {
            if (_onHideAction == null) 
                Connect("hide", this, nameof(ExecuteHide));
            _onHideAction = action;
            return this;
        }
        public HSeparatorAction RemoveOnHide() {
        ...
        public HSeparatorAction OnItemRectChanged(Action action) {
        ...
        public HSeparatorAction RemoveOnItemRectChanged() {
        ...
        public HSeparatorAction OnMinimumSizeChanged(Action action) {
        ...
        public HSeparatorAction RemoveOnMinimumSizeChanged() {
        ...
        public HSeparatorAction OnReady(Action action) {
            if (_onReadyAction == null) 
                Connect("ready", this, nameof(ExecuteReady));
            _onReadyAction = action;
            return this;
        }
        public HSeparatorAction RemoveOnReady() {
        ...
        public HSeparatorAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public HSeparatorAction RemoveOnScriptChanged() {
        ...
        public HSeparatorAction OnSizeFlagsChanged(Action action) {
        ...
        public HSeparatorAction RemoveOnSizeFlagsChanged() {
        ...
        public HSeparatorAction OnVisibilityChanged(Action action) {
        ...
        public HSeparatorAction RemoveOnVisibilityChanged() {
