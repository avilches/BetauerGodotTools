...
namespace Betauer.GodotAction {
    public class AnimationNodeAdd2Action : AnimationNodeAdd2 {


        private Action? _onChangedAction; 
        public AnimationNodeAdd2Action OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public AnimationNodeAdd2Action RemoveOnChanged() {
        ...
        public AnimationNodeAdd2Action OnRemovedFromGraph(Action action) {
        ...
        public AnimationNodeAdd2Action RemoveOnRemovedFromGraph() {
        ...
        public AnimationNodeAdd2Action OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public AnimationNodeAdd2Action RemoveOnScriptChanged() {
        ...
        public AnimationNodeAdd2Action OnTreeChanged(Action action) {
            if (_onTreeChangedAction == null) 
                Connect("tree_changed", this, nameof(ExecuteTreeChanged));
            _onTreeChangedAction = action;
            return this;
        }
        public AnimationNodeAdd2Action RemoveOnTreeChanged() {
