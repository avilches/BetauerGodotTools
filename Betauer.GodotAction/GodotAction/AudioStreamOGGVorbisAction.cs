...
namespace Betauer.GodotAction {
    public class AudioStreamOGGVorbisAction : AudioStreamOGGVorbis {


        private List<Action>? _onChangedAction; 
        public AudioStreamOGGVorbisAction OnChanged(Action action) {
        ...
        public AudioStreamOGGVorbisAction OnScriptChanged(Action action) {
