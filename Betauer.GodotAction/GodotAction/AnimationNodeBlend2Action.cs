...
namespace Betauer.GodotAction {
    public class AnimationNodeBlend2Action : AnimationNodeBlend2 {


        private Action? _onChangedAction; 
        public AnimationNodeBlend2Action OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public AnimationNodeBlend2Action RemoveOnChanged() {
        ...
        public AnimationNodeBlend2Action OnRemovedFromGraph(Action action) {
        ...
        public AnimationNodeBlend2Action RemoveOnRemovedFromGraph() {
        ...
        public AnimationNodeBlend2Action OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public AnimationNodeBlend2Action RemoveOnScriptChanged() {
        ...
        public AnimationNodeBlend2Action OnTreeChanged(Action action) {
            if (_onTreeChangedAction == null) 
                Connect("tree_changed", this, nameof(ExecuteTreeChanged));
            _onTreeChangedAction = action;
            return this;
        }
        public AnimationNodeBlend2Action RemoveOnTreeChanged() {
