...
namespace Betauer.GodotAction {
    public class VisualShaderNodeCustomAction : VisualShaderNodeCustom {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeCustomAction OnChanged(Action action) {
        ...
        public VisualShaderNodeCustomAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeCustomAction OnScriptChanged(Action action) {
