...
namespace Betauer.GodotAction {
    public class PackedSceneGLTFAction : PackedSceneGLTF {


        private List<Action>? _onChangedAction; 
        public PackedSceneGLTFAction OnChanged(Action action) {
        ...
        public PackedSceneGLTFAction OnScriptChanged(Action action) {
