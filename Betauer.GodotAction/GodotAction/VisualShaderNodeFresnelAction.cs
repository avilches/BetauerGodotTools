...
namespace Betauer.GodotAction {
    public class VisualShaderNodeFresnelAction : VisualShaderNodeFresnel {


        private Action? _onChangedAction; 
        public VisualShaderNodeFresnelAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public VisualShaderNodeFresnelAction RemoveOnChanged() {
        ...
        public VisualShaderNodeFresnelAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeFresnelAction RemoveOnEditorRefreshRequest() {
        ...
        public VisualShaderNodeFresnelAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public VisualShaderNodeFresnelAction RemoveOnScriptChanged() {
