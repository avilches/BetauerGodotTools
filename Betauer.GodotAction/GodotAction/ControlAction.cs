...
namespace Betauer.GodotAction {
    public class ControlAction : Node {
        ...
        public ControlAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public ControlAction OnPhysicsProcess(Action<float> action) {
        ...
        public ControlAction OnInput(Action<InputEvent> action) {
        ...
        public ControlAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public ControlAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public ControlAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public ControlAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public ControlAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public ControlAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public ControlAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
