...
namespace Betauer.GodotAction {
    public class InputEventMouseButtonAction : InputEventMouseButton {


        private List<Action>? _onChangedAction; 
        public InputEventMouseButtonAction OnChanged(Action action) {
        ...
        public InputEventMouseButtonAction OnScriptChanged(Action action) {
