...
namespace Betauer.GodotAction {
    public class VisualScriptYieldSignalAction : VisualScriptYieldSignal {


        private List<Action>? _onChangedAction; 
        public VisualScriptYieldSignalAction OnChanged(Action action) {
        ...
        public VisualScriptYieldSignalAction OnPortsChanged(Action action) {
        ...
        public VisualScriptYieldSignalAction OnScriptChanged(Action action) {
