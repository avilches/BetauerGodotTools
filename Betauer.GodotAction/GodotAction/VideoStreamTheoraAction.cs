...
namespace Betauer.GodotAction {
    public class VideoStreamTheoraAction : VideoStreamTheora {


        private Action? _onChangedAction; 
        public VideoStreamTheoraAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public VideoStreamTheoraAction RemoveOnChanged() {
        ...
        public VideoStreamTheoraAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public VideoStreamTheoraAction RemoveOnScriptChanged() {
