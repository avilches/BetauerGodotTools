...
namespace Betauer.GodotAction {
    public class AnimationNodeBlendSpace2DAction : Node {
        ...
        private void _GodotSignalTrianglesUpdated() {
            if (_onTrianglesUpdatedAction == null || _onTrianglesUpdatedAction.Count == 0) return;
            for (var i = 0; i < _onTrianglesUpdatedAction.Count; i++) _onTrianglesUpdatedAction[i].Invoke();
        }
