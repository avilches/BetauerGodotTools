...
namespace Betauer.GodotAction {
    public class AnimationNodeAction : AnimationNode {


        private Action? _onChangedAction; 
        public AnimationNodeAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public AnimationNodeAction RemoveOnChanged() {
        ...
        public AnimationNodeAction OnRemovedFromGraph(Action action) {
        ...
        public AnimationNodeAction RemoveOnRemovedFromGraph() {
        ...
        public AnimationNodeAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public AnimationNodeAction RemoveOnScriptChanged() {
