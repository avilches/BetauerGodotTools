...
namespace Betauer.GodotAction {
    public class AudioStreamPlayerAction : Node {
        public AudioStreamPlayerAction() {
            SetProcess(false);
        ...
        public AudioStreamPlayerAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public AudioStreamPlayerAction OnPhysicsProcess(Action<float> action) {
        ...
        public AudioStreamPlayerAction OnInput(Action<InputEvent> action) {
        ...
        public AudioStreamPlayerAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public AudioStreamPlayerAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public AudioStreamPlayerAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public AudioStreamPlayerAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public AudioStreamPlayerAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public AudioStreamPlayerAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public AudioStreamPlayerAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public AudioStreamPlayerAction OnFinished(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public AudioStreamPlayerAction RemoveOnFinished(Action action) {
        ...
        public AudioStreamPlayerAction OnReady(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public AudioStreamPlayerAction RemoveOnReady(Action action) {
        ...
        public AudioStreamPlayerAction OnRenamed(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public AudioStreamPlayerAction RemoveOnRenamed(Action action) {
        ...
        public AudioStreamPlayerAction OnScriptChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public AudioStreamPlayerAction RemoveOnScriptChanged(Action action) {
        ...
        public AudioStreamPlayerAction OnTreeEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public AudioStreamPlayerAction RemoveOnTreeEntered(Action action) {
        ...
        public AudioStreamPlayerAction OnTreeExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public AudioStreamPlayerAction RemoveOnTreeExited(Action action) {
        ...
        public AudioStreamPlayerAction OnTreeExiting(Action action, bool oneShot = false, bool deferred = false) {
        ...
        public AudioStreamPlayerAction RemoveOnTreeExiting(Action action) {
