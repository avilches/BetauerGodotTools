...
namespace Betauer.GodotAction {
    public class CollisionPolygon2DAction : Node {
        public CollisionPolygon2DAction() {
            SetProcess(false);
        ...
        public CollisionPolygon2DAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public CollisionPolygon2DAction OnPhysicsProcess(Action<float> action) {
        ...
        public CollisionPolygon2DAction OnInput(Action<InputEvent> action) {
        ...
        public CollisionPolygon2DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public CollisionPolygon2DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public CollisionPolygon2DAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public CollisionPolygon2DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public CollisionPolygon2DAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public CollisionPolygon2DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public CollisionPolygon2DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
