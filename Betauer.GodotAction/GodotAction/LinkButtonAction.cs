...
namespace Betauer.GodotAction {
    public class LinkButtonAction : LinkButton {
        ...
        public LinkButtonAction OnProcessAction(Action<float> action) {
            _onProcessAction ??= new List<Action<float>>(1);
            _onProcessAction.Add(action);
            SetProcess(true);
            return this;
        }
        public LinkButtonAction OnPhysicsProcess(Action<float> action) {
        ...
        public LinkButtonAction OnInput(Action<InputEvent> action) {
        ...
        public LinkButtonAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public LinkButtonAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public LinkButtonAction RemoveOnProcessAction(Action<float> action) {
            _onProcessAction?.Remove(action);
            return this;
        }

        public LinkButtonAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcess?.Remove(action);
            return this;
        }

        public LinkButtonAction RemoveOnInput(Action<InputEvent> action) {
            _onInput?.Remove(action);
            return this;
        }

        public LinkButtonAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInput?.Remove(action);
            return this;
        }

        public LinkButtonAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public LinkButtonAction OnDraw(Action action) {
            if (_onDrawAction == null) 
                Connect("draw", this, nameof(ExecuteDraw));
            _onDrawAction = action;
            return this;
        }
        public LinkButtonAction RemoveOnDraw() {
        ...
        public LinkButtonAction OnGuiInput(Action<InputEvent> action) {
            if (_onGuiInputAction == null) 
                Connect("gui_input", this, nameof(ExecuteGuiInput));
            _onGuiInputAction = action;
            return this;
        }
        public LinkButtonAction RemoveOnGuiInput() {
        ...
        public LinkButtonAction OnHide(Action action) {
            if (_onHideAction == null) 
                Connect("hide", this, nameof(ExecuteHide));
            _onHideAction = action;
            return this;
        }
        public LinkButtonAction RemoveOnHide() {
        ...
        public LinkButtonAction OnItemRectChanged(Action action) {
        ...
        public LinkButtonAction RemoveOnItemRectChanged() {
        ...
        public LinkButtonAction OnMinimumSizeChanged(Action action) {
        ...
        public LinkButtonAction RemoveOnMinimumSizeChanged() {
        ...
        public LinkButtonAction OnReady(Action action) {
            if (_onReadyAction == null) 
                Connect("ready", this, nameof(ExecuteReady));
            _onReadyAction = action;
            return this;
        }
        public LinkButtonAction RemoveOnReady() {
        ...
        public LinkButtonAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public LinkButtonAction RemoveOnScriptChanged() {
        ...
        public LinkButtonAction OnSizeFlagsChanged(Action action) {
        ...
        public LinkButtonAction RemoveOnSizeFlagsChanged() {
        ...
        public LinkButtonAction OnToggled(Action<bool> action) {
            if (_onToggledAction == null) 
                Connect("toggled", this, nameof(ExecuteToggled));
            _onToggledAction = action;
            return this;
        }
        public LinkButtonAction RemoveOnToggled() {
        ...
        public LinkButtonAction OnVisibilityChanged(Action action) {
        ...
        public LinkButtonAction RemoveOnVisibilityChanged() {
