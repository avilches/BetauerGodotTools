...
namespace Betauer.GodotAction {
    public class Bone2DAction : Node {
        public Bone2DAction() {
            SetProcess(false);
        ...
        public Bone2DAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public Bone2DAction OnPhysicsProcess(Action<float> action) {
        ...
        public Bone2DAction OnInput(Action<InputEvent> action) {
        ...
        public Bone2DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public Bone2DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public Bone2DAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public Bone2DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public Bone2DAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public Bone2DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public Bone2DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
