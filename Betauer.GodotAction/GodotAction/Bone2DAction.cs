...
namespace Betauer.GodotAction {
    public class Bone2DAction : Bone2D {
        ...
        public Bone2DAction OnDraw(Action action) {
        ...
        public Bone2DAction OnHide(Action action) {
        ...
        public Bone2DAction OnItemRectChanged(Action action) {
        ...
        public Bone2DAction OnReady(Action action) {
        ...
        public Bone2DAction OnRenamed(Action action) {
        ...
        public Bone2DAction OnScriptChanged(Action action) {
        ...
        public Bone2DAction OnTreeEntered(Action action) {
        ...
        public Bone2DAction OnTreeExited(Action action) {
        ...
        public Bone2DAction OnTreeExiting(Action action) {
        ...
        public Bone2DAction OnVisibilityChanged(Action action) {
