...
namespace Betauer.GodotAction {
    public class VScrollBarAction : Node {
        public VScrollBarAction() {
            SetProcess(false);
        ...
        public VScrollBarAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public VScrollBarAction OnPhysicsProcess(Action<float> action) {
        ...
        public VScrollBarAction OnInput(Action<InputEvent> action) {
        ...
        public VScrollBarAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public VScrollBarAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public VScrollBarAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public VScrollBarAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public VScrollBarAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public VScrollBarAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public VScrollBarAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public VScrollBarAction OnScrolling(Action action, bool oneShot = false, bool deferred = false) {
            if (_onScrollingAction == null || _onScrollingAction.Count == 0) {
                ...
                GetParent().Connect("scrolling", this, nameof(_GodotSignalScrolling));
            }
        ...
        public VScrollBarAction RemoveOnScrolling(Action action) {
            ...
            if (_onScrollingAction.Count == 0) {
                GetParent().Disconnect("scrolling", this, nameof(_GodotSignalScrolling));
            }
            return this;
        }
        private void _GodotSignalScrolling() {
