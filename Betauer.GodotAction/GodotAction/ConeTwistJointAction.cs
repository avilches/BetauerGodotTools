...
namespace Betauer.GodotAction {
    public class ConeTwistJointAction : Node {
        public ConeTwistJointAction() {
            SetProcess(false);
        ...
        public ConeTwistJointAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public ConeTwistJointAction OnPhysicsProcess(Action<float> action) {
        ...
        public ConeTwistJointAction OnInput(Action<InputEvent> action) {
        ...
        public ConeTwistJointAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public ConeTwistJointAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public ConeTwistJointAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public ConeTwistJointAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public ConeTwistJointAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public ConeTwistJointAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public ConeTwistJointAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
