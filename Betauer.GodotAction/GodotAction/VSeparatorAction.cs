...
namespace Betauer.GodotAction {
    public class VSeparatorAction : Node {
        public VSeparatorAction() {
            SetProcess(false);
        ...
        public VSeparatorAction OnProcess(Action<float> action) {
        ...
        public VSeparatorAction RemoveOnProcess(Action<float> action) {
