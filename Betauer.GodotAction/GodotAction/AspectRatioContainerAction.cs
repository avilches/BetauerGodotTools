...
namespace Betauer.GodotAction {
    public class AspectRatioContainerAction : Node {
        public AspectRatioContainerAction() {
            SetProcess(false);
        ...
        public AspectRatioContainerAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public AspectRatioContainerAction OnPhysicsProcess(Action<float> action) {
        ...
        public AspectRatioContainerAction OnInput(Action<InputEvent> action) {
        ...
        public AspectRatioContainerAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public AspectRatioContainerAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public AspectRatioContainerAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public AspectRatioContainerAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public AspectRatioContainerAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public AspectRatioContainerAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public AspectRatioContainerAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
