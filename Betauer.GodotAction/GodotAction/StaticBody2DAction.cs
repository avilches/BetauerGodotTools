...
namespace Betauer.GodotAction {
    public class StaticBody2DAction : Node {
        public StaticBody2DAction() {
            SetProcess(false);
        ...
        public StaticBody2DAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public StaticBody2DAction OnPhysicsProcess(Action<float> action) {
        ...
        public StaticBody2DAction OnInput(Action<InputEvent> action) {
        ...
        public StaticBody2DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public StaticBody2DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public StaticBody2DAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public StaticBody2DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public StaticBody2DAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public StaticBody2DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public StaticBody2DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
