...
namespace Betauer.GodotAction {
    public class StaticBody2DAction : StaticBody2D {
        ...
        public StaticBody2DAction OnDraw(Action action) {
        ...
        public StaticBody2DAction OnHide(Action action) {
        ...
        public StaticBody2DAction OnInputEvent(Action<InputEvent, int, Node> action) {
        ...
        public StaticBody2DAction OnItemRectChanged(Action action) {
        ...
        public StaticBody2DAction OnMouseEntered(Action action) {
        ...
        public StaticBody2DAction OnMouseExited(Action action) {
        ...
        public StaticBody2DAction OnReady(Action action) {
        ...
        public StaticBody2DAction OnRenamed(Action action) {
        ...
        public StaticBody2DAction OnScriptChanged(Action action) {
        ...
        public StaticBody2DAction OnTreeEntered(Action action) {
        ...
        public StaticBody2DAction OnTreeExited(Action action) {
        ...
        public StaticBody2DAction OnTreeExiting(Action action) {
        ...
        public StaticBody2DAction OnVisibilityChanged(Action action) {
