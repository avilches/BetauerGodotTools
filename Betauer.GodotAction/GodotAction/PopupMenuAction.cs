    ...
    public class PopupMenuAction : PopupMenu {
        ...
        public PopupMenuAction OnIdFocused(Action<int> action) {
            if (_onIdFocusedAction == null || _onIdFocusedAction.Count == 0) {
                ...
                Connect("id_focused", this, nameof(_GodotSignalIdFocused));
            }
        ...
        public PopupMenuAction RemoveOnIdFocused(Action<int> action) {
            ...
            if (_onIdFocusedAction.Count == 0) {
                Disconnect("id_focused", this, nameof(_GodotSignalIdFocused));
            }
            return this;
        }
        ...
        public PopupMenuAction OnIdPressed(Action<int> action) {
            if (_onIdPressedAction == null || _onIdPressedAction.Count == 0) {
                ...
                Connect("id_pressed", this, nameof(_GodotSignalIdPressed));
            }
        ...
        public PopupMenuAction RemoveOnIdPressed(Action<int> action) {
            ...
            if (_onIdPressedAction.Count == 0) {
                Disconnect("id_pressed", this, nameof(_GodotSignalIdPressed));
            }
            return this;
        }
        ...
        public PopupMenuAction OnIndexPressed(Action<int> action) {
            if (_onIndexPressedAction == null || _onIndexPressedAction.Count == 0) {
                ...
                Connect("index_pressed", this, nameof(_GodotSignalIndexPressed));
            }
        ...
        public PopupMenuAction RemoveOnIndexPressed(Action<int> action) {
            ...
            if (_onIndexPressedAction.Count == 0) {
                Disconnect("index_pressed", this, nameof(_GodotSignalIndexPressed));
            }
            return this;
        }
