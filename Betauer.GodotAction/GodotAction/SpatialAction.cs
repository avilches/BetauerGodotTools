...
namespace Betauer.GodotAction {
    public class SpatialAction : Spatial {
        ...
        public SpatialAction OnProcessAction(Action<float> action) {
            _onProcessAction ??= new List<Action<float>>(1);
            _onProcessAction.Add(action);
            SetProcess(true);
            return this;
        }
        public SpatialAction OnPhysicsProcess(Action<float> action) {
        ...
        public SpatialAction OnInput(Action<InputEvent> action) {
        ...
        public SpatialAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public SpatialAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public SpatialAction RemoveOnProcessAction(Action<float> action) {
            _onProcessAction?.Remove(action);
            return this;
        }

        public SpatialAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcess?.Remove(action);
            return this;
        }

        public SpatialAction RemoveOnInput(Action<InputEvent> action) {
            _onInput?.Remove(action);
            return this;
        }

        public SpatialAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInput?.Remove(action);
            return this;
        }

        public SpatialAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public SpatialAction OnGameplayEntered(Action action) {
        ...
        public SpatialAction RemoveOnGameplayEntered() {
        ...
        public SpatialAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public SpatialAction RemoveOnScriptChanged() {
        ...
        public SpatialAction OnVisibilityChanged(Action action) {
        ...
        public SpatialAction RemoveOnVisibilityChanged() {
