...
namespace Betauer.GodotAction {
    public class ProceduralSkyAction : ProceduralSky {


        private Action? _onChangedAction; 
        public ProceduralSkyAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public ProceduralSkyAction RemoveOnChanged() {
        ...
        public ProceduralSkyAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public ProceduralSkyAction RemoveOnScriptChanged() {
