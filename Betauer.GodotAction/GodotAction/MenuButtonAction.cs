...
namespace Betauer.GodotAction {
    public class MenuButtonAction : MenuButton {
        ...
        public MenuButtonAction OnProcessAction(Action<float> action) {
            _onProcessAction ??= new List<Action<float>>(1);
            _onProcessAction.Add(action);
            SetProcess(true);
            return this;
        }
        public MenuButtonAction OnPhysicsProcess(Action<float> action) {
        ...
        public MenuButtonAction OnInput(Action<InputEvent> action) {
        ...
        public MenuButtonAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public MenuButtonAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public MenuButtonAction RemoveOnProcessAction(Action<float> action) {
            _onProcessAction?.Remove(action);
            return this;
        }

        public MenuButtonAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcess?.Remove(action);
            return this;
        }

        public MenuButtonAction RemoveOnInput(Action<InputEvent> action) {
            _onInput?.Remove(action);
            return this;
        }

        public MenuButtonAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInput?.Remove(action);
            return this;
        }

        public MenuButtonAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public MenuButtonAction OnDraw(Action action) {
            if (_onDrawAction == null) 
                Connect("draw", this, nameof(ExecuteDraw));
            _onDrawAction = action;
            return this;
        }
        public MenuButtonAction RemoveOnDraw() {
        ...
        public MenuButtonAction OnGuiInput(Action<InputEvent> action) {
            if (_onGuiInputAction == null) 
                Connect("gui_input", this, nameof(ExecuteGuiInput));
            _onGuiInputAction = action;
            return this;
        }
        public MenuButtonAction RemoveOnGuiInput() {
        ...
        public MenuButtonAction OnHide(Action action) {
            if (_onHideAction == null) 
                Connect("hide", this, nameof(ExecuteHide));
            _onHideAction = action;
            return this;
        }
        public MenuButtonAction RemoveOnHide() {
        ...
        public MenuButtonAction OnItemRectChanged(Action action) {
        ...
        public MenuButtonAction RemoveOnItemRectChanged() {
        ...
        public MenuButtonAction OnMinimumSizeChanged(Action action) {
        ...
        public MenuButtonAction RemoveOnMinimumSizeChanged() {
        ...
        public MenuButtonAction OnReady(Action action) {
            if (_onReadyAction == null) 
                Connect("ready", this, nameof(ExecuteReady));
            _onReadyAction = action;
            return this;
        }
        public MenuButtonAction RemoveOnReady() {
        ...
        public MenuButtonAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public MenuButtonAction RemoveOnScriptChanged() {
        ...
        public MenuButtonAction OnSizeFlagsChanged(Action action) {
        ...
        public MenuButtonAction RemoveOnSizeFlagsChanged() {
        ...
        public MenuButtonAction OnToggled(Action<bool> action) {
            if (_onToggledAction == null) 
                Connect("toggled", this, nameof(ExecuteToggled));
            _onToggledAction = action;
            return this;
        }
        public MenuButtonAction RemoveOnToggled() {
        ...
        public MenuButtonAction OnVisibilityChanged(Action action) {
        ...
        public MenuButtonAction RemoveOnVisibilityChanged() {
