...
namespace Betauer.GodotAction {
    public class GrooveJoint2DAction : Node {
        public GrooveJoint2DAction() {
            SetProcess(false);
        ...
        public GrooveJoint2DAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public GrooveJoint2DAction OnPhysicsProcess(Action<float> action) {
        ...
        public GrooveJoint2DAction OnInput(Action<InputEvent> action) {
        ...
        public GrooveJoint2DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public GrooveJoint2DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public GrooveJoint2DAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public GrooveJoint2DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public GrooveJoint2DAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public GrooveJoint2DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public GrooveJoint2DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
