...
namespace Betauer.GodotAction {
    public class GrooveJoint2DAction : GrooveJoint2D {
        ...
        public GrooveJoint2DAction OnDraw(Action action) {
        ...
        public GrooveJoint2DAction OnHide(Action action) {
        ...
        public GrooveJoint2DAction OnItemRectChanged(Action action) {
        ...
        public GrooveJoint2DAction OnReady(Action action) {
        ...
        public GrooveJoint2DAction OnRenamed(Action action) {
        ...
        public GrooveJoint2DAction OnScriptChanged(Action action) {
        ...
        public GrooveJoint2DAction OnTreeEntered(Action action) {
        ...
        public GrooveJoint2DAction OnTreeExited(Action action) {
        ...
        public GrooveJoint2DAction OnTreeExiting(Action action) {
        ...
        public GrooveJoint2DAction OnVisibilityChanged(Action action) {
