...
namespace Betauer.GodotAction {
    public class VisualShaderNodeVectorDistanceAction : VisualShaderNodeVectorDistance {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeVectorDistanceAction OnChanged(Action action) {
        ...
        public VisualShaderNodeVectorDistanceAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeVectorDistanceAction OnScriptChanged(Action action) {
