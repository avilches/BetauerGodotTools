...
namespace Betauer.GodotAction {
    public class OptionButtonAction : OptionButton {
        ...
        public OptionButtonAction OnItemFocused(Action<int> action) {
            if (_onItemFocusedAction == null || _onItemFocusedAction.Count == 0) {
                _onItemFocusedAction ??= new List<Action<int>>(); 
                Connect("item_focused", this, nameof(_GodotSignalItemFocused));
            }
            _onItemFocusedAction.Add(action);
            return this;
        }
        public OptionButtonAction RemoveOnItemFocused(Action<int> action) {
            if (_onItemFocusedAction == null || _onItemFocusedAction.Count == 0) return this;
            _onItemFocusedAction.Remove(action); 
            if (_onItemFocusedAction.Count == 0) {
                Disconnect("item_focused", this, nameof(_GodotSignalItemFocused));
            }
            return this;
        }
        private void _GodotSignalItemFocused(int index) {
            if (_onItemFocusedAction == null || _onItemFocusedAction.Count == 0) return;
            for (var i = 0; i < _onItemFocusedAction.Count; i++) _onItemFocusedAction[i].Invoke(index);
        }
        ...
        public OptionButtonAction OnItemSelected(Action<int> action) {
            if (_onItemSelectedAction == null || _onItemSelectedAction.Count == 0) {
                ...
                Connect("item_selected", this, nameof(_GodotSignalItemSelected));
            }
        ...
        public OptionButtonAction RemoveOnItemSelected(Action<int> action) {
            ...
            if (_onItemSelectedAction.Count == 0) {
                Disconnect("item_selected", this, nameof(_GodotSignalItemSelected));
            }
            return this;
        }
        private void _GodotSignalItemSelected(int index) {
