...
namespace Betauer.GodotAction {
    public class OptionButtonAction : OptionButton {
        ...
        public OptionButtonAction OnProcessAction(Action<float> action) {
            _onProcessAction ??= new List<Action<float>>(1);
            _onProcessAction.Add(action);
            SetProcess(true);
            return this;
        }
        public OptionButtonAction OnPhysicsProcess(Action<float> action) {
        ...
        public OptionButtonAction OnInput(Action<InputEvent> action) {
        ...
        public OptionButtonAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public OptionButtonAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public OptionButtonAction RemoveOnProcessAction(Action<float> action) {
            _onProcessAction?.Remove(action);
            return this;
        }

        public OptionButtonAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcess?.Remove(action);
            return this;
        }

        public OptionButtonAction RemoveOnInput(Action<InputEvent> action) {
            _onInput?.Remove(action);
            return this;
        }

        public OptionButtonAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInput?.Remove(action);
            return this;
        }

        public OptionButtonAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public OptionButtonAction OnDraw(Action action) {
            if (_onDrawAction == null) 
                Connect("draw", this, nameof(ExecuteDraw));
            _onDrawAction = action;
            return this;
        }
        public OptionButtonAction RemoveOnDraw() {
        ...
        public OptionButtonAction OnGuiInput(Action<InputEvent> action) {
            if (_onGuiInputAction == null) 
                Connect("gui_input", this, nameof(ExecuteGuiInput));
            _onGuiInputAction = action;
            return this;
        }
        public OptionButtonAction RemoveOnGuiInput() {
        ...
        public OptionButtonAction OnHide(Action action) {
            if (_onHideAction == null) 
                Connect("hide", this, nameof(ExecuteHide));
            _onHideAction = action;
            return this;
        }
        public OptionButtonAction RemoveOnHide() {
        ...
        private Action<int>? _onItemFocusedAction; 
        public OptionButtonAction OnItemFocused(Action<int> action) {
            if (_onItemFocusedAction == null) 
                Connect("item_focused", this, nameof(ExecuteItemFocused));
            _onItemFocusedAction = action;
            return this;
        }
        public OptionButtonAction RemoveOnItemFocused() {
            if (_onItemFocusedAction == null) return this; 
            Disconnect("item_focused", this, nameof(ExecuteItemFocused));
            _onItemFocusedAction = null;
            return this;
        }
        private void ExecuteItemFocused(int index) =>
            _onItemFocusedAction?.Invoke(index);
        

        private Action? _onItemRectChangedAction; 
        public OptionButtonAction OnItemRectChanged(Action action) {
        ...
        public OptionButtonAction RemoveOnItemRectChanged() {
        ...
        public OptionButtonAction OnMinimumSizeChanged(Action action) {
        ...
        public OptionButtonAction RemoveOnMinimumSizeChanged() {
        ...
        public OptionButtonAction OnPressed(Action action) {
            if (_onPressedAction == null) 
                Connect("pressed", this, nameof(ExecutePressed));
            _onPressedAction = action;
            return this;
        }
        public OptionButtonAction RemoveOnPressed() {
        ...
        public OptionButtonAction OnReady(Action action) {
            if (_onReadyAction == null) 
                Connect("ready", this, nameof(ExecuteReady));
            _onReadyAction = action;
            return this;
        }
        public OptionButtonAction RemoveOnReady() {
        ...
        public OptionButtonAction OnRenamed(Action action) {
            if (_onRenamedAction == null) 
                Connect("renamed", this, nameof(ExecuteRenamed));
            _onRenamedAction = action;
            return this;
        }
        public OptionButtonAction RemoveOnRenamed() {
        ...
        public OptionButtonAction OnResized(Action action) {
            if (_onResizedAction == null) 
                Connect("resized", this, nameof(ExecuteResized));
            _onResizedAction = action;
            return this;
        }
        public OptionButtonAction RemoveOnResized() {
        ...
        public OptionButtonAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public OptionButtonAction RemoveOnScriptChanged() {
        ...
        public OptionButtonAction OnSizeFlagsChanged(Action action) {
        ...
        public OptionButtonAction RemoveOnSizeFlagsChanged() {
        ...
        public OptionButtonAction OnToggled(Action<bool> action) {
            if (_onToggledAction == null) 
                Connect("toggled", this, nameof(ExecuteToggled));
            _onToggledAction = action;
            return this;
        }
        public OptionButtonAction RemoveOnToggled() {
        ...
        public OptionButtonAction OnVisibilityChanged(Action action) {
        ...
        public OptionButtonAction RemoveOnVisibilityChanged() {
