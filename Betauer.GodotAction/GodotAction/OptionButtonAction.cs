...
namespace Betauer.GodotAction {
    public class OptionButtonAction : Node {
        public OptionButtonAction() {
            SetProcess(false);
        ...
        public OptionButtonAction OnItemFocused(Action<int> action, bool oneShot = false, bool deferred = false) {
            if (_onItemFocusedAction == null || _onItemFocusedAction.Count == 0) {
                ...
                GetParent().Connect("item_focused", this, nameof(_GodotSignalItemFocused));
            }
        ...
        public OptionButtonAction RemoveOnItemFocused(Action<int> action) {
            ...
            if (_onItemFocusedAction.Count == 0) {
                GetParent().Disconnect("item_focused", this, nameof(_GodotSignalItemFocused));
            }
            return this;
        }
