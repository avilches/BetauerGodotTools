...
namespace Betauer.GodotAction {
    public class PhysicalBoneAction : Node {
        public PhysicalBoneAction() {
            SetProcess(false);
        ...
        public PhysicalBoneAction OnProcess(Action<float> action) {
        ...
        public PhysicalBoneAction RemoveOnProcess(Action<float> action) {
