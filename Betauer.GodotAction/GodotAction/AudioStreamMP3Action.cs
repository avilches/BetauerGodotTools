...
namespace Betauer.GodotAction {
    public class AudioStreamMP3Action : AudioStreamMP3 {


        private List<Action>? _onChangedAction; 
        public AudioStreamMP3Action OnChanged(Action action) {
        ...
        public AudioStreamMP3Action OnScriptChanged(Action action) {
