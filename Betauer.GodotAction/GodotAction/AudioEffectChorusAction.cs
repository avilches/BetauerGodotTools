...
namespace Betauer.GodotAction {
    public class AudioEffectChorusAction : AudioEffectChorus {


        private List<Action>? _onChangedAction; 
        public AudioEffectChorusAction OnChanged(Action action) {
        ...
        public AudioEffectChorusAction OnScriptChanged(Action action) {
