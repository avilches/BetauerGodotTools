...
namespace Betauer.GodotAction {
    public class KinematicBodyAction : ProxyNode {

        private List<Action>? _onGameplayEnteredAction; 
        public KinematicBodyAction OnGameplayEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private KinematicBodyAction _GodotSignalGameplayEntered() {
            ExecuteSignal(_onGameplayEnteredAction);
            return this;
        }

        private List<Action>? _onGameplayExitedAction; 
        public KinematicBodyAction OnGameplayExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private KinematicBodyAction _GodotSignalGameplayExited() {
            ExecuteSignal(_onGameplayExitedAction);
            return this;
        }

        private List<Action<InputEvent, Node, Vector3, Vector3, int>>? _onInputEventAction; 
        public KinematicBodyAction OnInputEvent(Action<InputEvent, Node, Vector3, Vector3, int> action, bool oneShot = false, bool deferred = false) {
        ...
        private KinematicBodyAction _GodotSignalInputEvent(InputEvent @event, Node camera, Vector3 normal, Vector3 position, int shape_idx) {
            ExecuteSignal(_onInputEventAction, @event, camera, normal, position, shape_idx);
            return this;
        }

        private List<Action>? _onMouseEnteredAction; 
        public KinematicBodyAction OnMouseEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private KinematicBodyAction _GodotSignalMouseEntered() {
            ExecuteSignal(_onMouseEnteredAction);
            return this;
        }

        private List<Action>? _onMouseExitedAction; 
        public KinematicBodyAction OnMouseExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private KinematicBodyAction _GodotSignalMouseExited() {
            ExecuteSignal(_onMouseExitedAction);
            return this;
        }

        private List<Action>? _onReadyAction; 
        public KinematicBodyAction OnReady(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private KinematicBodyAction _GodotSignalReady() {
            ExecuteSignal(_onReadyAction);
            return this;
        }

        private List<Action>? _onRenamedAction; 
        public KinematicBodyAction OnRenamed(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private KinematicBodyAction _GodotSignalRenamed() {
            ExecuteSignal(_onRenamedAction);
            return this;
        }

        private List<Action>? _onScriptChangedAction; 
        public KinematicBodyAction OnScriptChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private KinematicBodyAction _GodotSignalScriptChanged() {
            ExecuteSignal(_onScriptChangedAction);
            return this;
        }

        private List<Action>? _onTreeEnteredAction; 
        public KinematicBodyAction OnTreeEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private KinematicBodyAction _GodotSignalTreeEntered() {
            ExecuteSignal(_onTreeEnteredAction);
            return this;
        }

        private List<Action>? _onTreeExitedAction; 
        public KinematicBodyAction OnTreeExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private KinematicBodyAction _GodotSignalTreeExited() {
            ExecuteSignal(_onTreeExitedAction);
            return this;
        }

        private List<Action>? _onTreeExitingAction; 
        public KinematicBodyAction OnTreeExiting(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private KinematicBodyAction _GodotSignalTreeExiting() {
            ExecuteSignal(_onTreeExitingAction);
            return this;
        }

        private List<Action>? _onVisibilityChangedAction; 
        public KinematicBodyAction OnVisibilityChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private KinematicBodyAction _GodotSignalVisibilityChanged() {
