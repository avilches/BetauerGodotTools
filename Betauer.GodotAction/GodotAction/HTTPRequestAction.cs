...
namespace Betauer.GodotAction {
    public class HTTPRequestAction : HTTPRequest {
        ...
        public HTTPRequestAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public HTTPRequestAction OnPhysicsProcess(Action<float> action) {
        ...
        public HTTPRequestAction OnInput(Action<InputEvent> action) {
        ...
        public HTTPRequestAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public HTTPRequestAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public HTTPRequestAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public HTTPRequestAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public HTTPRequestAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public HTTPRequestAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public HTTPRequestAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public HTTPRequestAction OnReady(Action action) {
            if (_onReadyAction == null) 
                Connect("ready", this, nameof(ExecuteReady));
            _onReadyAction = action;
            return this;
        }
        public HTTPRequestAction RemoveOnReady() {
        ...
        private Action<byte[], string[], int, int>? _onRequestCompletedAction; 
        public HTTPRequestAction OnRequestCompleted(Action<byte[], string[], int, int> action) {
            if (_onRequestCompletedAction == null) 
                Connect("request_completed", this, nameof(ExecuteRequestCompleted));
            _onRequestCompletedAction = action;
            return this;
        }
        public HTTPRequestAction RemoveOnRequestCompleted() {
            if (_onRequestCompletedAction == null) return this; 
            Disconnect("request_completed", this, nameof(ExecuteRequestCompleted));
            _onRequestCompletedAction = null;
            return this;
        }
        private void ExecuteRequestCompleted(byte[] body, string[] headers, int response_code, int result) =>
            _onRequestCompletedAction?.Invoke(body, headers, response_code, result);
        

        private Action? _onScriptChangedAction; 
        public HTTPRequestAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public HTTPRequestAction RemoveOnScriptChanged() {
