...
namespace Betauer.GodotAction {
    public class HTTPRequestAction : ProxyNode {
        ...
        public void OnRequestCompleted(Action<byte[], string[], int, int> action, bool oneShot = false, bool deferred = false) =>
            AddSignal(ref _onRequestCompletedAction, "request_completed", nameof(_GodotSignalRequestCompleted), action, oneShot, deferred);

        public void RemoveOnRequestCompleted(Action<byte[], string[], int, int> action) =>
