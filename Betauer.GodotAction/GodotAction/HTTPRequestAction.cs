...
namespace Betauer.GodotAction {
    public class HTTPRequestAction : Node {
        ...
        public HTTPRequestAction OnRequestCompleted(Action<byte[], string[], int, int> action, bool oneShot = false, bool deferred = false) {
            if (_onRequestCompletedAction == null || _onRequestCompletedAction.Count == 0) {
                ...
                GetParent().Connect("request_completed", this, nameof(_GodotSignalRequestCompleted));
            }
        ...
        public HTTPRequestAction RemoveOnRequestCompleted(Action<byte[], string[], int, int> action) {
            ...
            if (_onRequestCompletedAction.Count == 0) {
                GetParent().Disconnect("request_completed", this, nameof(_GodotSignalRequestCompleted));
            }
            return this;
        }
