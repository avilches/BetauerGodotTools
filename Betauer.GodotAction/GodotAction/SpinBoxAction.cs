...
namespace Betauer.GodotAction {
    public class SpinBoxAction : Node {
        public SpinBoxAction() {
            SetProcess(false);
        ...
        public SpinBoxAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public SpinBoxAction OnPhysicsProcess(Action<float> action) {
        ...
        public SpinBoxAction OnInput(Action<InputEvent> action) {
        ...
        public SpinBoxAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public SpinBoxAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public SpinBoxAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public SpinBoxAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public SpinBoxAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public SpinBoxAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public SpinBoxAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
