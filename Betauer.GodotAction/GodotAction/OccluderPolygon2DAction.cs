...
namespace Betauer.GodotAction {
    public class OccluderPolygon2DAction : OccluderPolygon2D {


        private List<Action>? _onChangedAction; 
        public OccluderPolygon2DAction OnChanged(Action action) {
        ...
        public OccluderPolygon2DAction OnScriptChanged(Action action) {
