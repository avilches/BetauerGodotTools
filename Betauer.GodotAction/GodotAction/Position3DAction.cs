...
namespace Betauer.GodotAction {
    public class Position3DAction : Node {
        public Position3DAction() {
            SetProcess(false);
        ...
        public Position3DAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public Position3DAction OnPhysicsProcess(Action<float> action) {
        ...
        public Position3DAction OnInput(Action<InputEvent> action) {
        ...
        public Position3DAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public Position3DAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public Position3DAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public Position3DAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public Position3DAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public Position3DAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public Position3DAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
