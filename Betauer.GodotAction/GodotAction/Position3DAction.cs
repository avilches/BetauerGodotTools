...
namespace Betauer.GodotAction {
    public class Position3DAction : Position3D {
        ...
        public Position3DAction OnGameplayEntered(Action action) {
        ...
        public Position3DAction OnGameplayExited(Action action) {
        ...
        public Position3DAction OnReady(Action action) {
        ...
        public Position3DAction OnRenamed(Action action) {
        ...
        public Position3DAction OnScriptChanged(Action action) {
        ...
        public Position3DAction OnTreeEntered(Action action) {
        ...
        public Position3DAction OnTreeExited(Action action) {
        ...
        public Position3DAction OnTreeExiting(Action action) {
        ...
        public Position3DAction OnVisibilityChanged(Action action) {
