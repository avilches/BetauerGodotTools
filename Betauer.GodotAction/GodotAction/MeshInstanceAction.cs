...
namespace Betauer.GodotAction {
    public class MeshInstanceAction : Node {
        public MeshInstanceAction() {
            SetProcess(false);
        ...
        public MeshInstanceAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public MeshInstanceAction OnPhysicsProcess(Action<float> action) {
        ...
        public MeshInstanceAction OnInput(Action<InputEvent> action) {
        ...
        public MeshInstanceAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public MeshInstanceAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public MeshInstanceAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public MeshInstanceAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public MeshInstanceAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public MeshInstanceAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public MeshInstanceAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
