...
namespace Betauer.GodotAction {
    public class ViewportAction : ProxyNode {
        ...
        public void OnGuiFocusChanged(Action<Control> action, bool oneShot = false, bool deferred = false) =>
            AddSignal(ref _onGuiFocusChangedAction, "gui_focus_changed", nameof(_GodotSignalGuiFocusChanged), action, oneShot, deferred);

        public void RemoveOnGuiFocusChanged(Action<Control> action) =>
        ...
        public void OnSizeChanged(Action action, bool oneShot = false, bool deferred = false) =>
            AddSignal(ref _onSizeChangedAction, "size_changed", nameof(_GodotSignalSizeChanged), action, oneShot, deferred);

        public void RemoveOnSizeChanged(Action action) =>
