    ...
    public class TabsAction : Node {
        ...
        public TabsAction OnRepositionActiveTabRequest(Action<int> action, bool oneShot = false, bool deferred = false) {
            if (_onRepositionActiveTabRequestAction == null || _onRepositionActiveTabRequestAction.Count == 0) {
                ...
                GetParent().Connect("reposition_active_tab_request", this, nameof(_GodotSignalRepositionActiveTabRequest));
            }
        ...
        public TabsAction RemoveOnRepositionActiveTabRequest(Action<int> action) {
            ...
            if (_onRepositionActiveTabRequestAction.Count == 0) {
                GetParent().Disconnect("reposition_active_tab_request", this, nameof(_GodotSignalRepositionActiveTabRequest));
            }
            return this;
        }
        ...
        public TabsAction OnRightButtonPressed(Action<int> action, bool oneShot = false, bool deferred = false) {
            if (_onRightButtonPressedAction == null || _onRightButtonPressedAction.Count == 0) {
                ...
                GetParent().Connect("right_button_pressed", this, nameof(_GodotSignalRightButtonPressed));
            }
        ...
        public TabsAction RemoveOnRightButtonPressed(Action<int> action) {
            ...
            if (_onRightButtonPressedAction.Count == 0) {
                GetParent().Disconnect("right_button_pressed", this, nameof(_GodotSignalRightButtonPressed));
            }
            return this;
        }
        ...
        public TabsAction OnTabClicked(Action<int> action, bool oneShot = false, bool deferred = false) {
            if (_onTabClickedAction == null || _onTabClickedAction.Count == 0) {
                ...
                GetParent().Connect("tab_clicked", this, nameof(_GodotSignalTabClicked));
            }
        ...
        public TabsAction RemoveOnTabClicked(Action<int> action) {
            ...
            if (_onTabClickedAction.Count == 0) {
                GetParent().Disconnect("tab_clicked", this, nameof(_GodotSignalTabClicked));
            }
            return this;
        }
        ...
        public TabsAction OnTabClose(Action<int> action, bool oneShot = false, bool deferred = false) {
            if (_onTabCloseAction == null || _onTabCloseAction.Count == 0) {
                ...
                GetParent().Connect("tab_close", this, nameof(_GodotSignalTabClose));
            }
        ...
        public TabsAction RemoveOnTabClose(Action<int> action) {
            ...
            if (_onTabCloseAction.Count == 0) {
                GetParent().Disconnect("tab_close", this, nameof(_GodotSignalTabClose));
            }
            return this;
        }
        ...
        public TabsAction OnTabHover(Action<int> action, bool oneShot = false, bool deferred = false) {
            if (_onTabHoverAction == null || _onTabHoverAction.Count == 0) {
                ...
                GetParent().Connect("tab_hover", this, nameof(_GodotSignalTabHover));
            }
        ...
        public TabsAction RemoveOnTabHover(Action<int> action) {
            ...
            if (_onTabHoverAction.Count == 0) {
                GetParent().Disconnect("tab_hover", this, nameof(_GodotSignalTabHover));
            }
            return this;
        }
