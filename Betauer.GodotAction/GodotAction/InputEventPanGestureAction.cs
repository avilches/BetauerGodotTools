...
namespace Betauer.GodotAction {
    public class InputEventPanGestureAction : InputEventPanGesture {


        private List<Action>? _onChangedAction; 
        public InputEventPanGestureAction OnChanged(Action action) {
        ...
        public InputEventPanGestureAction OnScriptChanged(Action action) {
