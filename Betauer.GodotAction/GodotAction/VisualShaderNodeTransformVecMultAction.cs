...
namespace Betauer.GodotAction {
    public class VisualShaderNodeTransformVecMultAction : VisualShaderNodeTransformVecMult {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeTransformVecMultAction OnChanged(Action action) {
        ...
        public VisualShaderNodeTransformVecMultAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeTransformVecMultAction OnScriptChanged(Action action) {
