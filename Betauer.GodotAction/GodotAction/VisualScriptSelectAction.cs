...
namespace Betauer.GodotAction {
    public class VisualScriptSelectAction : VisualScriptSelect {


        private List<Action>? _onChangedAction; 
        public VisualScriptSelectAction OnChanged(Action action) {
        ...
        public VisualScriptSelectAction OnPortsChanged(Action action) {
        ...
        public VisualScriptSelectAction OnScriptChanged(Action action) {
