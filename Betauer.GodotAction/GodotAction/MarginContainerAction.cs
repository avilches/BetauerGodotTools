...
namespace Betauer.GodotAction {
    public class MarginContainerAction : Node {
        public MarginContainerAction() {
            SetProcess(false);
        ...
        public MarginContainerAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public MarginContainerAction OnPhysicsProcess(Action<float> action) {
        ...
        public MarginContainerAction OnInput(Action<InputEvent> action) {
        ...
        public MarginContainerAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public MarginContainerAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public MarginContainerAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public MarginContainerAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public MarginContainerAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public MarginContainerAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public MarginContainerAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
