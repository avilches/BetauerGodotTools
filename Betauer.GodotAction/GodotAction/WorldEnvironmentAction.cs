...
namespace Betauer.GodotAction {
    public class WorldEnvironmentAction : Node {
        public WorldEnvironmentAction() {
            SetProcess(false);
        ...
        public WorldEnvironmentAction OnProcess(Action<float> action) {
            _onProcessActions ??= new List<Action<float>>(1);
            _onProcessActions.Add(action);
            SetProcess(true);
            return this;
        }
        public WorldEnvironmentAction OnPhysicsProcess(Action<float> action) {
        ...
        public WorldEnvironmentAction OnInput(Action<InputEvent> action) {
        ...
        public WorldEnvironmentAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public WorldEnvironmentAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public WorldEnvironmentAction RemoveOnProcess(Action<float> action) {
            _onProcessActions?.Remove(action);
            return this;
        }

        public WorldEnvironmentAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcessActions?.Remove(action);
            return this;
        }

        public WorldEnvironmentAction RemoveOnInput(Action<InputEvent> action) {
            _onInputActions?.Remove(action);
            return this;
        }

        public WorldEnvironmentAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInputActions?.Remove(action);
            return this;
        }

        public WorldEnvironmentAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
