...
namespace Betauer.GodotAction {
    public class WorldEnvironmentAction : WorldEnvironment {
        ...
        public WorldEnvironmentAction OnReady(Action action) {
        ...
        public WorldEnvironmentAction OnRenamed(Action action) {
        ...
        public WorldEnvironmentAction OnScriptChanged(Action action) {
        ...
        public WorldEnvironmentAction OnTreeEntered(Action action) {
        ...
        public WorldEnvironmentAction OnTreeExited(Action action) {
        ...
        public WorldEnvironmentAction OnTreeExiting(Action action) {
