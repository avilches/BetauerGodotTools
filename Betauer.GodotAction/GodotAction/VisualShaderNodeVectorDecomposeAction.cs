...
namespace Betauer.GodotAction {
    public class VisualShaderNodeVectorDecomposeAction : VisualShaderNodeVectorDecompose {


        private List<Action>? _onChangedAction; 
        public VisualShaderNodeVectorDecomposeAction OnChanged(Action action) {
        ...
        public VisualShaderNodeVectorDecomposeAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeVectorDecomposeAction OnScriptChanged(Action action) {
