...
namespace Betauer.GodotAction {
    public class VisualScriptIndexGetAction : VisualScriptIndexGet {


        private Action? _onChangedAction; 
        public VisualScriptIndexGetAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public VisualScriptIndexGetAction RemoveOnChanged() {
        ...
        public VisualScriptIndexGetAction OnPortsChanged(Action action) {
            if (_onPortsChangedAction == null) 
                Connect("ports_changed", this, nameof(ExecutePortsChanged));
            _onPortsChangedAction = action;
            return this;
        }
        public VisualScriptIndexGetAction RemoveOnPortsChanged() {
        ...
        public VisualScriptIndexGetAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public VisualScriptIndexGetAction RemoveOnScriptChanged() {
