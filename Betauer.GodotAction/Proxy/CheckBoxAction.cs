...
namespace Betauer.GodotAction.Proxy {
    public class CheckBoxAction : ProxyNode {

        private List<Action>? _onButtonDownAction; 
        public CheckBoxAction OnButtonDown(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private CheckBoxAction _GodotSignalButtonDown() {
            ExecuteSignal(_onButtonDownAction);
            return this;
        }

        private List<Action>? _onButtonUpAction; 
        public CheckBoxAction OnButtonUp(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private CheckBoxAction _GodotSignalDraw() {
            ExecuteSignal(_onDrawAction);
            return this;
        }

        private List<Action>? _onFocusEnteredAction; 
        public CheckBoxAction OnFocusEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private CheckBoxAction _GodotSignalFocusEntered() {
            ExecuteSignal(_onFocusEnteredAction);
            return this;
        }

        private List<Action>? _onFocusExitedAction; 
        public CheckBoxAction OnFocusExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private CheckBoxAction _GodotSignalFocusExited() {
            ExecuteSignal(_onFocusExitedAction);
            return this;
        }

        private List<Action<InputEvent>>? _onGuiInputAction; 
        public CheckBoxAction OnGuiInput(Action<InputEvent> action, bool oneShot = false, bool deferred = false) {
        ...
        private CheckBoxAction _GodotSignalGuiInput(InputEvent @event) {
            ExecuteSignal(_onGuiInputAction, @event);
            return this;
        }

        private List<Action>? _onHideAction; 
        public CheckBoxAction OnHide(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private CheckBoxAction _GodotSignalHide() {
            ExecuteSignal(_onHideAction);
            return this;
        }

        private List<Action>? _onItemRectChangedAction; 
        public CheckBoxAction OnItemRectChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private CheckBoxAction _GodotSignalItemRectChanged() {
            ExecuteSignal(_onItemRectChangedAction);
            return this;
        }

        private List<Action>? _onMinimumSizeChangedAction; 
        public CheckBoxAction OnMinimumSizeChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private CheckBoxAction _GodotSignalMinimumSizeChanged() {
            ExecuteSignal(_onMinimumSizeChangedAction);
            return this;
        }

        private List<Action>? _onModalClosedAction; 
        public CheckBoxAction OnModalClosed(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private CheckBoxAction _GodotSignalModalClosed() {
            ExecuteSignal(_onModalClosedAction);
            return this;
        }

        private List<Action>? _onMouseEnteredAction; 
        public CheckBoxAction OnMouseEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private CheckBoxAction _GodotSignalMouseEntered() {
            ExecuteSignal(_onMouseEnteredAction);
            return this;
        }

        private List<Action>? _onMouseExitedAction; 
        public CheckBoxAction OnMouseExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private CheckBoxAction _GodotSignalMouseExited() {
            ExecuteSignal(_onMouseExitedAction);
            return this;
        }

        private List<Action>? _onPressedAction; 
        public CheckBoxAction OnPressed(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private CheckBoxAction _GodotSignalPressed() {
            ExecuteSignal(_onPressedAction);
            return this;
        }

        private List<Action>? _onReadyAction; 
        public CheckBoxAction OnReady(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private CheckBoxAction _GodotSignalReady() {
            ExecuteSignal(_onReadyAction);
            return this;
        }

        private List<Action>? _onRenamedAction; 
        public CheckBoxAction OnRenamed(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private CheckBoxAction _GodotSignalRenamed() {
            ExecuteSignal(_onRenamedAction);
            return this;
        }

        private List<Action>? _onResizedAction; 
        public CheckBoxAction OnResized(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private CheckBoxAction _GodotSignalResized() {
            ExecuteSignal(_onResizedAction);
            return this;
        }

        private List<Action>? _onScriptChangedAction; 
        public CheckBoxAction OnScriptChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private CheckBoxAction _GodotSignalScriptChanged() {
            ExecuteSignal(_onScriptChangedAction);
            return this;
        }

        private List<Action>? _onSizeFlagsChangedAction; 
        public CheckBoxAction OnSizeFlagsChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private CheckBoxAction _GodotSignalSizeFlagsChanged() {
            ExecuteSignal(_onSizeFlagsChangedAction);
            return this;
        }

        private List<Action<bool>>? _onToggledAction; 
        public CheckBoxAction OnToggled(Action<bool> action, bool oneShot = false, bool deferred = false) {
        ...
        private CheckBoxAction _GodotSignalToggled(bool button_pressed) {
            ExecuteSignal(_onToggledAction, button_pressed);
            return this;
        }

        private List<Action>? _onTreeEnteredAction; 
        public CheckBoxAction OnTreeEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private CheckBoxAction _GodotSignalTreeEntered() {
            ExecuteSignal(_onTreeEnteredAction);
            return this;
        }

        private List<Action>? _onTreeExitedAction; 
        public CheckBoxAction OnTreeExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private CheckBoxAction _GodotSignalTreeExited() {
            ExecuteSignal(_onTreeExitedAction);
            return this;
        }

        private List<Action>? _onTreeExitingAction; 
        public CheckBoxAction OnTreeExiting(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private CheckBoxAction _GodotSignalTreeExiting() {
            ExecuteSignal(_onTreeExitingAction);
            return this;
        }

        private List<Action>? _onVisibilityChangedAction; 
        public CheckBoxAction OnVisibilityChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private CheckBoxAction _GodotSignalVisibilityChanged() {
