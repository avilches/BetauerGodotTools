...
namespace Betauer.GodotAction.Proxy {
    public class CanvasLayerAction : ProxyNode {
        ...
        public CanvasLayerAction OnVisibilityChanged(Action action, bool oneShot = false, bool deferred = false) {
            AddSignal(ref _onVisibilityChangedAction, "visibility_changed", nameof(_GodotSignalVisibilityChanged), action, oneShot, deferred);
            return this;
        }

        public CanvasLayerAction RemoveOnVisibilityChanged(Action action) {
            RemoveSignal(_onVisibilityChangedAction, "visibility_changed", nameof(_GodotSignalVisibilityChanged), action);
            return this;
        }

        private CanvasLayerAction _GodotSignalVisibilityChanged() {
