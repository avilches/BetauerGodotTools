...
namespace Betauer.GodotAction.Proxy {
    public class VisualScriptSubCallAction : ProxyNode {
        ...
        private VisualScriptSubCallAction _GodotSignalChanged() {
        ...
        private VisualScriptSubCallAction _GodotSignalPortsChanged() {
        ...
        private VisualScriptSubCallAction _GodotSignalScriptChanged() {
