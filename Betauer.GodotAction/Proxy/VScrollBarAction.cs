...
namespace Betauer.GodotAction.Proxy {
    public class VScrollBarAction : ProxyNode {

        private List<Action>? _onChangedAction; 
        public VScrollBarAction OnChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private VScrollBarAction _GodotSignalChanged() {
            ExecuteSignal(_onChangedAction);
            return this;
        }

        private List<Action>? _onDrawAction; 
        public VScrollBarAction OnDraw(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private VScrollBarAction _GodotSignalDraw() {
            ExecuteSignal(_onDrawAction);
            return this;
        }

        private List<Action>? _onFocusEnteredAction; 
        public VScrollBarAction OnFocusEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private VScrollBarAction _GodotSignalFocusEntered() {
            ExecuteSignal(_onFocusEnteredAction);
            return this;
        }

        private List<Action>? _onFocusExitedAction; 
        public VScrollBarAction OnFocusExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private VScrollBarAction _GodotSignalFocusExited() {
            ExecuteSignal(_onFocusExitedAction);
            return this;
        }

        private List<Action<InputEvent>>? _onGuiInputAction; 
        public VScrollBarAction OnGuiInput(Action<InputEvent> action, bool oneShot = false, bool deferred = false) {
        ...
        private VScrollBarAction _GodotSignalGuiInput(InputEvent @event) {
            ExecuteSignal(_onGuiInputAction, @event);
            return this;
        }

        private List<Action>? _onHideAction; 
        public VScrollBarAction OnHide(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private VScrollBarAction _GodotSignalHide() {
            ExecuteSignal(_onHideAction);
            return this;
        }

        private List<Action>? _onItemRectChangedAction; 
        public VScrollBarAction OnItemRectChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private VScrollBarAction _GodotSignalItemRectChanged() {
            ExecuteSignal(_onItemRectChangedAction);
            return this;
        }

        private List<Action>? _onMinimumSizeChangedAction; 
        public VScrollBarAction OnMinimumSizeChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private VScrollBarAction _GodotSignalMinimumSizeChanged() {
            ExecuteSignal(_onMinimumSizeChangedAction);
            return this;
        }

        private List<Action>? _onModalClosedAction; 
        public VScrollBarAction OnModalClosed(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private VScrollBarAction _GodotSignalModalClosed() {
            ExecuteSignal(_onModalClosedAction);
            return this;
        }

        private List<Action>? _onMouseEnteredAction; 
        public VScrollBarAction OnMouseEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private VScrollBarAction _GodotSignalMouseEntered() {
            ExecuteSignal(_onMouseEnteredAction);
            return this;
        }

        private List<Action>? _onMouseExitedAction; 
        public VScrollBarAction OnMouseExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private VScrollBarAction _GodotSignalMouseExited() {
            ExecuteSignal(_onMouseExitedAction);
            return this;
        }

        private List<Action>? _onReadyAction; 
        public VScrollBarAction OnReady(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private VScrollBarAction _GodotSignalReady() {
            ExecuteSignal(_onReadyAction);
            return this;
        }

        private List<Action>? _onRenamedAction; 
        public VScrollBarAction OnRenamed(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private VScrollBarAction _GodotSignalRenamed() {
            ExecuteSignal(_onRenamedAction);
            return this;
        }

        private List<Action>? _onResizedAction; 
        public VScrollBarAction OnResized(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private VScrollBarAction _GodotSignalResized() {
            ExecuteSignal(_onResizedAction);
            return this;
        }

        private List<Action>? _onScriptChangedAction; 
        public VScrollBarAction OnScriptChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private VScrollBarAction _GodotSignalScriptChanged() {
            ExecuteSignal(_onScriptChangedAction);
            return this;
        }

        private List<Action>? _onScrollingAction; 
        public VScrollBarAction OnScrolling(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private VScrollBarAction _GodotSignalScrolling() {
            ExecuteSignal(_onScrollingAction);
            return this;
        }

        private List<Action>? _onSizeFlagsChangedAction; 
        public VScrollBarAction OnSizeFlagsChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private VScrollBarAction _GodotSignalSizeFlagsChanged() {
            ExecuteSignal(_onSizeFlagsChangedAction);
            return this;
        }

        private List<Action>? _onTreeEnteredAction; 
        public VScrollBarAction OnTreeEntered(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private VScrollBarAction _GodotSignalTreeEntered() {
            ExecuteSignal(_onTreeEnteredAction);
            return this;
        }

        private List<Action>? _onTreeExitedAction; 
        public VScrollBarAction OnTreeExited(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private VScrollBarAction _GodotSignalTreeExited() {
            ExecuteSignal(_onTreeExitedAction);
            return this;
        }

        private List<Action>? _onTreeExitingAction; 
        public VScrollBarAction OnTreeExiting(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private VScrollBarAction _GodotSignalTreeExiting() {
            ExecuteSignal(_onTreeExitingAction);
            return this;
        }

        private List<Action<float>>? _onValueChangedAction; 
        public VScrollBarAction OnValueChanged(Action<float> action, bool oneShot = false, bool deferred = false) {
        ...
        private VScrollBarAction _GodotSignalValueChanged(float value) {
            ExecuteSignal(_onValueChangedAction, value);
            return this;
        }

        private List<Action>? _onVisibilityChangedAction; 
        public VScrollBarAction OnVisibilityChanged(Action action, bool oneShot = false, bool deferred = false) {
        ...
        private VScrollBarAction _GodotSignalVisibilityChanged() {
