...
namespace Betauer.GodotAction {
    public class TabContainerAction : TabContainer {
        ...
        public TabContainerAction OnProcessAction(Action<float> action) {
        ...
        public TabContainerAction RemoveOnProcessAction(Action<float> action) {
        ...
        public TabContainerAction OnDraw(Action action) {
            if (_onDrawAction == null) 
                Connect("draw", this, nameof(ExecuteDraw));
            _onDrawAction = action;
            return this;
        }
        public TabContainerAction RemoveOnDraw() {
        ...
        public TabContainerAction OnGuiInput(Action<InputEvent> action) {
            if (_onGuiInputAction == null) 
                Connect("gui_input", this, nameof(ExecuteGuiInput));
            _onGuiInputAction = action;
            return this;
        }
        public TabContainerAction RemoveOnGuiInput() {
        ...
        public TabContainerAction OnHide(Action action) {
            if (_onHideAction == null) 
                Connect("hide", this, nameof(ExecuteHide));
            _onHideAction = action;
            return this;
        }
        public TabContainerAction RemoveOnHide() {
        ...
        public TabContainerAction OnItemRectChanged(Action action) {
        ...
        public TabContainerAction RemoveOnItemRectChanged() {
        ...
        public TabContainerAction OnMinimumSizeChanged(Action action) {
        ...
        public TabContainerAction RemoveOnMinimumSizeChanged() {
        ...
        private Action? _onPrePopupPressedAction; 
        public TabContainerAction OnPrePopupPressed(Action action) {
            if (_onPrePopupPressedAction == null) 
                Connect("pre_popup_pressed", this, nameof(ExecutePrePopupPressed));
            _onPrePopupPressedAction = action;
            return this;
        }
        public TabContainerAction RemoveOnPrePopupPressed() {
            if (_onPrePopupPressedAction == null) return this; 
            Disconnect("pre_popup_pressed", this, nameof(ExecutePrePopupPressed));
            _onPrePopupPressedAction = null;
            return this;
        }
        private void ExecutePrePopupPressed() =>
            _onPrePopupPressedAction?.Invoke();
        

        private Action? _onReadyAction; 
        public TabContainerAction OnReady(Action action) {
            if (_onReadyAction == null) 
                Connect("ready", this, nameof(ExecuteReady));
            _onReadyAction = action;
            return this;
        }
        public TabContainerAction RemoveOnReady() {
        ...
        public TabContainerAction OnRenamed(Action action) {
            if (_onRenamedAction == null) 
                Connect("renamed", this, nameof(ExecuteRenamed));
            _onRenamedAction = action;
            return this;
        }
        public TabContainerAction RemoveOnRenamed() {
        ...
        public TabContainerAction OnResized(Action action) {
            if (_onResizedAction == null) 
                Connect("resized", this, nameof(ExecuteResized));
            _onResizedAction = action;
            return this;
        }
        public TabContainerAction RemoveOnResized() {
        ...
        public TabContainerAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public TabContainerAction RemoveOnScriptChanged() {
        ...
        public TabContainerAction OnSizeFlagsChanged(Action action) {
        ...
        public TabContainerAction RemoveOnSizeFlagsChanged() {
        ...
        private Action<int>? _onTabSelectedAction; 
        public TabContainerAction OnTabSelected(Action<int> action) {
            if (_onTabSelectedAction == null) 
                Connect("tab_selected", this, nameof(ExecuteTabSelected));
            _onTabSelectedAction = action;
            return this;
        }
        public TabContainerAction RemoveOnTabSelected() {
            if (_onTabSelectedAction == null) return this; 
            Disconnect("tab_selected", this, nameof(ExecuteTabSelected));
            _onTabSelectedAction = null;
            return this;
        }
        private void ExecuteTabSelected(int tab) =>
            _onTabSelectedAction?.Invoke(tab);
        

        private Action? _onTreeEnteredAction; 
        public TabContainerAction OnTreeEntered(Action action) {
            if (_onTreeEnteredAction == null) 
                Connect("tree_entered", this, nameof(ExecuteTreeEntered));
            _onTreeEnteredAction = action;
            return this;
        }
        public TabContainerAction RemoveOnTreeEntered() {
        ...
        public TabContainerAction OnVisibilityChanged(Action action) {
        ...
        public TabContainerAction RemoveOnVisibilityChanged() {
