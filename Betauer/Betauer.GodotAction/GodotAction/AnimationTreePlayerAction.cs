...
namespace Betauer.GodotAction {
    public class AnimationTreePlayerAction : AnimationTreePlayer {
        ...
        public AnimationTreePlayerAction OnProcessAction(Action<float> action) {
            _onProcessAction ??= new List<Action<float>>(1);
            _onProcessAction.Add(action);
            SetProcess(true);
            return this;
        }
        public AnimationTreePlayerAction OnPhysicsProcess(Action<float> action) {
        ...
        public AnimationTreePlayerAction OnInput(Action<InputEvent> action) {
        ...
        public AnimationTreePlayerAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public AnimationTreePlayerAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public AnimationTreePlayerAction RemoveOnProcessAction(Action<float> action) {
            _onProcessAction?.Remove(action);
            return this;
        }

        public AnimationTreePlayerAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcess?.Remove(action);
            return this;
        }

        public AnimationTreePlayerAction RemoveOnInput(Action<InputEvent> action) {
            _onInput?.Remove(action);
            return this;
        }

        public AnimationTreePlayerAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInput?.Remove(action);
            return this;
        }

        public AnimationTreePlayerAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public AnimationTreePlayerAction OnReady(Action action) {
            if (_onReadyAction == null) 
                Connect("ready", this, nameof(ExecuteReady));
            _onReadyAction = action;
            return this;
        }
        public AnimationTreePlayerAction RemoveOnReady() {
        ...
        public AnimationTreePlayerAction OnRenamed(Action action) {
            if (_onRenamedAction == null) 
                Connect("renamed", this, nameof(ExecuteRenamed));
            _onRenamedAction = action;
            return this;
        }
        public AnimationTreePlayerAction RemoveOnRenamed() {
        ...
        public AnimationTreePlayerAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public AnimationTreePlayerAction RemoveOnScriptChanged() {
        ...
        public AnimationTreePlayerAction OnTreeEntered(Action action) {
            if (_onTreeEnteredAction == null) 
                Connect("tree_entered", this, nameof(ExecuteTreeEntered));
            _onTreeEnteredAction = action;
            return this;
        }
        public AnimationTreePlayerAction RemoveOnTreeEntered() {
        ...
        public AnimationTreePlayerAction OnTreeExited(Action action) {
            if (_onTreeExitedAction == null) 
                Connect("tree_exited", this, nameof(ExecuteTreeExited));
            _onTreeExitedAction = action;
            return this;
        }
        public AnimationTreePlayerAction RemoveOnTreeExited() {
        ...
        public AnimationTreePlayerAction OnTreeExiting(Action action) {
            if (_onTreeExitingAction == null) 
                Connect("tree_exiting", this, nameof(ExecuteTreeExiting));
            _onTreeExitingAction = action;
            return this;
        }
        public AnimationTreePlayerAction RemoveOnTreeExiting() {
