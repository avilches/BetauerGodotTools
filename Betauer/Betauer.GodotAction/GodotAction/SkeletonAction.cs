...
namespace Betauer.GodotAction {
    public class SkeletonAction : Skeleton {
        ...
        public SkeletonAction OnProcessAction(Action<float> action) {
            _onProcessAction ??= new List<Action<float>>(1);
            _onProcessAction.Add(action);
            SetProcess(true);
            return this;
        }
        public SkeletonAction OnPhysicsProcess(Action<float> action) {
        ...
        public SkeletonAction OnInput(Action<InputEvent> action) {
        ...
        public SkeletonAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public SkeletonAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public SkeletonAction RemoveOnProcessAction(Action<float> action) {
            _onProcessAction?.Remove(action);
            return this;
        }

        public SkeletonAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcess?.Remove(action);
            return this;
        }

        public SkeletonAction RemoveOnInput(Action<InputEvent> action) {
            _onInput?.Remove(action);
            return this;
        }

        public SkeletonAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInput?.Remove(action);
            return this;
        }

        public SkeletonAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public SkeletonAction OnGameplayEntered(Action action) {
        ...
        public SkeletonAction RemoveOnGameplayEntered() {
        ...
        public SkeletonAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public SkeletonAction RemoveOnScriptChanged() {
        ...
        private Action? _onSkeletonUpdatedAction; 
        public SkeletonAction OnSkeletonUpdated(Action action) {
            if (_onSkeletonUpdatedAction == null) 
                Connect("skeleton_updated", this, nameof(ExecuteSkeletonUpdated));
            _onSkeletonUpdatedAction = action;
            return this;
        }
        public SkeletonAction RemoveOnSkeletonUpdated() {
            if (_onSkeletonUpdatedAction == null) return this; 
            Disconnect("skeleton_updated", this, nameof(ExecuteSkeletonUpdated));
            _onSkeletonUpdatedAction = null;
            return this;
        }
        private void ExecuteSkeletonUpdated() =>
            _onSkeletonUpdatedAction?.Invoke();
        

        private Action? _onTreeEnteredAction; 
        public SkeletonAction OnTreeEntered(Action action) {
            if (_onTreeEnteredAction == null) 
                Connect("tree_entered", this, nameof(ExecuteTreeEntered));
            _onTreeEnteredAction = action;
            return this;
        }
        public SkeletonAction RemoveOnTreeEntered() {
        ...
        public SkeletonAction OnVisibilityChanged(Action action) {
        ...
        public SkeletonAction RemoveOnVisibilityChanged() {
