...
namespace Betauer.GodotAction {
    public class CSGCombinerAction : CSGCombiner {
        ...
        public CSGCombinerAction OnProcessAction(Action<float> action) {
            _onProcessAction ??= new List<Action<float>>(1);
            _onProcessAction.Add(action);
            SetProcess(true);
            return this;
        }
        public CSGCombinerAction OnPhysicsProcess(Action<float> action) {
        ...
        public CSGCombinerAction OnInput(Action<InputEvent> action) {
        ...
        public CSGCombinerAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public CSGCombinerAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public CSGCombinerAction RemoveOnProcessAction(Action<float> action) {
            _onProcessAction?.Remove(action);
            return this;
        }

        public CSGCombinerAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcess?.Remove(action);
            return this;
        }

        public CSGCombinerAction RemoveOnInput(Action<InputEvent> action) {
            _onInput?.Remove(action);
            return this;
        }

        public CSGCombinerAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInput?.Remove(action);
            return this;
        }

        public CSGCombinerAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public CSGCombinerAction OnGameplayEntered(Action action) {
        ...
        public CSGCombinerAction RemoveOnGameplayEntered() {
        ...
        public CSGCombinerAction OnReady(Action action) {
            if (_onReadyAction == null) 
                Connect("ready", this, nameof(ExecuteReady));
            _onReadyAction = action;
            return this;
        }
        public CSGCombinerAction RemoveOnReady() {
        ...
        public CSGCombinerAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public CSGCombinerAction RemoveOnScriptChanged() {
        ...
        public CSGCombinerAction OnVisibilityChanged(Action action) {
        ...
        public CSGCombinerAction RemoveOnVisibilityChanged() {
