...
namespace Betauer.GodotAction {
    public class GLTFBufferViewAction : GLTFBufferView {


        private Action? _onChangedAction; 
        public GLTFBufferViewAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public GLTFBufferViewAction RemoveOnChanged() {
        ...
        public GLTFBufferViewAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public GLTFBufferViewAction RemoveOnScriptChanged() {
