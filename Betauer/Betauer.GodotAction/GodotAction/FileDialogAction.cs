...
namespace Betauer.GodotAction {
    public class FileDialogAction : FileDialog {
        ...
        public FileDialogAction OnProcessAction(Action<float> action) {
        ...
        public FileDialogAction RemoveOnProcessAction(Action<float> action) {
        ...
        public FileDialogAction RemoveOnAboutToShow() {
        ...
        public FileDialogAction RemoveOnConfirmed() {
        ...
        public FileDialogAction RemoveOnCustomAction() {
        ...
        private Action<string>? _onDirSelectedAction; 
        public FileDialogAction OnDirSelected(Action<string> action) {
            if (_onDirSelectedAction == null) 
                Connect("dir_selected", this, nameof(ExecuteDirSelected));
            _onDirSelectedAction = action;
            return this;
        }
        public FileDialogAction RemoveOnDirSelected() {
            if (_onDirSelectedAction == null) return this; 
            Disconnect("dir_selected", this, nameof(ExecuteDirSelected));
            _onDirSelectedAction = null;
            return this;
        }
        private void ExecuteDirSelected(string dir) =>
            _onDirSelectedAction?.Invoke(dir);
        ...
        public FileDialogAction RemoveOnDraw() {
        ...
        private Action<string>? _onFileSelectedAction; 
        public FileDialogAction OnFileSelected(Action<string> action) {
            if (_onFileSelectedAction == null) 
                Connect("file_selected", this, nameof(ExecuteFileSelected));
            _onFileSelectedAction = action;
            return this;
        }
        public FileDialogAction RemoveOnFileSelected() {
            if (_onFileSelectedAction == null) return this; 
            Disconnect("file_selected", this, nameof(ExecuteFileSelected));
            _onFileSelectedAction = null;
            return this;
        }
        private void ExecuteFileSelected(string path) =>
            _onFileSelectedAction?.Invoke(path);
        

        private Action<string[]>? _onFilesSelectedAction; 
        public FileDialogAction OnFilesSelected(Action<string[]> action) {
            if (_onFilesSelectedAction == null) 
                Connect("files_selected", this, nameof(ExecuteFilesSelected));
            _onFilesSelectedAction = action;
            return this;
        }
        public FileDialogAction RemoveOnFilesSelected() {
            if (_onFilesSelectedAction == null) return this; 
            Disconnect("files_selected", this, nameof(ExecuteFilesSelected));
            _onFilesSelectedAction = null;
            return this;
        }
        private void ExecuteFilesSelected(string[] paths) =>
            _onFilesSelectedAction?.Invoke(paths);
        ...
        public FileDialogAction RemoveOnFocusEntered() {
        ...
        public FileDialogAction RemoveOnFocusExited() {
        ...
        public FileDialogAction RemoveOnGuiInput() {
        ...
        public FileDialogAction RemoveOnHide() {
        ...
        public FileDialogAction RemoveOnItemRectChanged() {
        ...
        public FileDialogAction RemoveOnMinimumSizeChanged() {
        ...
        public FileDialogAction RemoveOnModalClosed() {
        ...
        public FileDialogAction RemoveOnMouseEntered() {
        ...
        public FileDialogAction RemoveOnMouseExited() {
        ...
        public FileDialogAction RemoveOnPopupHide() {
        ...
        public FileDialogAction RemoveOnReady() {
        ...
        public FileDialogAction RemoveOnRenamed() {
        ...
        public FileDialogAction RemoveOnResized() {
        ...
        public FileDialogAction RemoveOnScriptChanged() {
        ...
        public FileDialogAction RemoveOnSizeFlagsChanged() {
        ...
        public FileDialogAction RemoveOnTreeEntered() {
        ...
        public FileDialogAction RemoveOnTreeExited() {
        ...
        public FileDialogAction RemoveOnTreeExiting() {
        ...
        public FileDialogAction RemoveOnVisibilityChanged() {
