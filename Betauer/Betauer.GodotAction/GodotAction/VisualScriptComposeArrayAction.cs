...
namespace Betauer.GodotAction {
    public class VisualScriptComposeArrayAction : VisualScriptComposeArray {


        private Action? _onChangedAction; 
        public VisualScriptComposeArrayAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public VisualScriptComposeArrayAction RemoveOnChanged() {
        ...
        public VisualScriptComposeArrayAction OnPortsChanged(Action action) {
            if (_onPortsChangedAction == null) 
                Connect("ports_changed", this, nameof(ExecutePortsChanged));
            _onPortsChangedAction = action;
            return this;
        }
        public VisualScriptComposeArrayAction RemoveOnPortsChanged() {
        ...
        public VisualScriptComposeArrayAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public VisualScriptComposeArrayAction RemoveOnScriptChanged() {
