...
namespace Betauer.GodotAction {
    public class CSGMeshAction : CSGMesh {
        ...
        public CSGMeshAction OnProcessAction(Action<float> action) {
            _onProcessAction ??= new List<Action<float>>(1);
            _onProcessAction.Add(action);
            SetProcess(true);
            return this;
        }
        public CSGMeshAction OnPhysicsProcess(Action<float> action) {
        ...
        public CSGMeshAction OnInput(Action<InputEvent> action) {
        ...
        public CSGMeshAction OnUnhandledInput(Action<InputEvent> action) {
        ...
        public CSGMeshAction OnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public CSGMeshAction RemoveOnProcessAction(Action<float> action) {
            _onProcessAction?.Remove(action);
            return this;
        }

        public CSGMeshAction RemoveOnPhysicsProcess(Action<float> action) {
            _onPhysicsProcess?.Remove(action);
            return this;
        }

        public CSGMeshAction RemoveOnInput(Action<InputEvent> action) {
            _onInput?.Remove(action);
            return this;
        }

        public CSGMeshAction RemoveOnUnhandledInput(Action<InputEvent> action) {
            _onUnhandledInput?.Remove(action);
            return this;
        }

        public CSGMeshAction RemoveOnUnhandledKeyInput(Action<InputEventKey> action) {
        ...
        public CSGMeshAction OnGameplayEntered(Action action) {
        ...
        public CSGMeshAction RemoveOnGameplayEntered() {
        ...
        public CSGMeshAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public CSGMeshAction RemoveOnScriptChanged() {
        ...
        public CSGMeshAction OnVisibilityChanged(Action action) {
        ...
        public CSGMeshAction RemoveOnVisibilityChanged() {
