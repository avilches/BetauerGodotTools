...
namespace Betauer.GodotAction {
    public class ViewportTextureAction : ViewportTexture {


        private Action? _onChangedAction; 
        public ViewportTextureAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public ViewportTextureAction RemoveOnChanged() {
        ...
        public ViewportTextureAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public ViewportTextureAction RemoveOnScriptChanged() {
