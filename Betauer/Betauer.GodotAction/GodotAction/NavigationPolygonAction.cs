...
namespace Betauer.GodotAction {
    public class NavigationPolygonAction : NavigationPolygon {


        private Action? _onChangedAction; 
        public NavigationPolygonAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public NavigationPolygonAction RemoveOnChanged() {
        ...
        public NavigationPolygonAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public NavigationPolygonAction RemoveOnScriptChanged() {
