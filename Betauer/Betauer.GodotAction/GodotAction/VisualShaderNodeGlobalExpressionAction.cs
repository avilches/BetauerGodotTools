...
namespace Betauer.GodotAction {
    public class VisualShaderNodeGlobalExpressionAction : VisualShaderNodeGlobalExpression {


        private Action? _onChangedAction; 
        public VisualShaderNodeGlobalExpressionAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public VisualShaderNodeGlobalExpressionAction RemoveOnChanged() {
        ...
        public VisualShaderNodeGlobalExpressionAction OnEditorRefreshRequest(Action action) {
        ...
        public VisualShaderNodeGlobalExpressionAction RemoveOnEditorRefreshRequest() {
        ...
        public VisualShaderNodeGlobalExpressionAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public VisualShaderNodeGlobalExpressionAction RemoveOnScriptChanged() {
