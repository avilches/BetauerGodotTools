...
namespace Betauer.GodotAction {
    public class GDNativeLibraryAction : GDNativeLibrary {


        private Action? _onChangedAction; 
        public GDNativeLibraryAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public GDNativeLibraryAction RemoveOnChanged() {
        ...
        public GDNativeLibraryAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public GDNativeLibraryAction RemoveOnScriptChanged() {
