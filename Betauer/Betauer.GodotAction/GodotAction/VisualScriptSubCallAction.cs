...
namespace Betauer.GodotAction {
    public class VisualScriptSubCallAction : VisualScriptSubCall {


        private Action? _onChangedAction; 
        public VisualScriptSubCallAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public VisualScriptSubCallAction RemoveOnChanged() {
        ...
        public VisualScriptSubCallAction OnPortsChanged(Action action) {
            if (_onPortsChangedAction == null) 
                Connect("ports_changed", this, nameof(ExecutePortsChanged));
            _onPortsChangedAction = action;
            return this;
        }
        public VisualScriptSubCallAction RemoveOnPortsChanged() {
        ...
        public VisualScriptSubCallAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public VisualScriptSubCallAction RemoveOnScriptChanged() {
