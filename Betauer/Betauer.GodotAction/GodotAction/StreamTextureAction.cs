...
namespace Betauer.GodotAction {
    public class StreamTextureAction : StreamTexture {


        private Action? _onChangedAction; 
        public StreamTextureAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public StreamTextureAction RemoveOnChanged() {
        ...
        public StreamTextureAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public StreamTextureAction RemoveOnScriptChanged() {
