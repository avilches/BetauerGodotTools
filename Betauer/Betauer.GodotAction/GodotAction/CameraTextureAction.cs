...
namespace Betauer.GodotAction {
    public class CameraTextureAction : CameraTexture {


        private Action? _onChangedAction; 
        public CameraTextureAction OnChanged(Action action) {
            if (_onChangedAction == null) 
                Connect("changed", this, nameof(ExecuteChanged));
            _onChangedAction = action;
            return this;
        }
        public CameraTextureAction RemoveOnChanged() {
        ...
        public CameraTextureAction OnScriptChanged(Action action) {
            if (_onScriptChangedAction == null) 
                Connect("script_changed", this, nameof(ExecuteScriptChanged));
            _onScriptChangedAction = action;
            return this;
        }
        public CameraTextureAction RemoveOnScriptChanged() {
