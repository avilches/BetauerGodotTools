...
public class GeneratorScript : SceneTree {
    ...
    private const string SignalExtensionsFile = "../Betauer.Core.Tests/SignalExtensions.cs";
    private const string SignalConstantsFile = "../Betauer.Core.Tests/SignalConstants.cs";
