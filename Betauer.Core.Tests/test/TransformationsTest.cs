...
public class TransformationsTests {
    ...
    public void CopyGridTests() {
        ...
        original.CopyGrid(1, 2, 2, 3, dest);
        AreEqual(dest, new[,] {
            { 21, 22, 0, 0 },
            { 31, 32, 0, 0 },
            {  0,  0, 0, 0 },
        ...
        original.CopyGrid(1, 2, 10, 10, dest);
        AreEqual(dest, new[,] {
            { 21, 22, 23, 24 },
            { 31, 32, 33, 34 },
            {  0,  0,  0,  0 },
        ...
        dest = new int[2, 3];
        original.CopyGrid(3, 2, 1, 1, dest);
        AreEqual(dest, new[,] {
            { 23,  0,  0 },
            { 0 ,  0,  0 },
        });
        original.CopyGrid(3, 3, 8, 8, dest);
        AreEqual(dest, new[,] {
            { 33, 34,  0 },
            {  0,  0,  0 },
        });
        original.CopyGrid(0, 0, 8, 8, dest);
        AreEqual(dest, new[,] {
            {  0,  1,  2 },
            { 10, 11, 12 },
        });
        original.CopyGrid(-1, -1, 8, 8, dest);
        AreEqual(dest, new[,] {
            {  0,  0,  0 },
            {  0,  0,  1 },
        });
