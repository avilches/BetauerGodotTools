...
namespace Betauer.Tests.Signal {
    ...
    public class BodyOnArea2DTests : BaseNodeTest {
        ...
        [Test]
        public async Task BodyOnArea2DFilterMulticastTest() {
            var body1Calls = 0;
            var body2Calls = 0;
            var noFilter = 0;
            ...
            BodyOnArea2DEntered.Multicast topic = new BodyOnArea2DEntered.Multicast("T");
            var o = new Object();
        ...
        [Test]
        public async Task BodyOnArea2DFilterUnicastTest() {
            var calls = 0;
            Area2D area1 = new Area2D();
            Area2D area2 = new Area2D();
            KinematicBody2D body1 = new KinematicBody2D();
            KinematicBody2D body2 = new KinematicBody2D();
            BodyOnArea2DEntered.Unicast topic = new BodyOnArea2DEntered.Unicast("T");
        ...
        public async Task BodyOnArea2DCollisionTests() {
            ...
            BodyOnArea2DEntered.Multicast multiEnter = new BodyOnArea2DEntered.Multicast("T");
            BodyOnArea2DExited.Multicast multiExit = new BodyOnArea2DExited.Multicast("T");
            BodyOnArea2DEntered.Unicast uniEnter = new BodyOnArea2DEntered.Unicast("T");
            BodyOnArea2DExited.Unicast uniExit = new BodyOnArea2DExited.Unicast("T");
