...
namespace Betauer.Animation.Easing {
    public static class Easings {
        ...
        public static IEasing SpringIn = new GodotEasing(Tween.TransitionType.Spring, Tween.EaseType.In);
        public static IEasing SpringOut = new GodotEasing(Tween.TransitionType.Spring, Tween.EaseType.Out);
        public static IEasing SpringInOut = new GodotEasing(Tween.TransitionType.Spring, Tween.EaseType.InOut);
    }
}