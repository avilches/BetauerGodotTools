...
public class PlatformCollisionLayerManager {
    private const string GROUP_ENEMY = "enemy";
    public static void PlayerConfigureCollisions(PlatformPlayerNode playerNode) {
    ...
    public static void PlayerPickableArea(PlatformPlayerNode playerNode, Area2D.AreaEnteredEventHandler onEnterPickableArea) {
