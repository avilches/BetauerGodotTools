...
public class ProxyFactoryProvider : Provider {
    ...
    public ProxyFactoryProvider(Type proxyFactoryType, Lifetime lifetime, Proxy factory, string? name = null, bool serviceLazy = false, Dictionary<string, object>? metadata = null) : base(proxyFactoryType, proxyFactoryType, name, metadata) {
