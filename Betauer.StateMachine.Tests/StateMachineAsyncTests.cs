...
namespace Betauer.StateMachine.Tests {
    ...
    public class StateMachineAsyncTests : Node {
        ...
        public async Task ConditionalOrderStateNeverChanges() {
            var sm = new StateMachineAsync<State, Event>(State.Start);
        ...
        public async Task ConditionalOrderStateChangesAtTheBeginning() {
            var sm = new StateMachineAsync<State, Event>(State.Start);
        ...
        public async Task ConditionalOrderStateChangesAtTheEnd() {
            var sm = new StateMachineAsync<State, Event>(State.Start);
