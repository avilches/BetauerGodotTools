...
namespace Betauer.GameTools.Tests {
    ...
    public class ResolutionTests {
        ...
        public void ScaledResolutionEqualityTests() {
            ...
            Assert.That(res.Equals((object)null), Is.False);
            Assert.That(res.Equals(null), Is.False);
            Assert.That(res.Equals(new ScaledResolution(base1, size1 + Vector2.One)), Is.False);
            Assert.That(res.Equals(new ScaledResolution(base1 + Vector2.One, size1)), Is.False);
            Assert.That(res == new ScaledResolution(base1, size1 + Vector2.One), Is.False);
            Assert.That(res == new ScaledResolution(base1 + Vector2.One, size1), Is.False);
            ...
            Assert.That(res != new ScaledResolution(base1, size1 + Vector2.One));
            Assert.That(res != new ScaledResolution(base1 + Vector2.One, size1));
