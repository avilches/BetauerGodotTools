...
public class SpatialGrid {
    ...
    internal void Update(Point point, float x, float y) {
        ...
        var newIntersectingCells = GetPointIntersectingCell(x, y, CellSize);
    ...
    internal void Update(Circle circle, float x, float y, float radius) {
        ...
        var newIntersectingCells = GetCircleIntersectingCells(x, y, radius, CellSize);
    ...
    internal void Update(Rectangle rectangle, float x, float y, float width, float height) {
        ...
        var newIntersectingCells = GetRectangleIntersectingCells(x, y, width, height, CellSize);
